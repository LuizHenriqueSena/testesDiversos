...
__ESBMC_assume((layer1[1] >= 0.0279229991138) && (layer1[1] <= 0.976568996906));
...
__ESBMC_assume((layer1[2] >= 0) && (layer1[2] <= 0.897522985935));
...
__ESBMC_assume((layer1[3] >= 0.00336800003424) && (layer1[3] <= 0.887952983379));
...
__ESBMC_assume((layer2[0] >= 0.0121280001476) && (layer2[0] <= 0.995635986328));
...
__ESBMC_assume((layer2[1] >= 0.00399000011384) && (layer2[1] <= 1));
...
__ESBMC_assume((layer2[2] >= 0) && (layer2[2] <= 0.66596698761));
...
__ESBMC_assume((layer2[3] >= 0.418240994215) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 0) && (layer3[0] <= 0.944799005985));
int r = 0;
...
__ESBMC_assume((layer3[1] >= 0) && (layer3[1] <= 0.991250991821));
...
__ESBMC_assume((layer3[2] >= 0) && (layer3[2] <= 0.96045601368));
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.161109000444));
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <= 0.617748022079));
