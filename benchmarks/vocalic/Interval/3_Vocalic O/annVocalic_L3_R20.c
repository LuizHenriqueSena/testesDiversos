...
__ESBMC_assume((layer1[0] >= 0.0171239990741) && (layer1[0] <= 0.97068798542));
...
__ESBMC_assume((layer1[1] >= 0.729088008404) && (layer1[1] <= 1));
...
__ESBMC_assume((layer1[2] >= 0) && (layer1[2] <= 0.60587400198));
...
__ESBMC_assume((layer1[3] >= 0.0426970012486) && (layer1[3] <= 0.990529000759));
...
__ESBMC_assume((layer2[0] >= 0) && (layer2[0] <= 0.869890987873));
...
__ESBMC_assume((layer2[1] >= 0) && (layer2[1] <= 0.985656023026));
...
__ESBMC_assume((layer2[2] >= 0) && (layer2[2] <= 0.0787099972367));
...
__ESBMC_assume((layer2[3] >= 0.00937800016254) && (layer2[3] <= 0.987872004509));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 0) && (layer3[0] <= 0.140637993813));
int r = 0;
...
__ESBMC_assume((layer3[1] >= 0) && (layer3[1] <= 0.968016028404));
...
__ESBMC_assume((layer3[2] >= 0) && (layer3[2] <= 0.962311983109));
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.967073976994));
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <= 0.987506985664));
