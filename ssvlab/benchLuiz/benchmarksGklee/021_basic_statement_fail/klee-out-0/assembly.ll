...
@.str = private unnamed_addr constant [75 x i8] c"Digite 1 para duplicar um vetor ou\0ADigite 2 para dividir um vetor por 2: \0A\00", align 1
@.str1 = private unnamed_addr constant [8 x i8] c" %.1f; \00", align 1
@.str2 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str3 = private unnamed_addr constant [13 x i8] c"a[i]==2*v[i]\00", align 1
@.str4 = private unnamed_addr constant [9 x i8] c"main.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str5 = private unnamed_addr constant [15 x i8] c"a[i]==0.5*v[i]\00", align 1
...
define void @_Z3fooPfj(float* %v, i32 %i) uwtable noinline {
  ...
  br i1 %4, label %5, label %6, !dbg !731

; <label>:5                                       ; preds = %0
  store void (float*, i32)* @_Z13multiplyByTwoPfj, void (float*, i32)** %f, align 8, !dbg !733
  br label %11, !dbg !733

; <label>:6                                       ; preds = %0
  %7 = load i32* %2, align 4, !dbg !734
  %8 = icmp eq i32 %7, 2, !dbg !734
  br i1 %8, label %9, label %10, !dbg !734

; <label>:9                                       ; preds = %6
  store void (float*, i32)* @_Z11divideByTwoPfj, void (float*, i32)** %f, align 8, !dbg !735
  br label %11, !dbg !735

; <label>:10                                      ; preds = %6
  store void (float*, i32)* null, void (float*, i32)** %f, align 8, !dbg !736
  br label %11

; <label>:11                                      ; preds = %9, %10, %5
  %12 = load void (float*, i32)** %f, align 8, !dbg !737
  %13 = load float** %1, align 8, !dbg !737
  %14 = load i32* getelementptr inbounds (%struct.dim3* @blockIdx, i32 0, i32 0), align 4, !dbg !737
  %15 = load i32* getelementptr inbounds (%struct.dim3* @blockDim, i32 0, i32 0), align 4, !dbg !737
  %16 = mul i32 %14, %15, !dbg !737
  %17 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !737
  %18 = add i32 %16, %17, !dbg !737
  call void %12(float* %13, i32 %18), !dbg !737
  ret void, !dbg !738
}

define i32 @_Z11nondet_uintv() nounwind uwtable {
  %a = alloca i32, align 4
  %1 = load i32* %a, align 4, !dbg !739
  ret i32 %1, !dbg !739
}
...
define i32 @main() uwtable {
  ...
  store i32 0, i32* %1
  %6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([75 x i8]* @.str, i32 0, i32 0)), !dbg !741
  %7 = call i32 @_Z11nondet_uintv(), !dbg !743
  store i32 %7, i32* %c, align 4, !dbg !743
  %8 = call noalias i8* @malloc(i64 8) nounwind, !dbg !744
  %9 = bitcast i8* %8 to float*, !dbg !744
  store float* %9, float** %v, align 8, !dbg !744
  %10 = call noalias i8* @malloc(i64 8) nounwind, !dbg !745
  %11 = bitcast i8* %10 to float*, !dbg !745
  store float* %11, float** %a, align 8, !dbg !745
  store i32 0, i32* %i, align 4, !dbg !746
  br label %12, !dbg !746

; <label>:12                                      ; preds = %15, %0
  %13 = load i32* %i, align 4, !dbg !746
  %14 = icmp slt i32 %13, 2, !dbg !746
  br i1 %14, label %15, label %33, !dbg !746

; <label>:15                                      ; preds = %12
  %16 = call i32 @rand() nounwind, !dbg !748
  %17 = srem i32 %16, 10, !dbg !748
  %18 = add nsw i32 %17, 1, !dbg !748
  %19 = sitofp i32 %18 to float, !dbg !748
  %20 = load i32* %i, align 4, !dbg !748
  %21 = sext i32 %20 to i64, !dbg !748
  %22 = load float** %v, align 8, !dbg !748
  %23 = getelementptr inbounds float* %22, i64 %21, !dbg !748
  store float %19, float* %23, align 4, !dbg !748
  %24 = load i32* %i, align 4, !dbg !750
  %25 = sext i32 %24 to i64, !dbg !750
  %26 = load float** %v, align 8, !dbg !750
  %27 = getelementptr inbounds float* %26, i64 %25, !dbg !750
  %28 = load float* %27, align 4, !dbg !750
  %29 = fpext float %28 to double, !dbg !750
  %30 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str1, i32 0, i32 0), double %29), !dbg !750
  %31 = load i32* %i, align 4, !dbg !746
  %32 = add nsw i32 %31, 1, !dbg !746
  store i32 %32, i32* %i, align 4, !dbg !746
  br label %12, !dbg !746

; <label>:33                                      ; preds = %12
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !dbg !751
  %35 = bitcast float** %dev_v to i8**, !dbg !752
  %36 = call i32 @cudaMalloc(i8** %35, i64 8), !dbg !752
  %37 = load float** %dev_v, align 8, !dbg !753
  %38 = bitcast float* %37 to i8*, !dbg !753
  %39 = load float** %v, align 8, !dbg !753
  %40 = bitcast float* %39 to i8*, !dbg !753
  %41 = call i32 @cudaMemcpy(i8* %38, i8* %40, i64 8, i32 1), !dbg !753
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 1, i32 1, i32 1), !dbg !754
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %3, i32 2, i32 1, i32 1), !dbg !754
  %42 = bitcast { i64, i32 }* %4 to i8*, !dbg !754
  %43 = bitcast %struct.dim3* %2 to i8*, !dbg !754
  %44 = call i8* @memcpy(i8* %42, i8* %43, i64 12)
  %45 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !754
  %46 = load i64* %45, align 1, !dbg !754
  %47 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !754
  %48 = load i32* %47, align 1, !dbg !754
  %49 = bitcast { i64, i32 }* %5 to i8*, !dbg !754
  %50 = bitcast %struct.dim3* %3 to i8*, !dbg !754
  %51 = call i8* @memcpy(i8* %49, i8* %50, i64 12)
  %52 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !754
  %53 = load i64* %52, align 1, !dbg !754
  %54 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !754
  %55 = load i32* %54, align 1, !dbg !754
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %46, i32 %48, i64 %53, i32 %55), !dbg !754
  %56 = load float** %dev_v, align 8, !dbg !756
  %57 = load i32* %c, align 4, !dbg !756
  call void @_Z3fooPfj(float* %56, i32 %57), !dbg !756
  %58 = load float** %a, align 8, !dbg !757
  %59 = bitcast float* %58 to i8*, !dbg !757
  %60 = load float** %dev_v, align 8, !dbg !757
  %61 = bitcast float* %60 to i8*, !dbg !757
  %62 = call i32 @cudaMemcpy(i8* %59, i8* %61, i64 8, i32 2), !dbg !757
  store i32 0, i32* %i1, align 4, !dbg !758
  br label %63, !dbg !758

; <label>:63                                      ; preds = %109, %33
  %64 = load i32* %i1, align 4, !dbg !758
  %65 = icmp slt i32 %64, 2, !dbg !758
  br i1 %65, label %66, label %112, !dbg !758

; <label>:66                                      ; preds = %63
  %67 = load i32* %i1, align 4, !dbg !760
  %68 = sext i32 %67 to i64, !dbg !760
  %69 = load float** %a, align 8, !dbg !760
  %70 = getelementptr inbounds float* %69, i64 %68, !dbg !760
  %71 = load float* %70, align 4, !dbg !760
  %72 = fpext float %71 to double, !dbg !760
  %73 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([8 x i8]* @.str1, i32 0, i32 0), double %72), !dbg !760
  %74 = load i32* %c, align 4, !dbg !762
  %75 = icmp eq i32 %74, 1, !dbg !762
  br i1 %75, label %76, label %90, !dbg !762

; <label>:76                                      ; preds = %66
  %77 = load i32* %i1, align 4, !dbg !763
  %78 = sext i32 %77 to i64, !dbg !763
  %79 = load float** %a, align 8, !dbg !763
  %80 = getelementptr inbounds float* %79, i64 %78, !dbg !763
  %81 = load float* %80, align 4, !dbg !763
  %82 = load i32* %i1, align 4, !dbg !763
  %83 = sext i32 %82 to i64, !dbg !763
  %84 = load float** %v, align 8, !dbg !763
  %85 = getelementptr inbounds float* %84, i64 %83, !dbg !763
  %86 = load float* %85, align 4, !dbg !763
  %87 = fmul float 2.000000e+00, %86, !dbg !763
  %88 = fcmp oeq float %81, %87, !dbg !763
  br i1 %88, label %109, label %89, !dbg !763

; <label>:89                                      ; preds = %76
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0), i32 81, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwi
  unreachable, !dbg !763

; <label>:90                                      ; preds = %66
  %91 = load i32* %c, align 4, !dbg !764
  %92 = icmp eq i32 %91, 2, !dbg !764
  br i1 %92, label %93, label %109, !dbg !764

; <label>:93                                      ; preds = %90
  %94 = load i32* %i1, align 4, !dbg !765
  %95 = sext i32 %94 to i64, !dbg !765
  %96 = load float** %a, align 8, !dbg !765
  %97 = getelementptr inbounds float* %96, i64 %95, !dbg !765
  %98 = load float* %97, align 4, !dbg !765
  %99 = fpext float %98 to double, !dbg !765
  %100 = load i32* %i1, align 4, !dbg !765
  %101 = sext i32 %100 to i64, !dbg !765
  %102 = load float** %v, align 8, !dbg !765
  %103 = getelementptr inbounds float* %102, i64 %101, !dbg !765
  %104 = load float* %103, align 4, !dbg !765
  %105 = fpext float %104 to double, !dbg !765
  %106 = fmul double 5.000000e-01, %105, !dbg !765
  %107 = fcmp oeq double %99, %106, !dbg !765
  br i1 %107, label %109, label %108, !dbg !765

; <label>:108                                     ; preds = %93
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0), i32 83, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwi
  unreachable, !dbg !765

; <label>:109                                     ; preds = %76, %93, %90
  %110 = load i32* %i1, align 4, !dbg !758
  %111 = add nsw i32 %110, 1, !dbg !758
  store i32 %111, i32* %i1, align 4, !dbg !758
  br label %63, !dbg !758

; <label>:112                                     ; preds = %63
  %113 = load float** %v, align 8, !dbg !766
  %114 = bitcast float* %113 to i8*, !dbg !766
  call void @free(i8* %114) nounwind, !dbg !766
  %115 = load float** %a, align 8, !dbg !766
  %116 = bitcast float* %115 to i8*, !dbg !766
  call void @free(i8* %116) nounwind, !dbg !766
  %117 = load float** %dev_v, align 8, !dbg !767
  %118 = bitcast float* %117 to i8*, !dbg !767
  %119 = call i32 @cudaFree(i8* %118), !dbg !767
  ret i32 0, !dbg !768
}
...
define linkonce_odr void @_ZN4dim3C1Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr uwtable section "__device__" align 2 {
  ...
  %6 = load i32* %2, align 4, !dbg !769
  %7 = load i32* %3, align 4, !dbg !769
  %8 = load i32* %4, align 4, !dbg !769
  call void @_ZN4dim3C2Ejjj(%struct.dim3* %5, i32 %6, i32 %7, i32 %8), !dbg !769
  ret void, !dbg !769
}
...
define linkonce_odr void @_ZN4dim3C2Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr nounwind uwtable section "__device__" align 2 {
  ...
  store i32 %vz, i32* %4, align 4
  %5 = load %struct.dim3** %1
  %6 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 0, !dbg !770
  %7 = load i32* %2, align 4, !dbg !770
  store i32 %7, i32* %6, align 4, !dbg !770
  %8 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 1, !dbg !770
  %9 = load i32* %3, align 4, !dbg !770
  store i32 %9, i32* %8, align 4, !dbg !770
  %10 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 2, !dbg !770
  %11 = load i32* %4, align 4, !dbg !770
  store i32 %11, i32* %10, align 4, !dbg !770
  ret void, !dbg !771
}

define i8* @memcpy(i8* %destaddr, i8* nocapture %srcaddr, i64 %len) nounwind uwtable {
  %1 = icmp eq i64 %len, 0, !dbg !773
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !773

.lr.ph:                                           ; preds = %.lr.ph, %0
  %src.06 = phi i8* [ %3, %.lr.ph ], [ %srcaddr, %0 ]
  %dest.05 = phi i8* [ %5, %.lr.ph ], [ %destaddr, %0 ]
  %.04 = phi i64 [ %2, %.lr.ph ], [ %len, %0 ]
  %2 = add i64 %.04, -1, !dbg !773
  %3 = getelementptr inbounds i8* %src.06, i64 1, !dbg !774
  %4 = load i8* %src.06, align 1, !dbg !774, !tbaa !775
  %5 = getelementptr inbounds i8* %dest.05, i64 1, !dbg !774
  store i8 %4, i8* %dest.05, align 1, !dbg !774, !tbaa !775
  %6 = icmp eq i64 %2, 0, !dbg !773
  br i1 %6, label %._crit_edge, label %.lr.ph, !dbg !773

._crit_edge:                                      ; preds = %.lr.ph, %0
  ret i8* %destaddr, !dbg !777
}

declare void @llvm.dbg.value(metadata, i64, metadata) nounwind readnone

define i8* @memset(i8* %dst, i32 %s, i64 %count) nounwind uwtable {
  %1 = icmp eq i64 %count, 0, !dbg !778
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !778

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !779
  br label %3, !dbg !778

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.05 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.04 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.04, -1, !dbg !778
  %5 = getelementptr inbounds i8* %a.05, i64 1, !dbg !779
  store volatile i8 %2, i8* %a.05, align 1, !dbg !779, !tbaa !775
  %6 = icmp eq i64 %4, 0, !dbg !778
  br i1 %6, label %._crit_edge, label %3, !dbg !778
...
define i32 @cudaFree(i8* nocapture %devPtr) nounwind uwtable {
  tail call void @free(i8* %devPtr) nounwind, !dbg !783
  ret i32 0, !dbg !785
}

define i32 @cudaFreeArray(%struct.cudaArray* nocapture %array) nounwind uwtable {
  %1 = bitcast %struct.cudaArray* %array to i8*, !dbg !786
  tail call void @free(i8* %1) nounwind, !dbg !786
  ret i32 0, !dbg !788
}

define i32 @cudaFreeHost(i8* nocapture %ptr) nounwind uwtable {
  tail call void @free(i8* %ptr) nounwind, !dbg !789
  ret i32 0, !dbg !791
}
...
define i32 @cudaMalloc(i8** nocapture %devPtr, i64 %size) uwtable {
  tail call void @__set_device(), !dbg !806
  %1 = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !808
  store i8* %1, i8** %devPtr, align 8, !dbg !808, !tbaa !809
  tail call void @__clear_device(), !dbg !810
  ret i32 0, !dbg !811
}
...
define i32 @cudaMallocHost(i8** nocapture %ptr, i64 %size) uwtable {
  tail call void @__set_host(), !dbg !818
  %1 = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !820
  store i8* %1, i8** %ptr, align 8, !dbg !820, !tbaa !809
  tail call void @__clear_host(), !dbg !821
  ret i32 0, !dbg !822
}
...
define i32 @cudaMemcpyToSymbol(i8* nocapture %symbol, i8* nocapture %src, i64 %count, i64 %offset, i32 %kind) nounwind uwtable {
  %1 = getelementptr inbounds i8* %symbol, i64 %offset, !dbg !869
...
define i32 @cudaMemset(i8* nocapture %devPtr, i32 %value, i64 %count) nounwind uwtable {
  %1 = trunc i32 %value to i8, !dbg !876
  %2 = zext i8 %1 to i32
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail", null} ; [ DW_TAG_file_type ]
...
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail", null} ; [ DW_TAG_file_type ]
...
!24 = metadata !{i32 786478, i32 0, metadata !16, metadata !"nondet_uint", metadata !"nondet_uint", metadata !"_Z11nondet_uintv", metadata !16, i32 41, metadata !25, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @_Z11nondet_uintv, nul
...
!27 = metadata !{i32 786478, i32 0, metadata !16, metadata !"main", metadata !"main", metadata !"", metadata !16, i32 47, metadata !28, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !11, i32 47} ; [ DW_TAG_
...
!32 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail", null} ; [ DW_TAG_file_type ]
...
!726 = metadata !{i32 786443, metadata !15, i32 12, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!727 = metadata !{i32 16, i32 0, metadata !726, null}
!728 = metadata !{i32 22, i32 0, metadata !729, null}
!729 = metadata !{i32 786443, metadata !22, i32 19, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!730 = metadata !{i32 23, i32 0, metadata !729, null}
!731 = metadata !{i32 31, i32 0, metadata !732, null}
!732 = metadata !{i32 786443, metadata !23, i32 28, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!733 = metadata !{i32 32, i32 0, metadata !732, null}
!734 = metadata !{i32 33, i32 0, metadata !732, null}
!735 = metadata !{i32 34, i32 0, metadata !732, null}
!736 = metadata !{i32 36, i32 0, metadata !732, null}
!737 = metadata !{i32 38, i32 0, metadata !732, null}
!738 = metadata !{i32 39, i32 0, metadata !732, null}
!739 = metadata !{i32 43, i32 0, metadata !740, null}
!740 = metadata !{i32 786443, metadata !24, i32 41, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!741 = metadata !{i32 54, i32 0, metadata !742, null}
!742 = metadata !{i32 786443, metadata !27, i32 47, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!743 = metadata !{i32 55, i32 0, metadata !742, null}
!744 = metadata !{i32 57, i32 0, metadata !742, null}
!745 = metadata !{i32 58, i32 0, metadata !742, null}
!746 = metadata !{i32 60, i32 0, metadata !747, null}
!747 = metadata !{i32 786443, metadata !742, i32 60, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!748 = metadata !{i32 61, i32 0, metadata !749, null}
!749 = metadata !{i32 786443, metadata !747, i32 60, i32 0, metadata !16, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!750 = metadata !{i32 62, i32 0, metadata !749, null}
!751 = metadata !{i32 65, i32 0, metadata !742, null}
!752 = metadata !{i32 67, i32 0, metadata !742, null}
!753 = metadata !{i32 69, i32 0, metadata !742, null}
!754 = metadata !{i32 70, i32 0, metadata !755, null}
!755 = metadata !{i32 786443, metadata !742, i32 70, i32 0, metadata !16, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!756 = metadata !{i32 72, i32 0, metadata !755, null}
!757 = metadata !{i32 76, i32 0, metadata !742, null}
!758 = metadata !{i32 78, i32 0, metadata !759, null}
!759 = metadata !{i32 786443, metadata !742, i32 78, i32 0, metadata !16, i32 8} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!760 = metadata !{i32 79, i32 0, metadata !761, null}
!761 = metadata !{i32 786443, metadata !759, i32 78, i32 0, metadata !16, i32 9} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail/main.cpp]
!762 = metadata !{i32 80, i32 0, metadata !761, null}
!763 = metadata !{i32 81, i32 0, metadata !761, null}
!764 = metadata !{i32 82, i32 0, metadata !761, null}
!765 = metadata !{i32 83, i32 0, metadata !761, null}
!766 = metadata !{i32 86, i32 0, metadata !742, null}
!767 = metadata !{i32 87, i32 0, metadata !742, null}
!768 = metadata !{i32 89, i32 0, metadata !742, null}
!769 = metadata !{i32 419, i32 0, metadata !31, null}
!770 = metadata !{i32 419, i32 0, metadata !73, null}
!771 = metadata !{i32 419, i32 0, metadata !772, null}
!772 = metadata !{i32 786443, metadata !73, i32 419, i32 0, metadata !32, i32 10} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/021_basic_statement_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_t
!773 = metadata !{i32 16, i32 0, metadata !92, null}
!774 = metadata !{i32 17, i32 0, metadata !92, null}
!775 = metadata !{metadata !"omnipotent char", metadata !776}
!776 = metadata !{metadata !"Simple C/C++ TBAA"}
!777 = metadata !{i32 18, i32 0, metadata !92, null}
!778 = metadata !{i32 14, i32 0, metadata !128, null}
!779 = metadata !{i32 15, i32 0, metadata !128, null}
!780 = metadata !{i32 16, i32 0, metadata !128, null}
!781 = metadata !{i32 26, i32 0, metadata !782, null}
!782 = metadata !{i32 786443, metadata !218, i32 25, i32 0, metadata !219, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!783 = metadata !{i32 30, i32 0, metadata !784, null}
!784 = metadata !{i32 786443, metadata !247, i32 29, i32 0, metadata !219, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!785 = metadata !{i32 31, i32 0, metadata !784, null}
!786 = metadata !{i32 35, i32 0, metadata !787, null}
!787 = metadata !{i32 786443, metadata !253, i32 34, i32 0, metadata !219, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!788 = metadata !{i32 36, i32 0, metadata !787, null}
!789 = metadata !{i32 40, i32 0, metadata !790, null}
!790 = metadata !{i32 786443, metadata !259, i32 39, i32 0, metadata !219, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!791 = metadata !{i32 41, i32 0, metadata !790, null}
!792 = metadata !{i32 45, i32 0, metadata !793, null}
!793 = metadata !{i32 786443, metadata !263, i32 44, i32 0, metadata !219, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!794 = metadata !{i32 49, i32 0, metadata !795, null}
!795 = metadata !{i32 786443, metadata !271, i32 48, i32 0, metadata !219, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!796 = metadata !{i32 53, i32 0, metadata !797, null}
!797 = metadata !{i32 786443, metadata !279, i32 52, i32 0, metadata !219, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!798 = metadata !{i32 57, i32 0, metadata !799, null}
!799 = metadata !{i32 786443, metadata !287, i32 56, i32 0, metadata !219, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!800 = metadata !{i32 61, i32 0, metadata !801, null}
!801 = metadata !{i32 786443, metadata !295, i32 60, i32 0, metadata !219, i32 8} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!802 = metadata !{i32 65, i32 0, metadata !803, null}
!803 = metadata !{i32 786443, metadata !302, i32 64, i32 0, metadata !219, i32 9} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!804 = metadata !{i32 69, i32 0, metadata !805, null}
!805 = metadata !{i32 786443, metadata !310, i32 68, i32 0, metadata !219, i32 10} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!806 = metadata !{i32 73, i32 0, metadata !807, null}
!807 = metadata !{i32 786443, metadata !314, i32 72, i32 0, metadata !219, i32 11} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!808 = metadata !{i32 74, i32 0, metadata !807, null}
!809 = metadata !{metadata !"any pointer", metadata !775}
!810 = metadata !{i32 75, i32 0, metadata !807, null}
!811 = metadata !{i32 77, i32 0, metadata !807, null}
!812 = metadata !{i32 81, i32 0, metadata !813, null}
!813 = metadata !{i32 786443, metadata !321, i32 80, i32 0, metadata !219, i32 12} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!814 = metadata !{i32 86, i32 0, metadata !815, null}
!815 = metadata !{i32 786443, metadata !335, i32 85, i32 0, metadata !219, i32 13} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!816 = metadata !{i32 91, i32 0, metadata !817, null}
!817 = metadata !{i32 786443, metadata !345, i32 90, i32 0, metadata !219, i32 14} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!818 = metadata !{i32 95, i32 0, metadata !819, null}
!819 = metadata !{i32 786443, metadata !355, i32 94, i32 0, metadata !219, i32 15} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!820 = metadata !{i32 96, i32 0, metadata !819, null}
!821 = metadata !{i32 97, i32 0, metadata !819, null}
!822 = metadata !{i32 99, i32 0, metadata !819, null}
!823 = metadata !{i32 103, i32 0, metadata !824, null}
!824 = metadata !{i32 786443, metadata !360, i32 102, i32 0, metadata !219, i32 16} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!825 = metadata !{i32 108, i32 0, metadata !826, null}
!826 = metadata !{i32 786443, metadata !369, i32 106, i32 0, metadata !219, i32 17} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!827 = metadata !{i32 113, i32 0, metadata !828, null}
!828 = metadata !{i32 786443, metadata !378, i32 112, i32 0, metadata !219, i32 18} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!829 = metadata !{i32 119, i32 0, metadata !830, null}
!830 = metadata !{i32 786443, metadata !390, i32 118, i32 0, metadata !219, i32 19} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!831 = metadata !{i32 125, i32 0, metadata !832, null}
!832 = metadata !{i32 786443, metadata !404, i32 124, i32 0, metadata !219, i32 20} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!833 = metadata !{i32 131, i32 0, metadata !834, null}
!834 = metadata !{i32 786443, metadata !420, i32 130, i32 0, metadata !219, i32 21} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!835 = metadata !{i32 137, i32 0, metadata !836, null}
!836 = metadata !{i32 786443, metadata !433, i32 136, i32 0, metadata !219, i32 22} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!837 = metadata !{i32 143, i32 0, metadata !838, null}
!838 = metadata !{i32 786443, metadata !447, i32 142, i32 0, metadata !219, i32 23} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!839 = metadata !{i32 149, i32 0, metadata !840, null}
!840 = metadata !{i32 786443, metadata !460, i32 148, i32 0, metadata !219, i32 24} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!841 = metadata !{i32 153, i32 0, metadata !842, null}
!842 = metadata !{i32 786443, metadata !474, i32 152, i32 0, metadata !219, i32 25} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!843 = metadata !{i32 157, i32 0, metadata !844, null}
!844 = metadata !{i32 786443, metadata !498, i32 156, i32 0, metadata !219, i32 26} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!845 = metadata !{i32 161, i32 0, metadata !846, null}
!846 = metadata !{i32 786443, metadata !505, i32 160, i32 0, metadata !219, i32 27} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!847 = metadata !{i32 165, i32 0, metadata !848, null}
!848 = metadata !{i32 786443, metadata !524, i32 164, i32 0, metadata !219, i32 28} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!849 = metadata !{i32 171, i32 0, metadata !850, null}
!850 = metadata !{i32 786443, metadata !531, i32 170, i32 0, metadata !219, i32 29} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!851 = metadata !{i32 176, i32 0, metadata !852, null}
!852 = metadata !{i32 786443, metadata !544, i32 175, i32 0, metadata !219, i32 30} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!853 = metadata !{i32 181, i32 0, metadata !854, null}
!854 = metadata !{i32 786443, metadata !554, i32 180, i32 0, metadata !219, i32 31} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!855 = metadata !{i32 187, i32 0, metadata !856, null}
!856 = metadata !{i32 786443, metadata !565, i32 186, i32 0, metadata !219, i32 32} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!857 = metadata !{i32 192, i32 0, metadata !858, null}
!858 = metadata !{i32 786443, metadata !577, i32 191, i32 0, metadata !219, i32 33} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!859 = metadata !{i32 198, i32 0, metadata !860, null}
!860 = metadata !{i32 786443, metadata !587, i32 197, i32 0, metadata !219, i32 34} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!861 = metadata !{i32 203, i32 0, metadata !862, null}
!862 = metadata !{i32 786443, metadata !598, i32 201, i32 0, metadata !219, i32 35} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!863 = metadata !{i32 209, i32 0, metadata !864, null}
!864 = metadata !{i32 786443, metadata !608, i32 207, i32 0, metadata !219, i32 36} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!865 = metadata !{i32 214, i32 0, metadata !866, null}
!866 = metadata !{i32 786443, metadata !619, i32 213, i32 0, metadata !219, i32 37} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!867 = metadata !{i32 220, i32 0, metadata !868, null}
!868 = metadata !{i32 786443, metadata !630, i32 219, i32 0, metadata !219, i32 38} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!869 = metadata !{i32 225, i32 0, metadata !870, null}
!870 = metadata !{i32 786443, metadata !642, i32 224, i32 0, metadata !219, i32 39} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!871 = metadata !{i32 226, i32 0, metadata !870, null}
!872 = metadata !{i32 231, i32 0, metadata !873, null}
!873 = metadata !{i32 786443, metadata !652, i32 230, i32 0, metadata !219, i32 40} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!874 = metadata !{i32 235, i32 0, metadata !875, null}
!875 = metadata !{i32 786443, metadata !663, i32 234, i32 0, metadata !219, i32 41} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!876 = metadata !{i32 239, i32 0, metadata !877, null}
!877 = metadata !{i32 786443, metadata !670, i32 238, i32 0, metadata !219, i32 42} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!878 = metadata !{i32 240, i32 0, metadata !877, null}
!879 = metadata !{i32 245, i32 0, metadata !880, null}
!880 = metadata !{i32 786443, metadata !678, i32 244, i32 0, metadata !219, i32 43} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!881 = metadata !{i32 250, i32 0, metadata !882, null}
!882 = metadata !{i32 786443, metadata !688, i32 249, i32 0, metadata !219, i32 44} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!883 = metadata !{i32 255, i32 0, metadata !884, null}
!884 = metadata !{i32 786443, metadata !699, i32 254, i32 0, metadata !219, i32 45} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!885 = metadata !{i32 260, i32 0, metadata !886, null}
!886 = metadata !{i32 786443, metadata !707, i32 259, i32 0, metadata !219, i32 46} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!887 = metadata !{i32 264, i32 0, metadata !888, null}
!888 = metadata !{i32 786443, metadata !716, i32 263, i32 0, metadata !219, i32 47} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
