...
__ESBMC_assume((layer1[1] >= 0.173647001386) && (layer1[1] <= 0.887952983379));
...
__ESBMC_assume((layer1[2] >= 0.0140639999881) && (layer1[2] <= 0.495000004768));
...
__ESBMC_assume((layer1[3] >= 0.0183429997414) && (layer1[3] <= 0.477515012026));
...
__ESBMC_assume((layer2[0] >= 0.08166000247) && (layer2[0] <= 0.968016028404));
...
__ESBMC_assume((layer2[1] >= 0.00537799997255) && (layer2[1] <= 0.798991024494));
...
__ESBMC_assume((layer2[2] >= 0) && (layer2[2] <= 0.112047001719));
...
__ESBMC_assume((layer2[3] >= 0.734973013401) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 0) && (layer3[0] <= 0.102476999164));
int r = 0;
...
__ESBMC_assume((layer3[1] >= 0) && (layer3[1] <= 0.988108992577));
...
__ESBMC_assume((layer3[2] >= 0) && (layer3[2] <= 0.916061997414));
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.0033350000158));
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <= 0.011429999955));
