...
@.str = private unnamed_addr constant [22 x i8] c"a[%d]= %d; b[%d]=%d;\0A\00", align 1
@.str1 = private unnamed_addr constant [15 x i8] c"a[2]==(b[2]+1)\00", align 1
@.str2 = private unnamed_addr constant [9 x i8] c"main.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

define void @_Z3fooPiS_(i32* %p, i32* %q) nounwind uwtable noinline {
  %1 = alloca i32*, align 8
  %2 = alloca i32*, align 8
  store i32* %p, i32** %1, align 8
  store i32* %q, i32** %2, align 8
  %3 = load i32** %2, align 8, !dbg !719
  %4 = getelementptr inbounds i32* %3, i64 2, !dbg !719
  %5 = load i32* %4, align 4, !dbg !719
  %6 = add nsw i32 %5, 1, !dbg !719
  %7 = load i32** %1, align 8, !dbg !719
  %8 = getelementptr inbounds i32* %7, i64 2, !dbg !719
  store i32 %6, i32* %8, align 4, !dbg !719
  ret void, !dbg !721
}
...
; <label>:10                                      ; preds = %13, %0
  ...
  br i1 %12, label %13, label %27, !dbg !725
...
; <label>:13                                      ; preds = %10
  ...
  %21 = load i32* %i, align 4, !dbg !729
  %22 = sext i32 %21 to i64, !dbg !729
  %23 = load i32** %b, align 8, !dbg !729
  %24 = getelementptr inbounds i32* %23, i64 %22, !dbg !729
  store i32 %20, i32* %24, align 4, !dbg !729
  %25 = load i32* %i, align 4, !dbg !725
  %26 = add nsw i32 %25, 1, !dbg !725
  store i32 %26, i32* %i, align 4, !dbg !725
  br label %10, !dbg !725

; <label>:27                                      ; preds = %10
  %28 = bitcast i32** %dev_a to i8**, !dbg !730
  %29 = call i32 @cudaMalloc(i8** %28, i64 8), !dbg !730
  %30 = bitcast i32** %dev_b to i8**, !dbg !731
  %31 = call i32 @cudaMalloc(i8** %30, i64 8), !dbg !731
  %32 = load i32** %dev_a, align 8, !dbg !732
  %33 = bitcast i32* %32 to i8*, !dbg !732
  %34 = load i32** %a, align 8, !dbg !732
  %35 = bitcast i32* %34 to i8*, !dbg !732
  %36 = call i32 @cudaMemcpy(i8* %33, i8* %35, i64 8, i32 1), !dbg !732
  %37 = load i32** %dev_b, align 8, !dbg !733
  %38 = bitcast i32* %37 to i8*, !dbg !733
  %39 = load i32** %b, align 8, !dbg !733
  %40 = bitcast i32* %39 to i8*, !dbg !733
  %41 = call i32 @cudaMemcpy(i8* %38, i8* %40, i64 8, i32 1), !dbg !733
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 2, i32 1, i32 1), !dbg !734
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %3, i32 2, i32 1, i32 1), !dbg !734
  %42 = bitcast { i64, i32 }* %4 to i8*, !dbg !734
  %43 = bitcast %struct.dim3* %2 to i8*, !dbg !734
  %44 = call i8* @memcpy(i8* %42, i8* %43, i64 12)
  %45 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !734
  %46 = load i64* %45, align 1, !dbg !734
  %47 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !734
  %48 = load i32* %47, align 1, !dbg !734
  %49 = bitcast { i64, i32 }* %5 to i8*, !dbg !734
  %50 = bitcast %struct.dim3* %3 to i8*, !dbg !734
  %51 = call i8* @memcpy(i8* %49, i8* %50, i64 12)
  %52 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !734
  %53 = load i64* %52, align 1, !dbg !734
  %54 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !734
  %55 = load i32* %54, align 1, !dbg !734
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %46, i32 %48, i64 %53, i32 %55), !dbg !734
  %56 = load i32** %dev_a, align 8, !dbg !736
  %57 = load i32** %dev_b, align 8, !dbg !736
  call void @_Z3fooPiS_(i32* %56, i32* %57), !dbg !736
  %58 = load i32** %a, align 8, !dbg !737
  %59 = bitcast i32* %58 to i8*, !dbg !737
  %60 = load i32** %dev_a, align 8, !dbg !737
  %61 = bitcast i32* %60 to i8*, !dbg !737
  %62 = call i32 @cudaMemcpy(i8* %59, i8* %61, i64 8, i32 2), !dbg !737
  %63 = load i32** %b, align 8, !dbg !738
  %64 = bitcast i32* %63 to i8*, !dbg !738
  %65 = load i32** %dev_b, align 8, !dbg !738
  %66 = bitcast i32* %65 to i8*, !dbg !738
  %67 = call i32 @cudaMemcpy(i8* %64, i8* %66, i64 8, i32 2), !dbg !738
  store i32 0, i32* %i1, align 4, !dbg !739
  br label %68, !dbg !739

; <label>:68                                      ; preds = %71, %27
  %69 = load i32* %i1, align 4, !dbg !739
  %70 = icmp slt i32 %69, 2, !dbg !739
  br i1 %70, label %71, label %87, !dbg !739

; <label>:71                                      ; preds = %68
  %72 = load i32* %i1, align 4, !dbg !741
  %73 = load i32* %i1, align 4, !dbg !741
  %74 = sext i32 %73 to i64, !dbg !741
  %75 = load i32** %a, align 8, !dbg !741
  %76 = getelementptr inbounds i32* %75, i64 %74, !dbg !741
  %77 = load i32* %76, align 4, !dbg !741
  %78 = load i32* %i1, align 4, !dbg !741
  %79 = load i32* %i1, align 4, !dbg !741
  %80 = sext i32 %79 to i64, !dbg !741
  %81 = load i32** %b, align 8, !dbg !741
  %82 = getelementptr inbounds i32* %81, i64 %80, !dbg !741
  %83 = load i32* %82, align 4, !dbg !741
  %84 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i32 0, i32 0), i32 %72, i32 %77, i32 %78, i32 %83), !dbg !741
  %85 = load i32* %i1, align 4, !dbg !739
  %86 = add nsw i32 %85, 1, !dbg !739
  store i32 %86, i32* %i1, align 4, !dbg !739
  br label %68, !dbg !739

; <label>:87                                      ; preds = %68
  %88 = load i32** %a, align 8, !dbg !743
  %89 = getelementptr inbounds i32* %88, i64 2, !dbg !743
  %90 = load i32* %89, align 4, !dbg !743
  %91 = load i32** %b, align 8, !dbg !743
  %92 = getelementptr inbounds i32* %91, i64 2, !dbg !743
  %93 = load i32* %92, align 4, !dbg !743
  %94 = add nsw i32 %93, 1, !dbg !743
  %95 = icmp eq i32 %90, %94, !dbg !743
  br i1 %95, label %97, label %96, !dbg !743

; <label>:96                                      ; preds = %87
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i32 48, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwi
  unreachable, !dbg !743

; <label>:97                                      ; preds = %87
  %98 = load i32** %a, align 8, !dbg !744
  %99 = bitcast i32* %98 to i8*, !dbg !744
  call void @free(i8* %99) nounwind, !dbg !744
  %100 = load i32** %b, align 8, !dbg !744
  %101 = bitcast i32* %100 to i8*, !dbg !744
  call void @free(i8* %101) nounwind, !dbg !744
  %102 = load i32** %dev_a, align 8, !dbg !745
  %103 = bitcast i32* %102 to i8*, !dbg !745
  %104 = call i32 @cudaFree(i8* %103), !dbg !745
  %105 = load i32** %dev_b, align 8, !dbg !746
  %106 = bitcast i32* %105 to i8*, !dbg !746
  %107 = call i32 @cudaFree(i8* %106), !dbg !746
  ret i32 0, !dbg !747
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, m
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing", null} ; [ DW_TAG_file_type ]
...
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"foo", metadata !"foo", metadata !"_Z3fooPiS_", metadata !16, i32 10, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*)* @_Z3fooPiS_, null, null, metadata
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 10, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing/main.cpp]
!721 = metadata !{i32 14, i32 0, metadata !720, null}
!722 = metadata !{i32 22, i32 0, metadata !723, null}
!723 = metadata !{i32 786443, metadata !21, i32 16, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing/main.cpp]
!724 = metadata !{i32 23, i32 0, metadata !723, null}
!725 = metadata !{i32 25, i32 0, metadata !726, null}
!726 = metadata !{i32 786443, metadata !723, i32 25, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing/main.cpp]
!727 = metadata !{i32 26, i32 0, metadata !728, null}
!728 = metadata !{i32 786443, metadata !726, i32 25, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing/main.cpp]
!729 = metadata !{i32 27, i32 0, metadata !728, null}
!730 = metadata !{i32 30, i32 0, metadata !723, null}
!731 = metadata !{i32 31, i32 0, metadata !723, null}
!732 = metadata !{i32 33, i32 0, metadata !723, null}
!733 = metadata !{i32 34, i32 0, metadata !723, null}
!734 = metadata !{i32 35, i32 0, metadata !735, null}
!735 = metadata !{i32 786443, metadata !723, i32 35, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing/main.cpp]
!736 = metadata !{i32 37, i32 0, metadata !735, null}
!737 = metadata !{i32 41, i32 0, metadata !723, null}
!738 = metadata !{i32 42, i32 0, metadata !723, null}
!739 = metadata !{i32 44, i32 0, metadata !740, null}
!740 = metadata !{i32 786443, metadata !723, i32 44, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing/main.cpp]
!741 = metadata !{i32 45, i32 0, metadata !742, null}
!742 = metadata !{i32 786443, metadata !740, i32 44, i32 0, metadata !16, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing/main.cpp]
!743 = metadata !{i32 48, i32 0, metadata !723, null}
!744 = metadata !{i32 50, i32 0, metadata !723, null}
!745 = metadata !{i32 51, i32 0, metadata !723, null}
!746 = metadata !{i32 52, i32 0, metadata !723, null}
!747 = metadata !{i32 54, i32 0, metadata !723, null}
...
!751 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/018_testbasicaliasing//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types
