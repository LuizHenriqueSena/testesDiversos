...
@.str = private unnamed_addr constant [8 x i8] c"a[i]==1\00", align 1
...
define i32 @main() uwtable {
  ...
  %15 = load i32** %dev_a, align 8, !dbg !727
  %16 = bitcast i32* %15 to i8*, !dbg !727
  %17 = load i32** %a, align 8, !dbg !727
  %18 = bitcast i32* %17 to i8*, !dbg !727
  %19 = load i32* %size, align 4, !dbg !727
  %20 = sext i32 %19 to i64, !dbg !727
  %21 = call i32 @cudaMemcpy(i8* %16, i8* %18, i64 %20, i32 1), !dbg !727
  ...
  %22 = bitcast { i64, i32 }* %4 to i8*, !dbg !728
  %23 = bitcast %struct.dim3* %2 to i8*, !dbg !728
  %24 = call i8* @memcpy(i8* %22, i8* %23, i64 12)
  %25 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !728
  %26 = load i64* %25, align 1, !dbg !728
  %27 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !728
  %28 = load i32* %27, align 1, !dbg !728
  %29 = bitcast { i64, i32 }* %5 to i8*, !dbg !728
  %30 = bitcast %struct.dim3* %3 to i8*, !dbg !728
  %31 = call i8* @memcpy(i8* %29, i8* %30, i64 12)
  %32 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !728
  %33 = load i64* %32, align 1, !dbg !728
  %34 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !728
  %35 = load i32* %34, align 1, !dbg !728
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %26, i32 %28, i64 %33, i32 %35), !dbg !728
  %36 = load i32** %dev_a, align 8, !dbg !730
  call void @_Z3fooPi(i32* %36), !dbg !730
  %37 = load i32** %a, align 8, !dbg !731
  %38 = bitcast i32* %37 to i8*, !dbg !731
  %39 = load i32** %dev_a, align 8, !dbg !731
  %40 = bitcast i32* %39 to i8*, !dbg !731
  %41 = load i32* %size, align 4, !dbg !731
  %42 = sext i32 %41 to i64, !dbg !731
  %43 = call i32 @cudaMemcpy(i8* %38, i8* %40, i64 %42, i32 2), !dbg !731
  store i32 0, i32* %i, align 4, !dbg !732
  br label %44, !dbg !732

; <label>:44                                      ; preds = %55, %0
  %45 = load i32* %i, align 4, !dbg !732
  %46 = icmp slt i32 %45, 2, !dbg !732
  br i1 %46, label %47, label %58, !dbg !732

; <label>:47                                      ; preds = %44
  %48 = load i32* %i, align 4, !dbg !734
  %49 = sext i32 %48 to i64, !dbg !734
  %50 = load i32** %a, align 8, !dbg !734
  %51 = getelementptr inbounds i32* %50, i64 %49, !dbg !734
  %52 = load i32* %51, align 4, !dbg !734
  %53 = icmp eq i32 %52, 1, !dbg !734
  br i1 %53, label %55, label %54, !dbg !734

; <label>:54                                      ; preds = %47
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i32 32, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwind
  unreachable, !dbg !734

; <label>:55                                      ; preds = %47
  %56 = load i32* %i, align 4, !dbg !732
  %57 = add nsw i32 %56, 1, !dbg !732
  store i32 %57, i32* %i, align 4, !dbg !732
  br label %44, !dbg !732

; <label>:58                                      ; preds = %44
  %59 = load i32** %a, align 8, !dbg !736
  %60 = bitcast i32* %59 to i8*, !dbg !736
  call void @free(i8* %60) nounwind, !dbg !736
  %61 = load i32** %dev_a, align 8, !dbg !737
  %62 = bitcast i32* %61 to i8*, !dbg !737
  %63 = call i32 @cudaFree(i8* %62), !dbg !737
  ret i32 0, !dbg !738
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !11, 
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail", null} ; [ DW_TAG_file_type ]
...
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 7, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail/main.cpp]
...
!724 = metadata !{i32 786443, metadata !21, i32 12, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail/main.cpp]
...
!729 = metadata !{i32 786443, metadata !724, i32 23, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail/main.cpp]
!730 = metadata !{i32 25, i32 0, metadata !729, null}
!731 = metadata !{i32 29, i32 0, metadata !724, null}
!732 = metadata !{i32 31, i32 0, metadata !733, null}
!733 = metadata !{i32 786443, metadata !724, i32 31, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail/main.cpp]
!734 = metadata !{i32 32, i32 0, metadata !735, null}
!735 = metadata !{i32 786443, metadata !733, i32 31, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail/main.cpp]
!736 = metadata !{i32 35, i32 0, metadata !724, null}
!737 = metadata !{i32 37, i32 0, metadata !724, null}
!738 = metadata !{i32 39, i32 0, metadata !724, null}
...
!742 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/049_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
