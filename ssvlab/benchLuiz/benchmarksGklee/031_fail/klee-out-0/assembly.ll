...
@.str = private unnamed_addr constant [8 x i8] c"b[i]!=c\00", align 1
@.str1 = private unnamed_addr constant [9 x i8] c"main.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

define void @_Z3fooPff(float* %A, float %c) nounwind uwtable noinline {
  ...
  %5 = icmp ne i32 %4, 0, !dbg !720
  br i1 %5, label %6, label %9, !dbg !720

; <label>:6                                       ; preds = %0
  %7 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !720
  %8 = mul i32 2, %7, !dbg !720
  br label %9, !dbg !720

; <label>:9                                       ; preds = %0, %6
  %10 = phi i32 [ %8, %6 ], [ 1, %0 ], !dbg !720
  %11 = zext i32 %10 to i64, !dbg !720
  %12 = load float** %1, align 8, !dbg !720
  %13 = getelementptr inbounds float* %12, i64 %11, !dbg !720
  store float %3, float* %13, align 4, !dbg !720
  ret void, !dbg !722
}
...
define i32 @main() uwtable {
  ...
  store i32 0, i32* %1
  store float 2.000000e+00, float* %c, align 4, !dbg !723
  %6 = call noalias i8* @malloc(i64 16) nounwind, !dbg !725
  %7 = bitcast i8* %6 to float*, !dbg !725
  store float* %7, float** %b, align 8, !dbg !725
  %8 = bitcast float** %dev_b to i8**, !dbg !726
  %9 = call i32 @cudaMalloc(i8** %8, i64 16), !dbg !726
  ...
  %10 = bitcast { i64, i32 }* %4 to i8*, !dbg !727
  %11 = bitcast %struct.dim3* %2 to i8*, !dbg !727
  %12 = call i8* @memcpy(i8* %10, i8* %11, i64 12)
  %13 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !727
  %14 = load i64* %13, align 1, !dbg !727
  %15 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !727
  %16 = load i32* %15, align 1, !dbg !727
  %17 = bitcast { i64, i32 }* %5 to i8*, !dbg !727
  %18 = bitcast %struct.dim3* %3 to i8*, !dbg !727
  %19 = call i8* @memcpy(i8* %17, i8* %18, i64 12)
  %20 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !727
  %21 = load i64* %20, align 1, !dbg !727
  %22 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !727
  %23 = load i32* %22, align 1, !dbg !727
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %14, i32 %16, i64 %21, i32 %23), !dbg !727
  %24 = load float** %dev_b, align 8, !dbg !729
  %25 = load float* %c, align 4, !dbg !729
  call void @_Z3fooPff(float* %24, float %25), !dbg !729
  %26 = load float** %b, align 8, !dbg !730
  %27 = bitcast float* %26 to i8*, !dbg !730
  %28 = load float** %dev_b, align 8, !dbg !730
  %29 = bitcast float* %28 to i8*, !dbg !730
  %30 = call i32 @cudaMemcpy(i8* %27, i8* %29, i64 16, i32 2), !dbg !730
  store i32 0, i32* %i, align 4, !dbg !731
  br label %31, !dbg !731

; <label>:31                                      ; preds = %50, %0
  %32 = load i32* %i, align 4, !dbg !731
  %33 = icmp slt i32 %32, 4, !dbg !731
  br i1 %33, label %34, label %53, !dbg !731

; <label>:34                                      ; preds = %31
  %35 = load i32* %i, align 4, !dbg !733
  %36 = icmp sgt i32 %35, 0, !dbg !733
  br i1 %36, label %37, label %50, !dbg !733

; <label>:37                                      ; preds = %34
  %38 = load i32* %i, align 4, !dbg !733
  %39 = srem i32 %38, 2, !dbg !733
  %40 = icmp eq i32 %39, 0, !dbg !733
  br i1 %40, label %41, label %50, !dbg !733

; <label>:41                                      ; preds = %37
  %42 = load i32* %i, align 4, !dbg !735
  %43 = sext i32 %42 to i64, !dbg !735
  %44 = load float** %b, align 8, !dbg !735
  %45 = getelementptr inbounds float* %44, i64 %43, !dbg !735
  %46 = load float* %45, align 4, !dbg !735
  %47 = load float* %c, align 4, !dbg !735
  %48 = fcmp une float %46, %47, !dbg !735
  br i1 %48, label %50, label %49, !dbg !735

; <label>:49                                      ; preds = %41
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i32 39, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwind
  unreachable, !dbg !735

; <label>:50                                      ; preds = %34, %37, %41
  %51 = load i32* %i, align 4, !dbg !731
  %52 = add nsw i32 %51, 1, !dbg !731
  store i32 %52, i32* %i, align 4, !dbg !731
  br label %31, !dbg !731

; <label>:53                                      ; preds = %31
  %54 = load float** %b, align 8, !dbg !736
  %55 = bitcast float* %54 to i8*, !dbg !736
  call void @free(i8* %55) nounwind, !dbg !736
  %56 = load float** %dev_b, align 8, !dbg !737
  %57 = bitcast float* %56 to i8*, !dbg !737
  %58 = call i32 @cudaFree(i8* %57), !dbg !737
  ret i32 0, !dbg !738
}
...
define linkonce_odr void @_ZN4dim3C1Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr uwtable section "__device__" align 2 {
  ...
  %6 = load i32* %2, align 4, !dbg !739
  %7 = load i32* %3, align 4, !dbg !739
  %8 = load i32* %4, align 4, !dbg !739
  call void @_ZN4dim3C2Ejjj(%struct.dim3* %5, i32 %6, i32 %7, i32 %8), !dbg !739
  ret void, !dbg !739
}
...
define linkonce_odr void @_ZN4dim3C2Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr nounwind uwtable section "__device__" align 2 {
  ...
  store i32 %vz, i32* %4, align 4
  %5 = load %struct.dim3** %1
  %6 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 0, !dbg !740
  %7 = load i32* %2, align 4, !dbg !740
  store i32 %7, i32* %6, align 4, !dbg !740
  %8 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 1, !dbg !740
  %9 = load i32* %3, align 4, !dbg !740
  store i32 %9, i32* %8, align 4, !dbg !740
  %10 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 2, !dbg !740
  %11 = load i32* %4, align 4, !dbg !740
  store i32 %11, i32* %10, align 4, !dbg !740
  ret void, !dbg !741
}

define i8* @memcpy(i8* %destaddr, i8* nocapture %srcaddr, i64 %len) nounwind uwtable {
  %1 = icmp eq i64 %len, 0, !dbg !743
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !743

.lr.ph:                                           ; preds = %.lr.ph, %0
  %src.06 = phi i8* [ %3, %.lr.ph ], [ %srcaddr, %0 ]
  %dest.05 = phi i8* [ %5, %.lr.ph ], [ %destaddr, %0 ]
  %.04 = phi i64 [ %2, %.lr.ph ], [ %len, %0 ]
  %2 = add i64 %.04, -1, !dbg !743
  %3 = getelementptr inbounds i8* %src.06, i64 1, !dbg !744
  %4 = load i8* %src.06, align 1, !dbg !744, !tbaa !745
  %5 = getelementptr inbounds i8* %dest.05, i64 1, !dbg !744
  store i8 %4, i8* %dest.05, align 1, !dbg !744, !tbaa !745
  %6 = icmp eq i64 %2, 0, !dbg !743
  br i1 %6, label %._crit_edge, label %.lr.ph, !dbg !743

._crit_edge:                                      ; preds = %.lr.ph, %0
  ret i8* %destaddr, !dbg !747
}

declare void @llvm.dbg.value(metadata, i64, metadata) nounwind readnone

define i8* @memset(i8* %dst, i32 %s, i64 %count) nounwind uwtable {
  %1 = icmp eq i64 %count, 0, !dbg !748
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !748

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !749
  br label %3, !dbg !748

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.05 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.04 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.04, -1, !dbg !748
  %5 = getelementptr inbounds i8* %a.05, i64 1, !dbg !749
  store volatile i8 %2, i8* %a.05, align 1, !dbg !749, !tbaa !745
  %6 = icmp eq i64 %4, 0, !dbg !748
  br i1 %6, label %._crit_edge, label %3, !dbg !748
...
define i32 @cudaFree(i8* nocapture %devPtr) nounwind uwtable {
  tail call void @free(i8* %devPtr) nounwind, !dbg !753
  ret i32 0, !dbg !755
}

define i32 @cudaFreeArray(%struct.cudaArray* nocapture %array) nounwind uwtable {
  %1 = bitcast %struct.cudaArray* %array to i8*, !dbg !756
  tail call void @free(i8* %1) nounwind, !dbg !756
  ret i32 0, !dbg !758
}

define i32 @cudaFreeHost(i8* nocapture %ptr) nounwind uwtable {
  tail call void @free(i8* %ptr) nounwind, !dbg !759
  ret i32 0, !dbg !761
}
...
define i32 @cudaMalloc(i8** nocapture %devPtr, i64 %size) uwtable {
  tail call void @__set_device(), !dbg !776
  %1 = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !778
  store i8* %1, i8** %devPtr, align 8, !dbg !778, !tbaa !779
  tail call void @__clear_device(), !dbg !780
  ret i32 0, !dbg !781
}
...
define i32 @cudaMallocHost(i8** nocapture %ptr, i64 %size) uwtable {
  tail call void @__set_host(), !dbg !788
  %1 = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !790
  store i8* %1, i8** %ptr, align 8, !dbg !790, !tbaa !779
  tail call void @__clear_host(), !dbg !791
  ret i32 0, !dbg !792
}
...
define i32 @cudaMemcpyToSymbol(i8* nocapture %symbol, i8* nocapture %src, i64 %count, i64 %offset, i32 %kind) nounwind uwtable {
  %1 = getelementptr inbounds i8* %symbol, i64 %offset, !dbg !839
...
define i32 @cudaMemset(i8* nocapture %devPtr, i32 %value, i64 %count) nounwind uwtable {
  %1 = trunc i32 %value to i8, !dbg !846
  %2 = zext i8 %1 to i32
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !11, 
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail", null} ; [ DW_TAG_file_type ]
...
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail", null} ; [ DW_TAG_file_type ]
...
!21 = metadata !{i32 786478, i32 0, metadata !16, metadata !"main", metadata !"main", metadata !"", metadata !16, i32 17, metadata !22, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !11, i32 18} ; [ DW_TAG_
...
!26 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail", null} ; [ DW_TAG_file_type ]
...
!721 = metadata !{i32 786443, metadata !15, i32 11, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail/main.cpp]
!722 = metadata !{i32 15, i32 0, metadata !721, null}
!723 = metadata !{i32 21, i32 0, metadata !724, null}
!724 = metadata !{i32 786443, metadata !21, i32 18, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail/main.cpp]
!725 = metadata !{i32 23, i32 0, metadata !724, null}
!726 = metadata !{i32 25, i32 0, metadata !724, null}
!727 = metadata !{i32 26, i32 0, metadata !728, null}
!728 = metadata !{i32 786443, metadata !724, i32 26, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail/main.cpp]
!729 = metadata !{i32 28, i32 0, metadata !728, null}
!730 = metadata !{i32 32, i32 0, metadata !724, null}
!731 = metadata !{i32 36, i32 0, metadata !732, null}
!732 = metadata !{i32 786443, metadata !724, i32 36, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail/main.cpp]
!733 = metadata !{i32 38, i32 0, metadata !734, null}
!734 = metadata !{i32 786443, metadata !732, i32 36, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail/main.cpp]
!735 = metadata !{i32 39, i32 0, metadata !734, null}
!736 = metadata !{i32 42, i32 0, metadata !724, null}
!737 = metadata !{i32 43, i32 0, metadata !724, null}
!738 = metadata !{i32 44, i32 0, metadata !724, null}
!739 = metadata !{i32 419, i32 0, metadata !25, null}
!740 = metadata !{i32 419, i32 0, metadata !68, null}
!741 = metadata !{i32 419, i32 0, metadata !742, null}
!742 = metadata !{i32 786443, metadata !68, i32 419, i32 0, metadata !26, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/031_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
!743 = metadata !{i32 16, i32 0, metadata !87, null}
!744 = metadata !{i32 17, i32 0, metadata !87, null}
!745 = metadata !{metadata !"omnipotent char", metadata !746}
!746 = metadata !{metadata !"Simple C/C++ TBAA"}
!747 = metadata !{i32 18, i32 0, metadata !87, null}
!748 = metadata !{i32 14, i32 0, metadata !123, null}
!749 = metadata !{i32 15, i32 0, metadata !123, null}
!750 = metadata !{i32 16, i32 0, metadata !123, null}
!751 = metadata !{i32 26, i32 0, metadata !752, null}
!752 = metadata !{i32 786443, metadata !213, i32 25, i32 0, metadata !214, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!753 = metadata !{i32 30, i32 0, metadata !754, null}
!754 = metadata !{i32 786443, metadata !242, i32 29, i32 0, metadata !214, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!755 = metadata !{i32 31, i32 0, metadata !754, null}
!756 = metadata !{i32 35, i32 0, metadata !757, null}
!757 = metadata !{i32 786443, metadata !248, i32 34, i32 0, metadata !214, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!758 = metadata !{i32 36, i32 0, metadata !757, null}
!759 = metadata !{i32 40, i32 0, metadata !760, null}
!760 = metadata !{i32 786443, metadata !254, i32 39, i32 0, metadata !214, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!761 = metadata !{i32 41, i32 0, metadata !760, null}
!762 = metadata !{i32 45, i32 0, metadata !763, null}
!763 = metadata !{i32 786443, metadata !258, i32 44, i32 0, metadata !214, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!764 = metadata !{i32 49, i32 0, metadata !765, null}
!765 = metadata !{i32 786443, metadata !266, i32 48, i32 0, metadata !214, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!766 = metadata !{i32 53, i32 0, metadata !767, null}
!767 = metadata !{i32 786443, metadata !274, i32 52, i32 0, metadata !214, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!768 = metadata !{i32 57, i32 0, metadata !769, null}
!769 = metadata !{i32 786443, metadata !282, i32 56, i32 0, metadata !214, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!770 = metadata !{i32 61, i32 0, metadata !771, null}
!771 = metadata !{i32 786443, metadata !290, i32 60, i32 0, metadata !214, i32 8} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!772 = metadata !{i32 65, i32 0, metadata !773, null}
!773 = metadata !{i32 786443, metadata !297, i32 64, i32 0, metadata !214, i32 9} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!774 = metadata !{i32 69, i32 0, metadata !775, null}
!775 = metadata !{i32 786443, metadata !305, i32 68, i32 0, metadata !214, i32 10} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!776 = metadata !{i32 73, i32 0, metadata !777, null}
!777 = metadata !{i32 786443, metadata !309, i32 72, i32 0, metadata !214, i32 11} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!778 = metadata !{i32 74, i32 0, metadata !777, null}
!779 = metadata !{metadata !"any pointer", metadata !745}
!780 = metadata !{i32 75, i32 0, metadata !777, null}
!781 = metadata !{i32 77, i32 0, metadata !777, null}
!782 = metadata !{i32 81, i32 0, metadata !783, null}
!783 = metadata !{i32 786443, metadata !316, i32 80, i32 0, metadata !214, i32 12} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!784 = metadata !{i32 86, i32 0, metadata !785, null}
!785 = metadata !{i32 786443, metadata !330, i32 85, i32 0, metadata !214, i32 13} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!786 = metadata !{i32 91, i32 0, metadata !787, null}
!787 = metadata !{i32 786443, metadata !340, i32 90, i32 0, metadata !214, i32 14} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!788 = metadata !{i32 95, i32 0, metadata !789, null}
!789 = metadata !{i32 786443, metadata !350, i32 94, i32 0, metadata !214, i32 15} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!790 = metadata !{i32 96, i32 0, metadata !789, null}
!791 = metadata !{i32 97, i32 0, metadata !789, null}
!792 = metadata !{i32 99, i32 0, metadata !789, null}
!793 = metadata !{i32 103, i32 0, metadata !794, null}
!794 = metadata !{i32 786443, metadata !355, i32 102, i32 0, metadata !214, i32 16} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!795 = metadata !{i32 108, i32 0, metadata !796, null}
!796 = metadata !{i32 786443, metadata !364, i32 106, i32 0, metadata !214, i32 17} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!797 = metadata !{i32 113, i32 0, metadata !798, null}
!798 = metadata !{i32 786443, metadata !373, i32 112, i32 0, metadata !214, i32 18} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!799 = metadata !{i32 119, i32 0, metadata !800, null}
!800 = metadata !{i32 786443, metadata !385, i32 118, i32 0, metadata !214, i32 19} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!801 = metadata !{i32 125, i32 0, metadata !802, null}
!802 = metadata !{i32 786443, metadata !399, i32 124, i32 0, metadata !214, i32 20} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!803 = metadata !{i32 131, i32 0, metadata !804, null}
!804 = metadata !{i32 786443, metadata !415, i32 130, i32 0, metadata !214, i32 21} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!805 = metadata !{i32 137, i32 0, metadata !806, null}
!806 = metadata !{i32 786443, metadata !428, i32 136, i32 0, metadata !214, i32 22} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!807 = metadata !{i32 143, i32 0, metadata !808, null}
!808 = metadata !{i32 786443, metadata !442, i32 142, i32 0, metadata !214, i32 23} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!809 = metadata !{i32 149, i32 0, metadata !810, null}
!810 = metadata !{i32 786443, metadata !455, i32 148, i32 0, metadata !214, i32 24} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!811 = metadata !{i32 153, i32 0, metadata !812, null}
!812 = metadata !{i32 786443, metadata !469, i32 152, i32 0, metadata !214, i32 25} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!813 = metadata !{i32 157, i32 0, metadata !814, null}
!814 = metadata !{i32 786443, metadata !493, i32 156, i32 0, metadata !214, i32 26} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!815 = metadata !{i32 161, i32 0, metadata !816, null}
!816 = metadata !{i32 786443, metadata !500, i32 160, i32 0, metadata !214, i32 27} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!817 = metadata !{i32 165, i32 0, metadata !818, null}
!818 = metadata !{i32 786443, metadata !519, i32 164, i32 0, metadata !214, i32 28} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!819 = metadata !{i32 171, i32 0, metadata !820, null}
!820 = metadata !{i32 786443, metadata !526, i32 170, i32 0, metadata !214, i32 29} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!821 = metadata !{i32 176, i32 0, metadata !822, null}
!822 = metadata !{i32 786443, metadata !539, i32 175, i32 0, metadata !214, i32 30} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!823 = metadata !{i32 181, i32 0, metadata !824, null}
!824 = metadata !{i32 786443, metadata !549, i32 180, i32 0, metadata !214, i32 31} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!825 = metadata !{i32 187, i32 0, metadata !826, null}
!826 = metadata !{i32 786443, metadata !560, i32 186, i32 0, metadata !214, i32 32} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!827 = metadata !{i32 192, i32 0, metadata !828, null}
!828 = metadata !{i32 786443, metadata !572, i32 191, i32 0, metadata !214, i32 33} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!829 = metadata !{i32 198, i32 0, metadata !830, null}
!830 = metadata !{i32 786443, metadata !582, i32 197, i32 0, metadata !214, i32 34} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!831 = metadata !{i32 203, i32 0, metadata !832, null}
!832 = metadata !{i32 786443, metadata !593, i32 201, i32 0, metadata !214, i32 35} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!833 = metadata !{i32 209, i32 0, metadata !834, null}
!834 = metadata !{i32 786443, metadata !603, i32 207, i32 0, metadata !214, i32 36} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!835 = metadata !{i32 214, i32 0, metadata !836, null}
!836 = metadata !{i32 786443, metadata !614, i32 213, i32 0, metadata !214, i32 37} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!837 = metadata !{i32 220, i32 0, metadata !838, null}
!838 = metadata !{i32 786443, metadata !625, i32 219, i32 0, metadata !214, i32 38} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!839 = metadata !{i32 225, i32 0, metadata !840, null}
!840 = metadata !{i32 786443, metadata !637, i32 224, i32 0, metadata !214, i32 39} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!841 = metadata !{i32 226, i32 0, metadata !840, null}
!842 = metadata !{i32 231, i32 0, metadata !843, null}
!843 = metadata !{i32 786443, metadata !647, i32 230, i32 0, metadata !214, i32 40} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!844 = metadata !{i32 235, i32 0, metadata !845, null}
!845 = metadata !{i32 786443, metadata !658, i32 234, i32 0, metadata !214, i32 41} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!846 = metadata !{i32 239, i32 0, metadata !847, null}
!847 = metadata !{i32 786443, metadata !665, i32 238, i32 0, metadata !214, i32 42} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!848 = metadata !{i32 240, i32 0, metadata !847, null}
!849 = metadata !{i32 245, i32 0, metadata !850, null}
!850 = metadata !{i32 786443, metadata !673, i32 244, i32 0, metadata !214, i32 43} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!851 = metadata !{i32 250, i32 0, metadata !852, null}
!852 = metadata !{i32 786443, metadata !683, i32 249, i32 0, metadata !214, i32 44} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!853 = metadata !{i32 255, i32 0, metadata !854, null}
!854 = metadata !{i32 786443, metadata !694, i32 254, i32 0, metadata !214, i32 45} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!855 = metadata !{i32 260, i32 0, metadata !856, null}
!856 = metadata !{i32 786443, metadata !702, i32 259, i32 0, metadata !214, i32 46} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!857 = metadata !{i32 264, i32 0, metadata !858, null}
!858 = metadata !{i32 786443, metadata !711, i32 263, i32 0, metadata !214, i32 47} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
