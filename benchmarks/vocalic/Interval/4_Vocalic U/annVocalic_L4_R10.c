...
__ESBMC_assume((layer1[0] >= 0.84966802597) && (layer1[0] <= 0.995974004269));
...
__ESBMC_assume((layer1[1] >= 0.999154984951) && (layer1[1] <= 0.999978005886));
...
__ESBMC_assume((layer1[2] >= 0.956477999687) && (layer1[2] <= 0.999337017536));
...
__ESBMC_assume((layer1[3] >= 0.86294901371) && (layer1[3] <= 0.996738016605));
...
__ESBMC_assume((layer1[4] >= 0.99999499321) && (layer1[4] <= 1));
float layer2[4];
...
__ESBMC_assume(((layer2[0] >= 6.60000005155e-05) && (layer2[0] <= 0.000453999993624)));
...
__ESBMC_assume(((layer2[1] >= 0.98704200983) && (layer2[1] <= 0.995949983597)));
...
__ESBMC_assume(((layer2[2] >= 0.00197899993509) && (layer2[2] <= 0.0052049998194)));
...
__ESBMC_assume(((layer2[3] >= 0.0987669974566) && (layer2[3] <= 0.22011500597)));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 0.000717999995686) && (layer3[0] <= 0.000793999992311));
int r = 0;
...
__ESBMC_assume((layer3[2] >= 1.99999999495e-06) && (layer3[2] <= 6.00000021223e-06));
...
__ESBMC_assume((layer3[3] >= 0.00219999998808) && (layer3[3] <= 0.0102620003745));
...
__ESBMC_assume((layer3[4] >= 0.91084498167) && (layer3[4] <= 0.97301197052));
