...
int x0 = nondet_int();
__ESBMC_assume((x0 >= 485)&&(x0 <=494));
int x1 = nondet_int();
__ESBMC_assume((x1 >= 297)&&(x1 <=302));
int x2 = nondet_int();
...
float layer1[7];
layer1[0]= (-0.259293f)*i[0] + (0.337188f)*i[1] + (-0.553619f)*i[2] + (-0.396830f)*i[3] + (-0.019240f);
layer1[0] = sigmoidLUT(layer1[0]);
layer1[1]= (-0.224814f)*i[0] + (1.332844f)*i[1] + (-0.148397f)*i[2] + (0.727559f)*i[3] + (-0.016677f);
layer1[1] = sigmoidLUT(layer1[1]);
layer1[2]= (0.221390f)*i[0] + (-0.476375f)*i[1] + (-0.147145f)*i[2] + (0.651486f)*i[3] + (-0.017581f);
layer1[2] = sigmoidLUT(layer1[2]);
layer1[3]= (-0.324553f)*i[0] + (0.195045f)*i[1] + (-0.037613f)*i[2] + (0.068103f)*i[3] + (-0.118043f);
layer1[3] = sigmoidLUT(layer1[3]);
layer1[4]= (-0.079880f)*i[0] + (-1.363340f)*i[1] + (-0.391765f)*i[2] + (0.248677f)*i[3] + (-0.018501f);
layer1[4] = sigmoidLUT(layer1[4]);
layer1[5]= (-0.070675f)*i[0] + (-0.367779f)*i[1] + (-0.542259f)*i[2] + (0.474309f)*i[3] + (0.077769f);
layer1[5] = sigmoidLUT(layer1[5]);
layer1[6]= (0.981716f)*i[0] + (0.405520f)*i[1] + (0.461122f)*i[2] + (-1.402215f)*i[3] + (0.674765f);
