...
@_ZZ3foovE1A = internal global [10 x i32] zeroinitializer, section "__shared__", align 16
...
define void @_Z3foov() uwtable noinline {
  ...
  %3 = getelementptr inbounds [10 x i32]* @_ZZ3foovE1A, i32 0, i64 %2, !dbg !248
  store i32 2, i32* %3, align 4, !dbg !248
  call void @__syncthreads(), !dbg !250
  %4 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !251
  %5 = add i32 %4, 1, !dbg !251
  %6 = zext i32 %5 to i64, !dbg !251
  %7 = getelementptr inbounds [10 x i32]* @_ZZ3foovE1A, i32 0, i64 %6, !dbg !251
  %8 = load i32* %7, align 4, !dbg !251
  store i32 %8, i32* %x, align 4, !dbg !251
  ret void, !dbg !252
}
...
define i32 @main() uwtable {
  ...
  %3 = alloca { i64, i32 }
  %4 = alloca { i64, i32 }
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %1, i32 1, i32 1, i32 1), !dbg !253
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 2, i32 1, i32 1), !dbg !253
  %5 = bitcast { i64, i32 }* %3 to i8*, !dbg !253
  %6 = bitcast %struct.dim3* %1 to i8*, !dbg !253
  %7 = call i8* @memcpy(i8* %5, i8* %6, i64 12)
  %8 = getelementptr { i64, i32 }* %3, i32 0, i32 0, !dbg !253
  %9 = load i64* %8, align 1, !dbg !253
  %10 = getelementptr { i64, i32 }* %3, i32 0, i32 1, !dbg !253
  %11 = load i32* %10, align 1, !dbg !253
  %12 = bitcast { i64, i32 }* %4 to i8*, !dbg !253
  %13 = bitcast %struct.dim3* %2 to i8*, !dbg !253
  %14 = call i8* @memcpy(i8* %12, i8* %13, i64 12)
  %15 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !253
  %16 = load i64* %15, align 1, !dbg !253
  %17 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !253
  %18 = load i32* %17, align 1, !dbg !253
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %9, i32 %11, i64 %16, i32 %18), !dbg !253
  call void @_Z3foov(), !dbg !256
  %19 = call i32 @cudaThreadSynchronize(), !dbg !257
  ret i32 0, !dbg !258
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/081_localarrayaccess", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, me
!1 = metadata !{metadata !2}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{metadata !5, metadata !9, metadata !13, metadata !56}
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"foo", metadata !"foo", metadata !"_Z3foov", metadata !6, i32 11, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ()* @_Z3foov, null, null, metadata !1, i32 11} ; [ DW_
!6 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/081_localarrayaccess", null} ; [ DW_TAG_file_type ]
!7 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !8, i32 0, i32 0} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!8 = metadata !{null}
!9 = metadata !{i32 786478, i32 0, metadata !6, metadata !"main", metadata !"main", metadata !"", metadata !6, i32 23, metadata !10, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !1, i32 23} ; [ DW_TAG_subp
...
!14 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/081_localarrayaccess", null} ; [ DW_TAG_file_type ]
...
!59 = metadata !{i32 786484, i32 0, metadata !5, metadata !"A", metadata !"A", metadata !"", metadata !6, i32 13, metadata !60, i32 1, i32 1, [10 x i32]* @_ZZ3foovE1A} ; [ DW_TAG_variable ] [A] [line 13] [local] [def]
!60 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 320, i64 32, i32 0, i32 0, metadata !12, metadata !61, i32 0, i32 0} ; [ DW_TAG_array_type ] [line 0, size 320, align 32, offset 0] [from int]
...
!248 = metadata !{i32 15, i32 0, metadata !249, null}
!249 = metadata !{i32 786443, metadata !5, i32 11, i32 0, metadata !6, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/081_localarrayaccess/main.cpp]
!250 = metadata !{i32 17, i32 0, metadata !249, null}
!251 = metadata !{i32 19, i32 0, metadata !249, null}
!252 = metadata !{i32 21, i32 0, metadata !249, null}
!253 = metadata !{i32 24, i32 0, metadata !254, null}
!254 = metadata !{i32 786443, metadata !255, i32 24, i32 0, metadata !6, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/081_localarrayaccess/main.cpp]
!255 = metadata !{i32 786443, metadata !9, i32 23, i32 0, metadata !6, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/081_localarrayaccess/main.cpp]
!256 = metadata !{i32 26, i32 0, metadata !254, null}
!257 = metadata !{i32 30, i32 0, metadata !255, null}
!258 = metadata !{i32 32, i32 0, metadata !255, null}
...
!262 = metadata !{i32 786443, metadata !56, i32 419, i32 0, metadata !14, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/081_localarrayaccess//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.
