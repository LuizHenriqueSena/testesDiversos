...
__ESBMC_assume((layer2[0]  >= 0.00350499991328) && (layer2[0] <= 0.845534980297));
...
__ESBMC_assume((layer2[1]  >= 0.00252200011164) && (layer2[1] <= 0.0227540004998));
...
__ESBMC_assume((layer2[2]  >= 0) && (layer2[2] <= 0.00975700002164));
...
__ESBMC_assume((layer2[3]  >= 0.305763989687) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[1]  >= 0) && (layer3[1] <= 0.959300994873));
...
__ESBMC_assume((layer3[2]  >= 0) && (layer3[2] <= 0.964429020882));
...
__ESBMC_assume((layer3[3]  >= 0) && (layer3[3] <= 0.437824010849));
