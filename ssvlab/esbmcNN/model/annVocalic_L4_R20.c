...
__ESBMC_assume((layer1[0] >= 0.239941999316) && (layer1[0] <= 0.998347997665));
...
__ESBMC_assume((layer1[1] >= 0.98730802536) && (layer1[1] <= 0.999990999699));
...
__ESBMC_assume((layer1[2] >= 0.607544004917) && (layer1[2] <= 0.999863028526));
...
__ESBMC_assume((layer1[3] >= 0.409750014544) && (layer1[3] <= 0.999387979507));
...
__ESBMC_assume((layer1[4] >= 0.99994802475) && (layer1[4] <= 1));
float layer2[4];
...
__ESBMC_assume((layer2[0] >= 1.70000002981e-05) && (layer2[0] <= 0.321911990643));
...
__ESBMC_assume((layer2[1] >= 0.397235006094) && (layer2[1] <= 0.997730970383));
...
__ESBMC_assume((layer2[2] >= 0.000216000000364) && (layer2[2] <= 0.0320149995387));
...
__ESBMC_assume((layer2[3] >= 0.0405820012093) && (layer2[3] <= 0.88933801651));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 2.99999992421e-05) && (layer3[0] <= 0.00582899991423));
int r = 0;
...
__ESBMC_assume((layer3[1] >= 0) && (layer3[1] <= 0.00177700002678));
...
__ESBMC_assume((layer3[2] >= 0) && (layer3[2] <= 0.291316002607));
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.560945987701));
...
__ESBMC_assume((layer3[4] >= 4.30000000051e-05) && (layer3[4] <= 0.984767973423));
