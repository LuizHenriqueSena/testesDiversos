...
@__PRETTY_FUNCTION__._Z3fooii = private unnamed_addr constant [19 x i8] c"void foo(int, int)\00", align 1
@blockDim = external global %struct.dim3

define void @_Z3fooii(i32 %w, i32 %h) uwtable noinline {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 %w, i32* %1, align 4
  store i32 %h, i32* %2, align 4
  %3 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !242
  store i32 %3, i32* %i, align 4, !dbg !242
  br label %4, !dbg !242

; <label>:4                                       ; preds = %11, %0
  %5 = load i32* %i, align 4, !dbg !242
  %6 = load i32* %1, align 4, !dbg !242
  %7 = icmp slt i32 %5, %6, !dbg !242
  br i1 %7, label %8, label %16, !dbg !242

; <label>:8                                       ; preds = %4
  %9 = load i32* %2, align 4, !dbg !245
  %10 = icmp eq i32 %9, 0, !dbg !245
  br i1 %10, label %11, label %15, !dbg !245

; <label>:11                                      ; preds = %8
  call void @_Z3bari(i32 5), !dbg !247
  %12 = load i32* getelementptr inbounds (%struct.dim3* @blockDim, i32 0, i32 0), align 4, !dbg !248
  %13 = load i32* %i, align 4, !dbg !248
  %14 = add i32 %13, %12, !dbg !248
  store i32 %14, i32* %i, align 4, !dbg !248
  br label %4, !dbg !248

; <label>:15                                      ; preds = %8
  call void @__assert_fail(i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i32 21, i8* getelementptr inbounds ([19 x i8]* @__PRETTY_FUNCTION__._Z3fooii, i32 0, i32 0)) noreturn noun
  unreachable, !dbg !249
...
declare void @_Z3bari(i32) section "__device__"
...
define i32 @main() uwtable {
  ...
  %5 = alloca { i64, i32 }
  store i32 0, i32* %1
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 1, i32 1, i32 1), !dbg !251
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %3, i32 2, i32 1, i32 1), !dbg !251
  %6 = bitcast { i64, i32 }* %4 to i8*, !dbg !251
  %7 = bitcast %struct.dim3* %2 to i8*, !dbg !251
  %8 = call i8* @memcpy(i8* %6, i8* %7, i64 12)
  %9 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !251
  %10 = load i64* %9, align 1, !dbg !251
  %11 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !251
  %12 = load i32* %11, align 1, !dbg !251
  %13 = bitcast { i64, i32 }* %5 to i8*, !dbg !251
  %14 = bitcast %struct.dim3* %3 to i8*, !dbg !251
  %15 = call i8* @memcpy(i8* %13, i8* %14, i64 12)
  %16 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !251
  %17 = load i64* %16, align 1, !dbg !251
  %18 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !251
  %19 = load i32* %18, align 1, !dbg !251
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %10, i32 %12, i64 %17, i32 %19), !dbg !251
  call void @_Z3fooii(i32 5, i32 0), !dbg !254
  %20 = call i32 @cudaThreadSynchronize(), !dbg !255
  ret i32 0, !dbg !256
}
...
define linkonce_odr void @_ZN4dim3C1Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr uwtable section "__device__" align 2 {
  ...
  %6 = load i32* %2, align 4, !dbg !257
  %7 = load i32* %3, align 4, !dbg !257
  %8 = load i32* %4, align 4, !dbg !257
  call void @_ZN4dim3C2Ejjj(%struct.dim3* %5, i32 %6, i32 %7, i32 %8), !dbg !257
  ret void, !dbg !257
}
...
define linkonce_odr void @_ZN4dim3C2Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr nounwind uwtable section "__device__" align 2 {
  ...
  store i32 %vz, i32* %4, align 4
  %5 = load %struct.dim3** %1
  %6 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 0, !dbg !258
  %7 = load i32* %2, align 4, !dbg !258
  store i32 %7, i32* %6, align 4, !dbg !258
  %8 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 1, !dbg !258
  %9 = load i32* %3, align 4, !dbg !258
  store i32 %9, i32* %8, align 4, !dbg !258
  %10 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 2, !dbg !258
  %11 = load i32* %4, align 4, !dbg !258
  store i32 %11, i32* %10, align 4, !dbg !258
  ret void, !dbg !259
}
...
.lr.ph:                                           ; preds = %.lr.ph, %0
  ...
  %2 = add i64 %.04, -1, !dbg !261
  %3 = getelementptr inbounds i8* %src.06, i64 1, !dbg !262
  %4 = load i8* %src.06, align 1, !dbg !262, !tbaa !263
  %5 = getelementptr inbounds i8* %dest.05, i64 1, !dbg !262
  store i8 %4, i8* %dest.05, align 1, !dbg !262, !tbaa !263
  %6 = icmp eq i64 %2, 0, !dbg !261
  br i1 %6, label %._crit_edge, label %.lr.ph, !dbg !261

._crit_edge:                                      ; preds = %.lr.ph, %0
  ret i8* %destaddr, !dbg !265
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, 
!1 = metadata !{metadata !2}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{metadata !5, metadata !10, metadata !13, metadata !56}
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"foo", metadata !"foo", metadata !"_Z3fooii", metadata !6, i32 12, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32, i32)* @_Z3fooii, null, null, metadata !1, i32 1
!6 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4", null} ; [ DW_TAG_file_type ]
!7 = metadata !{i32 786453, i32 0, metadata !"", i32 0, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !8, i32 0, i32 0} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!8 = metadata !{null, metadata !9, metadata !9}
!9 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ] [int] [line 0, size 32, align 32, offset 0, enc DW_ATE_signed]
!10 = metadata !{i32 786478, i32 0, metadata !6, metadata !"main", metadata !"main", metadata !"", metadata !6, i32 25, metadata !11, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !1, i32 25} ; [ DW_TAG_sub
...
!14 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4", null} ; [ DW_TAG_file_type ]
...
!103 = metadata !{metadata !64, metadata !64, metadata !9, metadata !104}
...
!108 = metadata !{i32 786689, metadata !100, metadata !"s", metadata !101, i32 33554444, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [s] [line 12]
...
!242 = metadata !{i32 15, i32 0, metadata !243, null}
!243 = metadata !{i32 786443, metadata !244, i32 15, i32 0, metadata !6, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4/main.cpp]
!244 = metadata !{i32 786443, metadata !5, i32 13, i32 0, metadata !6, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4/main.cpp]
!245 = metadata !{i32 18, i32 0, metadata !246, null}
!246 = metadata !{i32 786443, metadata !243, i32 16, i32 0, metadata !6, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4/main.cpp]
!247 = metadata !{i32 19, i32 0, metadata !246, null}
!248 = metadata !{i32 16, i32 0, metadata !243, null}
!249 = metadata !{i32 21, i32 0, metadata !246, null}
!250 = metadata !{i32 23, i32 0, metadata !244, null}
!251 = metadata !{i32 26, i32 0, metadata !252, null}
!252 = metadata !{i32 786443, metadata !253, i32 26, i32 0, metadata !6, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4/main.cpp]
!253 = metadata !{i32 786443, metadata !10, i32 25, i32 0, metadata !6, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4/main.cpp]
!254 = metadata !{i32 28, i32 0, metadata !252, null}
!255 = metadata !{i32 32, i32 0, metadata !253, null}
!256 = metadata !{i32 34, i32 0, metadata !253, null}
!257 = metadata !{i32 419, i32 0, metadata !13, null}
!258 = metadata !{i32 419, i32 0, metadata !56, null}
!259 = metadata !{i32 419, i32 0, metadata !260, null}
!260 = metadata !{i32 786443, metadata !56, i32 419, i32 0, metadata !14, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/054_misc4//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
!261 = metadata !{i32 16, i32 0, metadata !75, null}
!262 = metadata !{i32 17, i32 0, metadata !75, null}
!263 = metadata !{metadata !"omnipotent char", metadata !264}
!264 = metadata !{metadata !"Simple C/C++ TBAA"}
!265 = metadata !{i32 18, i32 0, metadata !75, null}
!266 = metadata !{i32 14, i32 0, metadata !267, null}
!267 = metadata !{i32 786443, metadata !207, i32 13, i32 0, metadata !208, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!268 = metadata !{i32 18, i32 0, metadata !269, null}
!269 = metadata !{i32 786443, metadata !212, i32 17, i32 0, metadata !208, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!270 = metadata !{i32 22, i32 0, metadata !271, null}
!271 = metadata !{i32 786443, metadata !219, i32 21, i32 0, metadata !208, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!272 = metadata !{i32 26, i32 0, metadata !273, null}
!273 = metadata !{i32 786443, metadata !228, i32 25, i32 0, metadata !208, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!274 = metadata !{i32 30, i32 0, metadata !275, null}
!275 = metadata !{i32 786443, metadata !234, i32 29, i32 0, metadata !208, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!276 = metadata !{i32 34, i32 0, metadata !277, null}
!277 = metadata !{i32 786443, metadata !241, i32 33, i32 0, metadata !208, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
