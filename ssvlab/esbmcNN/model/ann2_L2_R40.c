...
int x0 = nondet_int();
__ESBMC_assume((x0 >= 477)&&(x0 <=502));
int x1 = nondet_int();
__ESBMC_assume((x1 >= 292)&&(x1 <=307));
int x2 = nondet_int();
__ESBMC_assume((x2 >= 136)&&(x2 <=143));
int x3 = nondet_int();
...
float layer1[7];
layer1[0]= (-0.259293f)*i[0] + (-0.542259f)*i[1] + (-1.363340f)*i[2] + (-0.324553f)*i[3] + (-0.019240f);
layer1[0] = sigmoidLUT(layer1[0]);
layer1[1]= (0.727559f)*i[0] + (-0.553619f)*i[1] + (0.981716f)*i[2] + (0.248677f)*i[3] + (-0.016677f);
layer1[1] = sigmoidLUT(layer1[1]);
layer1[2]= (-0.037613f)*i[0] + (-0.476375f)*i[1] + (-0.224814f)*i[2] + (0.461122f)*i[3] + (-0.017581f);
layer1[2] = sigmoidLUT(layer1[2]);
layer1[3]= (-0.367779f)*i[0] + (-0.079880f)*i[1] + (0.651486f)*i[2] + (-0.148397f)*i[3] + (-0.118043f);
layer1[3] = sigmoidLUT(layer1[3]);
layer1[4]= (0.337188f)*i[0] + (0.474309f)*i[1] + (-0.391765f)*i[2] + (0.195045f)*i[3] + (-0.018501f);
layer1[4] = sigmoidLUT(layer1[4]);
layer1[5]= (0.221390f)*i[0] + (-0.396830f)*i[1] + (0.405520f)*i[2] + (-0.070675f)*i[3] + (0.077769f);
layer1[5] = sigmoidLUT(layer1[5]);
layer1[6]= (0.068103f)*i[0] + (-0.147145f)*i[1] + (1.332844f)*i[2] + (-1.402215f)*i[3] + (0.674765f);
