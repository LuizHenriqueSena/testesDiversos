...
@.str = private unnamed_addr constant [13 x i8] c"d[i]==c[i+1]\00", align 1
...
define void @_Z3fooPi(i32* %p) nounwind uwtable noinline {
  ...
  %3 = getelementptr inbounds i32* %2, i64 1, !dbg !719
  store i32* %3, i32** %q, align 8, !dbg !719
  %4 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !721
  %5 = zext i32 %4 to i64, !dbg !721
  %6 = load i32** %q, align 8, !dbg !721
  %7 = getelementptr inbounds i32* %6, i64 %5, !dbg !721
  %8 = load i32* %7, align 4, !dbg !721
  %9 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !721
  %10 = zext i32 %9 to i64, !dbg !721
  %11 = load i32** %1, align 8, !dbg !721
  %12 = getelementptr inbounds i32* %11, i64 %10, !dbg !721
  store i32 %8, i32* %12, align 4, !dbg !721
  ret void, !dbg !722
}
...
define i32 @main() uwtable {
  ...
  %8 = call noalias i8* @malloc(i64 8) nounwind, !dbg !725
  %9 = bitcast i8* %8 to i32*, !dbg !725
  store i32* %9, i32** %d, align 8, !dbg !725
  store i32 0, i32* %i, align 4, !dbg !726
  br label %10, !dbg !726

; <label>:10                                      ; preds = %13, %0
  %11 = load i32* %i, align 4, !dbg !726
  %12 = icmp slt i32 %11, 2, !dbg !726
  br i1 %12, label %13, label %20, !dbg !726

; <label>:13                                      ; preds = %10
  %14 = load i32* %i, align 4, !dbg !728
  %15 = sext i32 %14 to i64, !dbg !728
  %16 = load i32** %c, align 8, !dbg !728
  %17 = getelementptr inbounds i32* %16, i64 %15, !dbg !728
  store i32 5, i32* %17, align 4, !dbg !728
  %18 = load i32* %i, align 4, !dbg !726
  %19 = add nsw i32 %18, 1, !dbg !726
  store i32 %19, i32* %i, align 4, !dbg !726
  br label %10, !dbg !726

; <label>:20                                      ; preds = %10
  %21 = bitcast i32** %dev_c to i8**, !dbg !729
  %22 = call i32 @cudaMalloc(i8** %21, i64 8), !dbg !729
  %23 = load i32** %dev_c, align 8, !dbg !730
  %24 = bitcast i32* %23 to i8*, !dbg !730
  %25 = load i32** %c, align 8, !dbg !730
  %26 = bitcast i32* %25 to i8*, !dbg !730
  %27 = call i32 @cudaMemcpy(i8* %24, i8* %26, i64 8, i32 1), !dbg !730
  ...
  %28 = bitcast { i64, i32 }* %4 to i8*, !dbg !731
  %29 = bitcast %struct.dim3* %2 to i8*, !dbg !731
  %30 = call i8* @memcpy(i8* %28, i8* %29, i64 12)
  %31 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !731
  %32 = load i64* %31, align 1, !dbg !731
  %33 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !731
  %34 = load i32* %33, align 1, !dbg !731
  %35 = bitcast { i64, i32 }* %5 to i8*, !dbg !731
  %36 = bitcast %struct.dim3* %3 to i8*, !dbg !731
  %37 = call i8* @memcpy(i8* %35, i8* %36, i64 12)
  %38 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !731
  %39 = load i64* %38, align 1, !dbg !731
  %40 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !731
  %41 = load i32* %40, align 1, !dbg !731
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %32, i32 %34, i64 %39, i32 %41), !dbg !731
  %42 = load i32** %dev_c, align 8, !dbg !733
  call void @_Z3fooPi(i32* %42), !dbg !733
  %43 = load i32** %d, align 8, !dbg !734
  %44 = bitcast i32* %43 to i8*, !dbg !734
  %45 = load i32** %dev_c, align 8, !dbg !734
  %46 = bitcast i32* %45 to i8*, !dbg !734
  %47 = call i32 @cudaMemcpy(i8* %44, i8* %46, i64 8, i32 2), !dbg !734
  store i32 0, i32* %i1, align 4, !dbg !735
  br label %48, !dbg !735

; <label>:48                                      ; preds = %65, %20
  %49 = load i32* %i1, align 4, !dbg !735
  %50 = icmp slt i32 %49, 2, !dbg !735
  br i1 %50, label %51, label %68, !dbg !735

; <label>:51                                      ; preds = %48
  %52 = load i32* %i1, align 4, !dbg !737
  %53 = sext i32 %52 to i64, !dbg !737
  %54 = load i32** %d, align 8, !dbg !737
  %55 = getelementptr inbounds i32* %54, i64 %53, !dbg !737
  %56 = load i32* %55, align 4, !dbg !737
  %57 = load i32* %i1, align 4, !dbg !737
  %58 = add nsw i32 %57, 1, !dbg !737
  %59 = sext i32 %58 to i64, !dbg !737
  %60 = load i32** %c, align 8, !dbg !737
  %61 = getelementptr inbounds i32* %60, i64 %59, !dbg !737
  %62 = load i32* %61, align 4, !dbg !737
  %63 = icmp eq i32 %56, %62, !dbg !737
  br i1 %63, label %65, label %64, !dbg !737

; <label>:64                                      ; preds = %51
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i32 37, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwin
  unreachable, !dbg !737

; <label>:65                                      ; preds = %51
  %66 = load i32* %i1, align 4, !dbg !735
  %67 = add nsw i32 %66, 1, !dbg !735
  store i32 %67, i32* %i1, align 4, !dbg !735
  br label %48, !dbg !735

; <label>:68                                      ; preds = %48
  %69 = load i32** %c, align 8, !dbg !739
  %70 = bitcast i32* %69 to i8*, !dbg !739
  call void @free(i8* %70) nounwind, !dbg !739
  %71 = load i32** %dev_c, align 8, !dbg !740
  %72 = bitcast i32* %71 to i8*, !dbg !740
  %73 = call i32 @cudaFree(i8* %72), !dbg !740
  ret i32 0, !dbg !741
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !11,
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3", null} ; [ DW_TAG_file_type ]
...
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 9, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3/main.cpp]
...
!724 = metadata !{i32 786443, metadata !21, i32 15, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3/main.cpp]
!725 = metadata !{i32 21, i32 0, metadata !724, null}
!726 = metadata !{i32 23, i32 0, metadata !727, null}
!727 = metadata !{i32 786443, metadata !724, i32 23, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3/main.cpp]
!728 = metadata !{i32 24, i32 0, metadata !727, null}
!729 = metadata !{i32 26, i32 0, metadata !724, null}
!730 = metadata !{i32 27, i32 0, metadata !724, null}
!731 = metadata !{i32 28, i32 0, metadata !732, null}
!732 = metadata !{i32 786443, metadata !724, i32 28, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3/main.cpp]
!733 = metadata !{i32 30, i32 0, metadata !732, null}
!734 = metadata !{i32 34, i32 0, metadata !724, null}
!735 = metadata !{i32 36, i32 0, metadata !736, null}
!736 = metadata !{i32 786443, metadata !724, i32 36, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3/main.cpp]
!737 = metadata !{i32 37, i32 0, metadata !738, null}
!738 = metadata !{i32 786443, metadata !736, i32 36, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3/main.cpp]
!739 = metadata !{i32 40, i32 0, metadata !724, null}
!740 = metadata !{i32 41, i32 0, metadata !724, null}
!741 = metadata !{i32 43, i32 0, metadata !724, null}
...
!745 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/010_test3//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
