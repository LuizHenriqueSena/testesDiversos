...
@.str = private unnamed_addr constant [12 x i8] c"a + b = %d\0A\00", align 1
@.str1 = private unnamed_addr constant [9 x i8] c"c != a+b\00", align 1
...
define void @_Z4AsumPiS_S_(i32* %a, i32* %b, i32* %c) nounwind uwtable noinline {
  ...
  %6 = load i32** %2, align 8, !dbg !719
  %7 = load i32* %6, align 4, !dbg !719
  %8 = add nsw i32 %5, %7, !dbg !719
  %9 = load i32** %3, align 8, !dbg !719
  store i32 %8, i32* %9, align 4, !dbg !719
  ret void, !dbg !721
}
...
define i32 @main() uwtable {
  ...
  %5 = alloca { i64, i32 }
  store i32 0, i32* %1
  store i32 4, i32* %size, align 4, !dbg !722
  ...
  store i32 7, i32* %b, align 4, !dbg !728
  store i32 8, i32* %c, align 4, !dbg !729
  %18 = load i32** %dev_a, align 8, !dbg !730
  %19 = bitcast i32* %18 to i8*, !dbg !730
  %20 = bitcast i32* %a to i8*, !dbg !730
  %21 = load i32* %size, align 4, !dbg !730
  %22 = sext i32 %21 to i64, !dbg !730
  %23 = call i32 @cudaMemcpy(i8* %19, i8* %20, i64 %22, i32 1), !dbg !730
  %24 = load i32** %dev_b, align 8, !dbg !731
  %25 = bitcast i32* %24 to i8*, !dbg !731
  %26 = bitcast i32* %b to i8*, !dbg !731
  %27 = load i32* %size, align 4, !dbg !731
  %28 = sext i32 %27 to i64, !dbg !731
  %29 = call i32 @cudaMemcpy(i8* %25, i8* %26, i64 %28, i32 1), !dbg !731
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 1, i32 1, i32 1), !dbg !732
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %3, i32 1, i32 1, i32 1), !dbg !732
  %30 = bitcast { i64, i32 }* %4 to i8*, !dbg !732
  %31 = bitcast %struct.dim3* %2 to i8*, !dbg !732
  %32 = call i8* @memcpy(i8* %30, i8* %31, i64 12)
  %33 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !732
  %34 = load i64* %33, align 1, !dbg !732
  %35 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !732
  %36 = load i32* %35, align 1, !dbg !732
  %37 = bitcast { i64, i32 }* %5 to i8*, !dbg !732
  %38 = bitcast %struct.dim3* %3 to i8*, !dbg !732
  %39 = call i8* @memcpy(i8* %37, i8* %38, i64 12)
  %40 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !732
  %41 = load i64* %40, align 1, !dbg !732
  %42 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !732
  %43 = load i32* %42, align 1, !dbg !732
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %34, i32 %36, i64 %41, i32 %43), !dbg !732
  %44 = load i32** %dev_a, align 8, !dbg !734
  %45 = load i32** %dev_b, align 8, !dbg !734
  %46 = load i32** %dev_c, align 8, !dbg !734
  call void @_Z4AsumPiS_S_(i32* %44, i32* %45, i32* %46), !dbg !734
  %47 = bitcast i32* %c to i8*, !dbg !735
  %48 = load i32** %dev_c, align 8, !dbg !735
  %49 = bitcast i32* %48 to i8*, !dbg !735
  %50 = load i32* %size, align 4, !dbg !735
  %51 = sext i32 %50 to i64, !dbg !735
  %52 = call i32 @cudaMemcpy(i8* %47, i8* %49, i64 %51, i32 2), !dbg !735
  %53 = load i32* %c, align 4, !dbg !736
  %54 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %53), !dbg !736
  %55 = load i32* %c, align 4, !dbg !737
  %56 = load i32* %a, align 4, !dbg !737
  %57 = load i32* %b, align 4, !dbg !737
  %58 = add nsw i32 %56, %57, !dbg !737
  %59 = icmp ne i32 %55, %58, !dbg !737
  br i1 %59, label %61, label %60, !dbg !737

; <label>:60                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i32 40, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwin
  unreachable, !dbg !737

; <label>:61                                      ; preds = %0
  %62 = load i32** %dev_a, align 8, !dbg !738
  %63 = bitcast i32* %62 to i8*, !dbg !738
  %64 = call i32 @cudaFree(i8* %63), !dbg !738
  %65 = load i32** %dev_b, align 8, !dbg !739
  %66 = bitcast i32* %65 to i8*, !dbg !739
  %67 = call i32 @cudaFree(i8* %66), !dbg !739
  %68 = load i32** %dev_c, align 8, !dbg !740
  %69 = bitcast i32* %68 to i8*, !dbg !740
  %70 = call i32 @cudaFree(i8* %69), !dbg !740
  ret i32 0, !dbg !741
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !11, 
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail", null} ; [ DW_TAG_file_type ]
...
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"Asum", metadata !"Asum", metadata !"_Z4AsumPiS_S_", metadata !16, i32 8, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*, i32*)* @_Z4AsumPiS_S_, null, n
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 8, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail/main.cpp]
!721 = metadata !{i32 10, i32 0, metadata !720, null}
!722 = metadata !{i32 15, i32 0, metadata !723, null}
!723 = metadata !{i32 786443, metadata !21, i32 12, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail/main.cpp]
!724 = metadata !{i32 17, i32 0, metadata !723, null}
!725 = metadata !{i32 21, i32 0, metadata !723, null}
!726 = metadata !{i32 22, i32 0, metadata !723, null}
!727 = metadata !{i32 24, i32 0, metadata !723, null}
!728 = metadata !{i32 25, i32 0, metadata !723, null}
!729 = metadata !{i32 26, i32 0, metadata !723, null}
!730 = metadata !{i32 28, i32 0, metadata !723, null}
!731 = metadata !{i32 29, i32 0, metadata !723, null}
!732 = metadata !{i32 30, i32 0, metadata !733, null}
!733 = metadata !{i32 786443, metadata !723, i32 30, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail/main.cpp]
!734 = metadata !{i32 32, i32 0, metadata !733, null}
!735 = metadata !{i32 36, i32 0, metadata !723, null}
!736 = metadata !{i32 38, i32 0, metadata !723, null}
!737 = metadata !{i32 40, i32 0, metadata !723, null}
!738 = metadata !{i32 42, i32 0, metadata !723, null}
!739 = metadata !{i32 43, i32 0, metadata !723, null}
!740 = metadata !{i32 44, i32 0, metadata !723, null}
!741 = metadata !{i32 46, i32 0, metadata !723, null}
...
!745 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/024_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
