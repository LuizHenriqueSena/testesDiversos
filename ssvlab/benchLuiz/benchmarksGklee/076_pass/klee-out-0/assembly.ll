...
@.str1 = private unnamed_addr constant [11 x i8] c"*a == 50.0\00", align 1
...
define void @_Z3fooPf(float* %A) nounwind uwtable noinline {
  ...
  %2 = load i32* getelementptr inbounds (%struct.dim3* @blockIdx, i32 0, i32 0), align 4, !dbg !720
  %3 = icmp eq i32 %2, 0, !dbg !720
  br i1 %3, label %4, label %9, !dbg !720

; <label>:4                                       ; preds = %0
  %5 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !722
  %6 = zext i32 %5 to i64, !dbg !722
  %7 = load float** %1, align 8, !dbg !722
  %8 = getelementptr inbounds float* %7, i64 %6, !dbg !722
  store float 5.000000e+01, float* %8, align 4, !dbg !722
  br label %9, !dbg !722
...
define i32 @main() uwtable {
  ...
  %5 = alloca { i64, i32 }
  store i32 0, i32* %1
  store float* null, float** %a, align 8, !dbg !724
  %6 = call noalias i8* @malloc(i64 8) nounwind, !dbg !726
  %7 = bitcast i8* %6 to float*, !dbg !726
  store float* %7, float** %a, align 8, !dbg !726
  %8 = bitcast float** %dev_a to i8**, !dbg !727
  %9 = call i32 @cudaMalloc(i8** %8, i64 8), !dbg !727
  %10 = load float** %dev_a, align 8, !dbg !728
  %11 = bitcast float* %10 to i8*, !dbg !728
  %12 = load float** %a, align 8, !dbg !728
  %13 = bitcast float* %12 to i8*, !dbg !728
  ...
  %29 = load float** %dev_a, align 8, !dbg !731
  call void @_Z3fooPf(float* %29), !dbg !731
  %30 = load float** %a, align 8, !dbg !732
  %31 = bitcast float* %30 to i8*, !dbg !732
  %32 = load float** %dev_a, align 8, !dbg !732
  %33 = bitcast float* %32 to i8*, !dbg !732
  %34 = call i32 @cudaMemcpy(i8* %31, i8* %33, i64 8, i32 2), !dbg !732
  %35 = load float** %a, align 8, !dbg !733
  %36 = load float* %35, align 4, !dbg !733
  %37 = fpext float %36 to double, !dbg !733
  %38 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), double %37), !dbg !733
  %39 = load float** %a, align 8, !dbg !734
  %40 = load float* %39, align 4, !dbg !734
  %41 = fpext float %40 to double, !dbg !734
  %42 = fcmp oeq double %41, 5.000000e+01, !dbg !734
  br i1 %42, label %44, label %43, !dbg !734

; <label>:43                                      ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str2, i32 0, i32 0), i32 33, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwi
  unreachable, !dbg !734

; <label>:44                                      ; preds = %0
  %45 = load float** %a, align 8, !dbg !735
  %46 = bitcast float* %45 to i8*, !dbg !735
  call void @free(i8* %46) nounwind, !dbg !735
  %47 = load float** %dev_a, align 8, !dbg !736
  %48 = bitcast float* %47 to i8*, !dbg !736
  %49 = call i32 @cudaFree(i8* %48), !dbg !736
  ret i32 0, !dbg !737
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !11, 
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass", null} ; [ DW_TAG_file_type ]
...
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"foo", metadata !"foo", metadata !"_Z3fooPf", metadata !16, i32 8, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (float*)* @_Z3fooPf, null, null, metadata !11, i32
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass", null} ; [ DW_TAG_file_type ]
...
!26 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass", null} ; [ DW_TAG_file_type ]
...
!721 = metadata !{i32 786443, metadata !15, i32 8, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass/main.cpp]
!722 = metadata !{i32 11, i32 0, metadata !721, null}
!723 = metadata !{i32 12, i32 0, metadata !721, null}
!724 = metadata !{i32 15, i32 0, metadata !725, null}
!725 = metadata !{i32 786443, metadata !21, i32 14, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass/main.cpp]
!726 = metadata !{i32 18, i32 0, metadata !725, null}
!727 = metadata !{i32 20, i32 0, metadata !725, null}
!728 = metadata !{i32 22, i32 0, metadata !725, null}
!729 = metadata !{i32 23, i32 0, metadata !730, null}
!730 = metadata !{i32 786443, metadata !725, i32 23, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass/main.cpp]
!731 = metadata !{i32 25, i32 0, metadata !730, null}
!732 = metadata !{i32 29, i32 0, metadata !725, null}
!733 = metadata !{i32 31, i32 0, metadata !725, null}
!734 = metadata !{i32 33, i32 0, metadata !725, null}
!735 = metadata !{i32 35, i32 0, metadata !725, null}
!736 = metadata !{i32 36, i32 0, metadata !725, null}
!737 = metadata !{i32 38, i32 0, metadata !725, null}
...
!741 = metadata !{i32 786443, metadata !68, i32 419, i32 0, metadata !26, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/076_pass//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
