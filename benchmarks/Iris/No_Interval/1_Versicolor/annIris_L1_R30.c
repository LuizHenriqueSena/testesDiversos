...
//unsigned int x0 = Frama_C_interval(195, 255);
//unsigned int x1 = Frama_C_interval(195, 255);
//unsigned int x2 = Frama_C_interval(195, 255);
//unsigned int x3 = Frama_C_interval(120, 180);
float i[4];
i[0] = x0*norm;
i[1] = x1*norm;
i[2] = x2*norm;
