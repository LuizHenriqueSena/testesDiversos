...
__ESBMC_assume((layer1[0]  >= 0) && (layer1[0] <= 1));
...
__ESBMC_assume((layer1[1]  >= 0) && (layer1[1] <= 1));
...
__ESBMC_assume((layer1[4]  >= 0.00516799977049) && (layer1[4] <= 1));
float layer2[4];
...
__ESBMC_assume((layer2[0]  >= 0) && (layer2[0] <= 0.997295022011));
...
__ESBMC_assume((layer2[1]  >= 0) && (layer2[1] <= 1));
...
__ESBMC_assume((layer2[2]  >= 0) && (layer2[2] <= 0.798991024494));
...
__ESBMC_assume((layer2[3]  >= 0) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[0]  >= 0) && (layer3[0] <= 0.979367017746));
int r = 0;
...
__ESBMC_assume((layer3[1]  >= 0) && (layer3[1] <= 0.991674005985));
...
__ESBMC_assume((layer3[3]  >= 0) && (layer3[3] <= 0.97068798542));
...
__ESBMC_assume((layer3[4]  >= 0) && (layer3[4] <= 0.989848971367));
