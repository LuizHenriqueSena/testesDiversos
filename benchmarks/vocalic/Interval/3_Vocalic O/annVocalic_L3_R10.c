...
__ESBMC_assume((layer1[0] >= 0.191544994712) && (layer1[0] <= 0.911330997944));
...
__ESBMC_assume((layer1[1] >= 0.967703998089) && (layer1[1] <= 1));
...
__ESBMC_assume((layer1[2] >= 0) && (layer1[2] <= 0.127862006426));
...
__ESBMC_assume((layer1[3] >= 0.23866699636) && (layer1[3] <= 0.937614023685));
...
__ESBMC_assume((layer2[0] >= 0) && (layer2[0] <= 0.0541669987142));
...
__ESBMC_assume((layer2[1] >= 0.00669299997389) && (layer2[1] <= 0.629482984543));
...
__ESBMC_assume((layer2[2] >= 0) && (layer2[2] <= 0.0063689998351));
...
__ESBMC_assume((layer2[3] >= 0.0129960002378) && (layer2[3] <= 0.589039981365));
float layer3[5];
...
__ESBMC_assume((layer3[2] >= 0) && (layer3[2] <= 0.349781990051));
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.964084029198));
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <= 0.79575997591));
