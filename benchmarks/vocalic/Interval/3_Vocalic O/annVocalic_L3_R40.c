...
__ESBMC_assume((layer1[0] >= 0) && (layer1[0] <= 0.997040987015));
...
__ESBMC_assume((layer1[1] >= 0.0216680001467) && (layer1[1] <= 1));
...
__ESBMC_assume((layer1[2] >= 0) && (layer1[2] <= 0.994234025478));
...
__ESBMC_assume((layer2[0] >= 0) && (layer2[0] <= 0.997040987015));
...
__ESBMC_assume((layer2[2] >= 0) && (layer2[2] <= 0.782450020313));
...
__ESBMC_assume((layer2[3] >= 0.00824400037527) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 0) && (layer3[0] <= 0.976796984673));
int r = 0;
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.967703998089));
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <= 0.989013016224));
