...
static void setopts (LGL * lgl, int i) {
  ...
  if (i && (locs >= 2 || (locs && (i > 7 || (i & 1))))) {
    ...
    switch (j % 16) {
      ...
      case 2: setopt (i, lgl, "agile", 0); break;
      case 3: setopt (i, lgl, "block", 0), setopt (i, lgl, "cce", 0); break;
      case 4: setopt (i, lgl, "bias", -1); break;
      case 5: setopt (i, lgl, "acts", 0); break;
      case 6: setopt (i, lgl, "phase", 1); break;
      case 7: setopt (i, lgl, "acts", 1); break;
      case 8: setopt (i, lgl, "bias", 1); break;
      case 9:
	setopt (i, lgl, "wait", 0);
	setopt (i, lgl, "blkrtc", 1);
	setopt (i, lgl, "elmrtc", 1);
	break;
      case 10: setopt (i, lgl, "phase", -1); break;
      case 11: setopt (i, lgl, "prbsimplertc", 1); break;
      case 12: setopt (i, lgl, "gluescale", 1); break;
      case 13: setopt (i, lgl, "gluescale", 3); break;
      case 14: setopt (i, lgl, "move", 1); break;
