...
__ESBMC_assume((layer1[0]  >= 0) && (layer1[0] <= 0.98799097538));
...
__ESBMC_assume((layer1[2]  >= 0) && (layer1[2] <= 0.993694007397));
...
__ESBMC_assume((layer1[3]  >= 0) && (layer1[3] <= 0.325195014477));
...
__ESBMC_assume((layer1[4]  >= 0.944799005985) && (layer1[4] <= 1));
float layer2[4];
...
__ESBMC_assume((layer2[0]  >= 0) && (layer2[0] <= 0.997241020203));
...
__ESBMC_assume((layer2[1]  >= 0) && (layer2[1] <= 0.978542983532));
...
__ESBMC_assume((layer2[2]  >= 0) && (layer2[2] <= 0.284958004951));
...
__ESBMC_assume((layer2[3]  >= 0.0216680001467) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[0]  >= 0) && (layer3[0] <= 0.562175989151));
int r = 0;
...
__ESBMC_assume((layer3[3]  >= 0) && (layer3[3] <= 0.961947977543));
...
__ESBMC_assume((layer3[4]  >= 0) && (layer3[4] <= 0.985080003738));
