...
__ESBMC_assume((layer1[0] >= 0.000980000011623) && (layer1[0] <= 0.999722003937));
...
__ESBMC_assume((layer1[1] >= 0.251994997263) && (layer1[1] <= 0.999998986721));
...
__ESBMC_assume((layer1[2] >= 0.00762999989092) && (layer1[2] <= 0.999993979931));
...
__ESBMC_assume((layer1[3] >= 0.00835900008678) && (layer1[3] <= 0.999979019165));
...
__ESBMC_assume((layer1[4] >= 0.994790017605) && (layer1[4] <= 1));
float layer2[4];
...
__ESBMC_assume((layer2[0] >= 1.99999999495e-06) && (layer2[0] <= 0.99398201704));
...
__ESBMC_assume((layer2[1] >= 0.00169599999208) && (layer2[1] <= 0.999372005463));
...
__ESBMC_assume((layer2[2] >= 1.70000002981e-05) && (layer2[2] <= 0.584191024303));
...
__ESBMC_assume((layer2[3] >= 0.0081789996475) && (layer2[3] <= 0.999877989292));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 3.9999999899e-06) && (layer3[0] <= 0.915367007256));
int r = 0;
...
__ESBMC_assume((layer3[1] >= 0) && (layer3[1] <= 0.991303026676));
...
__ESBMC_assume((layer3[2] >= 0) && (layer3[2] <= 0.966072022915));
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <= 0.98899102211));
