...
__ESBMC_assume((layer1[0] >= 0) && (layer1[0] <=0.999971985817));
...
__ESBMC_assume((layer1[1] >= 9.99999997475e-07) && (layer1[1] <=1));
...
__ESBMC_assume((layer1[3] >= 0) && (layer1[3] <=1));
...
__ESBMC_assume((layer1[4] >= 0.0393540002406) && (layer1[4] <=1));
float layer2[4];
...
__ESBMC_assume((layer2[1] >= 0.00154099997599) && (layer2[1] <=0.999862015247));
...
__ESBMC_assume((layer2[3] >= 0.000367000000551) && (layer2[3] <=0.999979972839));
float layer3[5];
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <=0.989829003811));
