...
@.str = private unnamed_addr constant [4 x i8] c"\0Aw:\00", align 1
@.str1 = private unnamed_addr constant [5 x i8] c" %f\09\00", align 1

define float @_Z13multiplyByTwoPfj(float* %v, i32 %index) nounwind uwtable section "__device__" {
  %1 = alloca float*, align 8
  %2 = alloca i32, align 4
  store float* %v, float** %1, align 8
  store i32 %index, i32* %2, align 4
  %3 = load i32* %2, align 4, !dbg !724
  %4 = zext i32 %3 to i64, !dbg !724
  %5 = load float** %1, align 8, !dbg !724
  %6 = getelementptr inbounds float* %5, i64 %4, !dbg !724
  %7 = load float* %6, align 4, !dbg !724
  %8 = fmul float %7, 2.000000e+00, !dbg !724
  ret float %8, !dbg !724
}

declare void @llvm.dbg.declare(metadata, metadata) nounwind readnone

define float @_Z11divideByTwoPfj(float* %v, i32 %index) nounwind uwtable section "__device__" {
  %1 = alloca float*, align 8
  %2 = alloca i32, align 4
  store float* %v, float** %1, align 8
  store i32 %index, i32* %2, align 4
  %3 = load i32* %2, align 4, !dbg !726
  %4 = zext i32 %3 to i64, !dbg !726
  %5 = load float** %1, align 8, !dbg !726
  %6 = getelementptr inbounds float* %5, i64 %4, !dbg !726
  %7 = load float* %6, align 4, !dbg !726
  %8 = fmul float %7, 5.000000e-01, !dbg !726
  ret float %8, !dbg !726
}

define void @_Z3fooPf(float* %v) uwtable noinline {
  %1 = alloca float*, align 8
  %f = alloca float (float*, i32)*, align 8
  store float* %v, float** %1, align 8
  store float (float*, i32)* inttoptr (i64 3 to float (float*, i32)*), float (float*, i32)** %f, align 8, !dbg !728
  %2 = load float (float*, i32)** %f, align 8, !dbg !730
  %3 = load float** %1, align 8, !dbg !730
  %4 = load i32* getelementptr inbounds (%struct.dim3* @blockIdx, i32 0, i32 0), align 4, !dbg !730
  %5 = load i32* getelementptr inbounds (%struct.dim3* @blockDim, i32 0, i32 0), align 4, !dbg !730
  %6 = mul i32 %4, %5, !dbg !730
  %7 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !730
  %8 = add i32 %6, %7, !dbg !730
  %9 = call float %2(float* %3, i32 %8), !dbg !730
  %10 = load i32* getelementptr inbounds (%struct.dim3* @blockIdx, i32 0, i32 0), align 4, !dbg !730
  %11 = load i32* getelementptr inbounds (%struct.dim3* @blockDim, i32 0, i32 0), align 4, !dbg !730
  %12 = mul i32 %10, %11, !dbg !730
  %13 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !730
  %14 = add i32 %12, %13, !dbg !730
  %15 = zext i32 %14 to i64, !dbg !730
  %16 = load float** %1, align 8, !dbg !730
  %17 = getelementptr inbounds float* %16, i64 %15, !dbg !730
  store float %9, float* %17, align 4, !dbg !730
  ret void, !dbg !731
}
...
define i32 @main() uwtable {
  ...
  %6 = load i32* %size, align 4, !dbg !734
  %7 = sext i32 %6 to i64, !dbg !734
  %8 = call noalias i8* @malloc(i64 %7) nounwind, !dbg !734
  %9 = bitcast i8* %8 to float*, !dbg !734
  store float* %9, float** %w, align 8, !dbg !734
  store i32 0, i32* %i, align 4, !dbg !735
  br label %10, !dbg !735

; <label>:10                                      ; preds = %13, %0
  %11 = load i32* %i, align 4, !dbg !735
  %12 = icmp slt i32 %11, 2, !dbg !735
  br i1 %12, label %13, label %22, !dbg !735

; <label>:13                                      ; preds = %10
  %14 = load i32* %i, align 4, !dbg !737
  %15 = sitofp i32 %14 to float, !dbg !737
  %16 = load i32* %i, align 4, !dbg !737
  %17 = sext i32 %16 to i64, !dbg !737
  %18 = load float** %w, align 8, !dbg !737
  %19 = getelementptr inbounds float* %18, i64 %17, !dbg !737
  store float %15, float* %19, align 4, !dbg !737
  %20 = load i32* %i, align 4, !dbg !735
  %21 = add nsw i32 %20, 1, !dbg !735
  store i32 %21, i32* %i, align 4, !dbg !735
  br label %10, !dbg !735

; <label>:22                                      ; preds = %10
  %23 = bitcast float** %dev_w to i8**, !dbg !739
  %24 = load i32* %size, align 4, !dbg !739
  %25 = sext i32 %24 to i64, !dbg !739
  %26 = call i32 @cudaMalloc(i8** %23, i64 %25), !dbg !739
  %27 = load float** %dev_w, align 8, !dbg !740
  %28 = bitcast float* %27 to i8*, !dbg !740
  %29 = load float** %w, align 8, !dbg !740
  %30 = bitcast float* %29 to i8*, !dbg !740
  %31 = load i32* %size, align 4, !dbg !740
  %32 = sext i32 %31 to i64, !dbg !740
  %33 = call i32 @cudaMemcpy(i8* %28, i8* %30, i64 %32, i32 1), !dbg !740
  ...
  %34 = bitcast { i64, i32 }* %4 to i8*, !dbg !741
  %35 = bitcast %struct.dim3* %2 to i8*, !dbg !741
  %36 = call i8* @memcpy(i8* %34, i8* %35, i64 12)
  %37 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !741
  %38 = load i64* %37, align 1, !dbg !741
  %39 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !741
  %40 = load i32* %39, align 1, !dbg !741
  %41 = bitcast { i64, i32 }* %5 to i8*, !dbg !741
  %42 = bitcast %struct.dim3* %3 to i8*, !dbg !741
  %43 = call i8* @memcpy(i8* %41, i8* %42, i64 12)
  %44 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !741
  %45 = load i64* %44, align 1, !dbg !741
  %46 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !741
  %47 = load i32* %46, align 1, !dbg !741
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %38, i32 %40, i64 %45, i32 %47), !dbg !741
  %48 = load float** %dev_w, align 8, !dbg !743
  call void @_Z3fooPf(float* %48), !dbg !743
  %49 = load float** %w, align 8, !dbg !744
  %50 = bitcast float* %49 to i8*, !dbg !744
  %51 = load float** %dev_w, align 8, !dbg !744
  %52 = bitcast float* %51 to i8*, !dbg !744
  %53 = load i32* %size, align 4, !dbg !744
  %54 = sext i32 %53 to i64, !dbg !744
  %55 = call i32 @cudaMemcpy(i8* %50, i8* %52, i64 %54, i32 2), !dbg !744
  %56 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0)), !dbg !745
  store i32 0, i32* %i1, align 4, !dbg !746
  br label %57, !dbg !746

; <label>:57                                      ; preds = %60, %22
  %58 = load i32* %i1, align 4, !dbg !746
  %59 = icmp slt i32 %58, 2, !dbg !746
  br i1 %59, label %60, label %70, !dbg !746

; <label>:60                                      ; preds = %57
  %61 = load i32* %i1, align 4, !dbg !748
  %62 = sext i32 %61 to i64, !dbg !748
  %63 = load float** %w, align 8, !dbg !748
  %64 = getelementptr inbounds float* %63, i64 %62, !dbg !748
  %65 = load float* %64, align 4, !dbg !748
  %66 = fpext float %65 to double, !dbg !748
  %67 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str1, i32 0, i32 0), double %66), !dbg !748
  %68 = load i32* %i1, align 4, !dbg !746
  %69 = add nsw i32 %68, 1, !dbg !746
  store i32 %69, i32* %i1, align 4, !dbg !746
  br label %57, !dbg !746

; <label>:70                                      ; preds = %57
  %71 = load float** %w, align 8, !dbg !750
  %72 = bitcast float* %71 to i8*, !dbg !750
  call void @free(i8* %72) nounwind, !dbg !750
  %73 = load float** %dev_w, align 8, !dbg !751
  %74 = bitcast float* %73 to i8*, !dbg !751
  %75 = call i32 @cudaFree(i8* %74), !dbg !751
  ret i32 0, !dbg !752
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1,
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail", null} ; [ DW_TAG_file_type ]
...
!14 = metadata !{metadata !15, metadata !22, metadata !23, metadata !26, metadata !30, metadata !72}
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"multiplyByTwo", metadata !"multiplyByTwo", metadata !"_Z13multiplyByTwoPfj", metadata !16, i32 14, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, float (float*, i32)* @
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail", null} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 786478, i32 0, metadata !16, metadata !"divideByTwo", metadata !"divideByTwo", metadata !"_Z11divideByTwoPfj", metadata !16, i32 19, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, float (float*, i32)* @_Z11di
!23 = metadata !{i32 786478, i32 0, metadata !16, metadata !"foo", metadata !"foo", metadata !"_Z3fooPf", metadata !16, i32 26, metadata !24, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (float*)* @_Z3fooPf, null, null, metadata !11, i3
...
!25 = metadata !{null, metadata !20}
!26 = metadata !{i32 786478, i32 0, metadata !16, metadata !"main", metadata !"main", metadata !"", metadata !16, i32 32, metadata !27, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !11, i32 32} ; [ DW_TAG_
...
!30 = metadata !{i32 786478, i32 0, null, metadata !"dim3", metadata !"dim3", metadata !"_ZN4dim3C1Ejjj", metadata !31, i32 419, metadata !32, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.dim3*, i32, i32, i32)* @_ZN4dim3C1Ejjj,
!31 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail", null} ; [ DW_TAG_file_type ]
...
!33 = metadata !{null, metadata !34, metadata !21, metadata !21, metadata !21}
!34 = metadata !{i32 786447, i32 0, metadata !"", i32 0, i32 0, i64 64, i64 64, i64 0, i32 1088, metadata !35} ; [ DW_TAG_pointer_type ] [line 0, size 64, align 64, offset 0] [from dim3]
!35 = metadata !{i32 786451, null, metadata !"dim3", metadata !31, i32 415, i64 96, i64 32, i32 0, i32 0, null, metadata !36, i32 0, null, null} ; [ DW_TAG_structure_type ] [dim3] [line 415, size 96, align 32, offset 0] [from ]
!36 = metadata !{metadata !37, metadata !38, metadata !39, metadata !40, metadata !43, metadata !61, metadata !64, metadata !69}
!37 = metadata !{i32 786445, metadata !35, metadata !"x", metadata !31, i32 417, i64 32, i64 32, i64 0, i32 0, metadata !21} ; [ DW_TAG_member ] [x] [line 417, size 32, align 32, offset 0] [from unsigned int]
!38 = metadata !{i32 786445, metadata !35, metadata !"y", metadata !31, i32 417, i64 32, i64 32, i64 32, i32 0, metadata !21} ; [ DW_TAG_member ] [y] [line 417, size 32, align 32, offset 32] [from unsigned int]
!39 = metadata !{i32 786445, metadata !35, metadata !"z", metadata !31, i32 417, i64 32, i64 32, i64 64, i32 0, metadata !21} ; [ DW_TAG_member ] [z] [line 417, size 32, align 32, offset 64] [from unsigned int]
!40 = metadata !{i32 786478, i32 0, metadata !35, metadata !"dim3", metadata !"dim3", metadata !"", metadata !31, i32 419, metadata !32, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !41, i32 419} ; [ DW_TAG_subpr
!41 = metadata !{metadata !42}
!42 = metadata !{i32 786468}                      ; [ DW_TAG_base_type ] [line 0, size 0, align 0, offset 0]
!43 = metadata !{i32 786478, i32 0, metadata !35, metadata !"dim3", metadata !"dim3", metadata !"", metadata !31, i32 420, metadata !44, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, metadata !41, i32 420} ; [ DW_TAG_subpr
...
!46 = metadata !{i32 786454, null, metadata !"uint3", metadata !31, i32 381, i64 0, i64 0, i64 0, i32 0, metadata !47} ; [ DW_TAG_typedef ] [uint3] [line 381, size 0, align 0, offset 0] [from uint3]
!47 = metadata !{i32 786451, null, metadata !"uint3", metadata !31, i32 188, i64 96, i64 32, i32 0, i32 0, null, metadata !48, i32 0, null, null} ; [ DW_TAG_structure_type ] [uint3] [line 188, size 96, align 32, offset 0] [from ]
!48 = metadata !{metadata !49, metadata !50, metadata !51, metadata !52, metadata !56}
!49 = metadata !{i32 786445, metadata !47, metadata !"x", metadata !31, i32 190, i64 32, i64 32, i64 0, i32 0, metadata !21} ; [ DW_TAG_member ] [x] [line 190, size 32, align 32, offset 0] [from unsigned int]
!50 = metadata !{i32 786445, metadata !47, metadata !"y", metadata !31, i32 190, i64 32, i64 32, i64 32, i32 0, metadata !21} ; [ DW_TAG_member ] [y] [line 190, size 32, align 32, offset 32] [from unsigned int]
!51 = metadata !{i32 786445, metadata !47, metadata !"z", metadata !31, i32 190, i64 32, i64 32, i64 64, i32 0, metadata !21} ; [ DW_TAG_member ] [z] [line 190, size 32, align 32, offset 64] [from unsigned int]
!52 = metadata !{i32 786478, i32 0, metadata !47, metadata !"uint3", metadata !"uint3", metadata !"", metadata !31, i32 188, metadata !53, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !41, i32 188} ; [ DW_TAG_sub
...
!56 = metadata !{i32 786478, i32 0, metadata !47, metadata !"uint3", metadata !"uint3", metadata !"", metadata !31, i32 188, metadata !57, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !41, i32 188} ; [ DW_TAG_sub
...
!61 = metadata !{i32 786478, i32 0, metadata !35, metadata !"operator uint3", metadata !"operator uint3", metadata !"_ZN4dim3cv5uint3Ev", metadata !31, i32 421, metadata !62, i1 false, i1 false, i32 0, i32 0, null, i32 256, i1 false, null, null, i32 0, m
...
!63 = metadata !{metadata !46, metadata !34}
!64 = metadata !{i32 786478, i32 0, metadata !35, metadata !"dim3", metadata !"dim3", metadata !"", metadata !31, i32 415, metadata !65, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !41, i32 415} ; [ DW_TAG_subpr
...
!66 = metadata !{null, metadata !34, metadata !67}
...
!68 = metadata !{i32 786470, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !35} ; [ DW_TAG_const_type ] [line 0, size 0, align 0, offset 0] [from dim3]
!69 = metadata !{i32 786478, i32 0, metadata !35, metadata !"~dim3", metadata !"~dim3", metadata !"", metadata !31, i32 415, metadata !70, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !41, i32 415} ; [ DW_TAG_sub
...
!71 = metadata !{null, metadata !34}
!72 = metadata !{i32 786478, i32 0, null, metadata !"dim3", metadata !"dim3", metadata !"_ZN4dim3C2Ejjj", metadata !31, i32 419, metadata !32, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.dim3*, i32, i32, i32)* @_ZN4dim3C2Ejjj,
...
!119 = metadata !{metadata !80, metadata !80, metadata !29, metadata !120}
...
!124 = metadata !{i32 786689, metadata !116, metadata !"s", metadata !117, i32 33554444, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [s] [line 12]
...
!225 = metadata !{i32 786445, metadata !223, metadata !"x", metadata !134, i32 662, i64 32, i64 32, i64 0, i32 0, metadata !29} ; [ DW_TAG_member ] [x] [line 662, size 32, align 32, offset 0] [from int]
!226 = metadata !{i32 786445, metadata !223, metadata !"y", metadata !134, i32 663, i64 32, i64 32, i64 32, i32 0, metadata !29} ; [ DW_TAG_member ] [y] [line 663, size 32, align 32, offset 32] [from int]
!227 = metadata !{i32 786445, metadata !223, metadata !"z", metadata !134, i32 664, i64 32, i64 32, i64 64, i32 0, metadata !29} ; [ DW_TAG_member ] [z] [line 664, size 32, align 32, offset 64] [from int]
!228 = metadata !{i32 786445, metadata !223, metadata !"w", metadata !134, i32 665, i64 32, i64 32, i64 96, i32 0, metadata !29} ; [ DW_TAG_member ] [w] [line 665, size 32, align 32, offset 96] [from int]
...
!237 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !21} ; [ DW_TAG_pointer_type ] [line 0, size 64, align 64, offset 0] [from unsigned int]
...
!280 = metadata !{metadata !221, metadata !265, metadata !234, metadata !21}
...
!285 = metadata !{i32 786689, metadata !278, metadata !"flags", metadata !218, i32 50331700, metadata !21, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [flags] [line 52]
...
!288 = metadata !{metadata !221, metadata !265, metadata !80, metadata !21}
...
!293 = metadata !{i32 786689, metadata !286, metadata !"flags", metadata !218, i32 50331704, metadata !21, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [flags] [line 56]
...
!303 = metadata !{metadata !221, metadata !80, metadata !234, metadata !21}
...
!308 = metadata !{i32 786689, metadata !301, metadata !"flags", metadata !218, i32 50331712, metadata !21, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [flags] [line 64]
...
!336 = metadata !{metadata !221, metadata !337, metadata !222, metadata !231, metadata !21}
...
!343 = metadata !{i32 786689, metadata !334, metadata !"flags", metadata !218, i32 67108949, metadata !21, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [flags] [line 85]
...
!346 = metadata !{metadata !221, metadata !337, metadata !222, metadata !234, metadata !234, metadata !21}
...
!353 = metadata !{i32 786689, metadata !344, metadata !"flags", metadata !218, i32 83886170, metadata !21, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [flags] [line 90]
...
!514 = metadata !{i32 786445, metadata !509, metadata !"srcDevice", metadata !134, i32 773, i64 32, i64 32, i64 512, i32 0, metadata !29} ; [ DW_TAG_member ] [srcDevice] [line 773, size 32, align 32, offset 512] [from int]
...
!518 = metadata !{i32 786445, metadata !509, metadata !"dstDevice", metadata !134, i32 778, i64 32, i64 32, i64 1088, i32 0, metadata !29} ; [ DW_TAG_member ] [dstDevice] [line 778, size 32, align 32, offset 1088] [from int]
...
!599 = metadata !{metadata !221, metadata !80, metadata !29, metadata !81, metadata !29, metadata !234}
...
!603 = metadata !{i32 786689, metadata !597, metadata !"dstDevice", metadata !218, i32 33554633, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [dstDevice] [line 201]
...
!605 = metadata !{i32 786689, metadata !597, metadata !"srcDevice", metadata !218, i32 67109065, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [srcDevice] [line 201]
...
!609 = metadata !{metadata !221, metadata !80, metadata !29, metadata !81, metadata !29, metadata !234, metadata !406}
...
!613 = metadata !{i32 786689, metadata !607, metadata !"dstDevice", metadata !218, i32 33554638, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [dstDevice] [line 206]
...
!615 = metadata !{i32 786689, metadata !607, metadata !"srcDevice", metadata !218, i32 67109070, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [srcDevice] [line 206]
...
!671 = metadata !{metadata !221, metadata !80, metadata !29, metadata !234}
...
!675 = metadata !{i32 786689, metadata !669, metadata !"value", metadata !218, i32 33554670, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [value] [line 238]
...
!679 = metadata !{metadata !221, metadata !80, metadata !234, metadata !29, metadata !234, metadata !234}
...
!684 = metadata !{i32 786689, metadata !677, metadata !"value", metadata !218, i32 50331891, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [value] [line 243]
...
!689 = metadata !{metadata !221, metadata !80, metadata !234, metadata !29, metadata !234, metadata !234, metadata !406}
...
!694 = metadata !{i32 786689, metadata !687, metadata !"value", metadata !218, i32 50331896, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [value] [line 248]
...
!700 = metadata !{metadata !221, metadata !324, metadata !29, metadata !231}
...
!704 = metadata !{i32 786689, metadata !698, metadata !"value", metadata !218, i32 33554685, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [value] [line 253]
...
!708 = metadata !{metadata !221, metadata !324, metadata !29, metadata !231, metadata !406}
...
!712 = metadata !{i32 786689, metadata !706, metadata !"value", metadata !218, i32 33554690, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [value] [line 258]
...
!717 = metadata !{metadata !221, metadata !80, metadata !29, metadata !234, metadata !406}
...
!721 = metadata !{i32 786689, metadata !715, metadata !"value", metadata !218, i32 33554695, metadata !29, i32 0, i32 0} ; [ DW_TAG_arg_variable ] [value] [line 263]
...
!725 = metadata !{i32 786443, metadata !15, i32 15, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!726 = metadata !{i32 21, i32 0, metadata !727, null}
!727 = metadata !{i32 786443, metadata !22, i32 20, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!728 = metadata !{i32 28, i32 0, metadata !729, null}
!729 = metadata !{i32 786443, metadata !23, i32 27, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!730 = metadata !{i32 29, i32 0, metadata !729, null}
!731 = metadata !{i32 30, i32 0, metadata !729, null}
!732 = metadata !{i32 37, i32 0, metadata !733, null}
!733 = metadata !{i32 786443, metadata !26, i32 32, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!734 = metadata !{i32 39, i32 0, metadata !733, null}
!735 = metadata !{i32 41, i32 0, metadata !736, null}
!736 = metadata !{i32 786443, metadata !733, i32 41, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!737 = metadata !{i32 42, i32 0, metadata !738, null}
!738 = metadata !{i32 786443, metadata !736, i32 41, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!739 = metadata !{i32 46, i32 0, metadata !733, null}
!740 = metadata !{i32 48, i32 0, metadata !733, null}
!741 = metadata !{i32 49, i32 0, metadata !742, null}
!742 = metadata !{i32 786443, metadata !733, i32 49, i32 0, metadata !16, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!743 = metadata !{i32 51, i32 0, metadata !742, null}
!744 = metadata !{i32 55, i32 0, metadata !733, null}
!745 = metadata !{i32 57, i32 0, metadata !733, null}
!746 = metadata !{i32 58, i32 0, metadata !747, null}
!747 = metadata !{i32 786443, metadata !733, i32 58, i32 0, metadata !16, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!748 = metadata !{i32 59, i32 0, metadata !749, null}
!749 = metadata !{i32 786443, metadata !747, i32 58, i32 0, metadata !16, i32 8} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail/main.cpp]
!750 = metadata !{i32 65, i32 0, metadata !733, null}
!751 = metadata !{i32 66, i32 0, metadata !733, null}
!752 = metadata !{i32 68, i32 0, metadata !733, null}
!753 = metadata !{i32 419, i32 0, metadata !30, null}
!754 = metadata !{i32 419, i32 0, metadata !72, null}
!755 = metadata !{i32 419, i32 0, metadata !756, null}
!756 = metadata !{i32 786443, metadata !72, i32 419, i32 0, metadata !31, i32 9} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/089_constant_value_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_typ
!757 = metadata !{i32 16, i32 0, metadata !91, null}
!758 = metadata !{i32 17, i32 0, metadata !91, null}
!759 = metadata !{metadata !"omnipotent char", metadata !760}
!760 = metadata !{metadata !"Simple C/C++ TBAA"}
!761 = metadata !{i32 18, i32 0, metadata !91, null}
!762 = metadata !{i32 14, i32 0, metadata !127, null}
!763 = metadata !{i32 15, i32 0, metadata !127, null}
!764 = metadata !{i32 16, i32 0, metadata !127, null}
!765 = metadata !{i32 26, i32 0, metadata !766, null}
!766 = metadata !{i32 786443, metadata !217, i32 25, i32 0, metadata !218, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!767 = metadata !{i32 30, i32 0, metadata !768, null}
!768 = metadata !{i32 786443, metadata !246, i32 29, i32 0, metadata !218, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!769 = metadata !{i32 31, i32 0, metadata !768, null}
!770 = metadata !{i32 35, i32 0, metadata !771, null}
!771 = metadata !{i32 786443, metadata !252, i32 34, i32 0, metadata !218, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!772 = metadata !{i32 36, i32 0, metadata !771, null}
!773 = metadata !{i32 40, i32 0, metadata !774, null}
!774 = metadata !{i32 786443, metadata !258, i32 39, i32 0, metadata !218, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!775 = metadata !{i32 41, i32 0, metadata !774, null}
!776 = metadata !{i32 45, i32 0, metadata !777, null}
!777 = metadata !{i32 786443, metadata !262, i32 44, i32 0, metadata !218, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!778 = metadata !{i32 49, i32 0, metadata !779, null}
!779 = metadata !{i32 786443, metadata !270, i32 48, i32 0, metadata !218, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!780 = metadata !{i32 53, i32 0, metadata !781, null}
!781 = metadata !{i32 786443, metadata !278, i32 52, i32 0, metadata !218, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!782 = metadata !{i32 57, i32 0, metadata !783, null}
!783 = metadata !{i32 786443, metadata !286, i32 56, i32 0, metadata !218, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!784 = metadata !{i32 61, i32 0, metadata !785, null}
!785 = metadata !{i32 786443, metadata !294, i32 60, i32 0, metadata !218, i32 8} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!786 = metadata !{i32 65, i32 0, metadata !787, null}
!787 = metadata !{i32 786443, metadata !301, i32 64, i32 0, metadata !218, i32 9} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!788 = metadata !{i32 69, i32 0, metadata !789, null}
!789 = metadata !{i32 786443, metadata !309, i32 68, i32 0, metadata !218, i32 10} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!790 = metadata !{i32 73, i32 0, metadata !791, null}
!791 = metadata !{i32 786443, metadata !313, i32 72, i32 0, metadata !218, i32 11} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
...
!797 = metadata !{i32 786443, metadata !320, i32 80, i32 0, metadata !218, i32 12} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!798 = metadata !{i32 86, i32 0, metadata !799, null}
!799 = metadata !{i32 786443, metadata !334, i32 85, i32 0, metadata !218, i32 13} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!800 = metadata !{i32 91, i32 0, metadata !801, null}
!801 = metadata !{i32 786443, metadata !344, i32 90, i32 0, metadata !218, i32 14} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!802 = metadata !{i32 95, i32 0, metadata !803, null}
!803 = metadata !{i32 786443, metadata !354, i32 94, i32 0, metadata !218, i32 15} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
...
!808 = metadata !{i32 786443, metadata !359, i32 102, i32 0, metadata !218, i32 16} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!809 = metadata !{i32 108, i32 0, metadata !810, null}
!810 = metadata !{i32 786443, metadata !368, i32 106, i32 0, metadata !218, i32 17} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!811 = metadata !{i32 113, i32 0, metadata !812, null}
!812 = metadata !{i32 786443, metadata !377, i32 112, i32 0, metadata !218, i32 18} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!813 = metadata !{i32 119, i32 0, metadata !814, null}
!814 = metadata !{i32 786443, metadata !389, i32 118, i32 0, metadata !218, i32 19} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!815 = metadata !{i32 125, i32 0, metadata !816, null}
!816 = metadata !{i32 786443, metadata !403, i32 124, i32 0, metadata !218, i32 20} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!817 = metadata !{i32 131, i32 0, metadata !818, null}
!818 = metadata !{i32 786443, metadata !419, i32 130, i32 0, metadata !218, i32 21} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!819 = metadata !{i32 137, i32 0, metadata !820, null}
!820 = metadata !{i32 786443, metadata !432, i32 136, i32 0, metadata !218, i32 22} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!821 = metadata !{i32 143, i32 0, metadata !822, null}
!822 = metadata !{i32 786443, metadata !446, i32 142, i32 0, metadata !218, i32 23} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!823 = metadata !{i32 149, i32 0, metadata !824, null}
!824 = metadata !{i32 786443, metadata !459, i32 148, i32 0, metadata !218, i32 24} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!825 = metadata !{i32 153, i32 0, metadata !826, null}
!826 = metadata !{i32 786443, metadata !473, i32 152, i32 0, metadata !218, i32 25} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!827 = metadata !{i32 157, i32 0, metadata !828, null}
!828 = metadata !{i32 786443, metadata !497, i32 156, i32 0, metadata !218, i32 26} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!829 = metadata !{i32 161, i32 0, metadata !830, null}
!830 = metadata !{i32 786443, metadata !504, i32 160, i32 0, metadata !218, i32 27} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!831 = metadata !{i32 165, i32 0, metadata !832, null}
!832 = metadata !{i32 786443, metadata !523, i32 164, i32 0, metadata !218, i32 28} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!833 = metadata !{i32 171, i32 0, metadata !834, null}
!834 = metadata !{i32 786443, metadata !530, i32 170, i32 0, metadata !218, i32 29} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!835 = metadata !{i32 176, i32 0, metadata !836, null}
!836 = metadata !{i32 786443, metadata !543, i32 175, i32 0, metadata !218, i32 30} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!837 = metadata !{i32 181, i32 0, metadata !838, null}
!838 = metadata !{i32 786443, metadata !553, i32 180, i32 0, metadata !218, i32 31} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!839 = metadata !{i32 187, i32 0, metadata !840, null}
!840 = metadata !{i32 786443, metadata !564, i32 186, i32 0, metadata !218, i32 32} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!841 = metadata !{i32 192, i32 0, metadata !842, null}
!842 = metadata !{i32 786443, metadata !576, i32 191, i32 0, metadata !218, i32 33} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!843 = metadata !{i32 198, i32 0, metadata !844, null}
!844 = metadata !{i32 786443, metadata !586, i32 197, i32 0, metadata !218, i32 34} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!845 = metadata !{i32 203, i32 0, metadata !846, null}
!846 = metadata !{i32 786443, metadata !597, i32 201, i32 0, metadata !218, i32 35} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!847 = metadata !{i32 209, i32 0, metadata !848, null}
!848 = metadata !{i32 786443, metadata !607, i32 207, i32 0, metadata !218, i32 36} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!849 = metadata !{i32 214, i32 0, metadata !850, null}
!850 = metadata !{i32 786443, metadata !618, i32 213, i32 0, metadata !218, i32 37} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!851 = metadata !{i32 220, i32 0, metadata !852, null}
!852 = metadata !{i32 786443, metadata !629, i32 219, i32 0, metadata !218, i32 38} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!853 = metadata !{i32 225, i32 0, metadata !854, null}
!854 = metadata !{i32 786443, metadata !641, i32 224, i32 0, metadata !218, i32 39} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!855 = metadata !{i32 226, i32 0, metadata !854, null}
!856 = metadata !{i32 231, i32 0, metadata !857, null}
!857 = metadata !{i32 786443, metadata !651, i32 230, i32 0, metadata !218, i32 40} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!858 = metadata !{i32 235, i32 0, metadata !859, null}
!859 = metadata !{i32 786443, metadata !662, i32 234, i32 0, metadata !218, i32 41} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!860 = metadata !{i32 239, i32 0, metadata !861, null}
!861 = metadata !{i32 786443, metadata !669, i32 238, i32 0, metadata !218, i32 42} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!862 = metadata !{i32 240, i32 0, metadata !861, null}
!863 = metadata !{i32 245, i32 0, metadata !864, null}
!864 = metadata !{i32 786443, metadata !677, i32 244, i32 0, metadata !218, i32 43} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!865 = metadata !{i32 250, i32 0, metadata !866, null}
!866 = metadata !{i32 786443, metadata !687, i32 249, i32 0, metadata !218, i32 44} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!867 = metadata !{i32 255, i32 0, metadata !868, null}
!868 = metadata !{i32 786443, metadata !698, i32 254, i32 0, metadata !218, i32 45} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!869 = metadata !{i32 260, i32 0, metadata !870, null}
!870 = metadata !{i32 786443, metadata !706, i32 259, i32 0, metadata !218, i32 46} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!871 = metadata !{i32 264, i32 0, metadata !872, null}
!872 = metadata !{i32 786443, metadata !715, i32 263, i32 0, metadata !218, i32 47} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
