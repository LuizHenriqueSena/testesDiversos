...
//float img2[25] = {255,255,255,255,255,255,0,0,0,255,255,255,255,255,255,255,0,0,0,255,255,0,0,0,255};
...
//	int i = isCloseEnough(img,img2,10,25);
	__ESBMC_assume(isCloseEnough(img,img2,10,25) == 0);
//	__ESBMC_assert(isCloseEnough(img, 1), "Image is near");
	checkNNLUT(wfc1, bfc1, wfc2, bfc2, wfc3, bfc3, img);
}
