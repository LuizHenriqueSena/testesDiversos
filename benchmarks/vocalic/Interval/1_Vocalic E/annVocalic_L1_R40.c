...
__ESBMC_assume((layer1[0] >= 0) && (layer1[0] <= 0.125648006797));
...
__ESBMC_assume((layer1[4] >= 0.99098700285) && (layer1[4] <= 1));
float layer2[4];
...
__ESBMC_assume((layer2[0] >= 0.00247299997136) && (layer2[0] <= 0.997295022011));
...
__ESBMC_assume((layer2[1] >= 0.00336800003424) && (layer2[1] <= 1));
...
__ESBMC_assume((layer2[3] >= 0.226181000471) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[0] >= 0) && (layer3[0] <= 0.978119015694));
int r = 0;
...
__ESBMC_assume((layer3[1] >= 0) && (layer3[1] <= 0.991421997547));
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.670400977135));
...
__ESBMC_assume((layer3[4] >= 0) && (layer3[4] <= 0.914511024952));
