...
__ESBMC_assume((layer1[0] >= 0) && (layer1[0] <= 0.999998986721));
...
__ESBMC_assume((layer1[4] >= 9.99999997475e-07) && (layer1[4] <=1));
float layer2[4];
...
__ESBMC_assume((layer2[1] >= 0.00154099997599) && (layer2[1] <=0.999868988991));
...
__ESBMC_assume((layer2[3] >= 0.000322999985656) && (layer2[3] <=0.999979972839));
float layer3[5];
...
__ESBMC_assume((layer3[3] >= 0) && (layer3[3] <= 0.970372974873));
