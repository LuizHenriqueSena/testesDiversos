...
define void @_Z3fooPiS_(i32* %p, i32* %ptr_a) nounwind uwtable noinline {
  %1 = alloca i32*, align 8
  %2 = alloca i32*, align 8
  store i32* %p, i32** %1, align 8
  store i32* %ptr_a, i32** %2, align 8
  %3 = load i32** %1, align 8, !dbg !719
  %4 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !719
  %5 = zext i32 %4 to i64, !dbg !719
  %6 = getelementptr inbounds i32* %3, i64 %5, !dbg !719
  store i32* %6, i32** %2, align 8, !dbg !719
  ret void, !dbg !721
}
...
define i32 @main() uwtable {
  ...
  %8 = call noalias i8* @malloc(i64 8) nounwind, !dbg !724
  %9 = bitcast i8* %8 to i32*, !dbg !724
  store i32* %9, i32** %a, align 8, !dbg !724
  store i32 0, i32* %i, align 4, !dbg !725
  br label %10, !dbg !725

; <label>:10                                      ; preds = %13, %0
  %11 = load i32* %i, align 4, !dbg !725
  %12 = icmp slt i32 %11, 2, !dbg !725
  br i1 %12, label %13, label %20, !dbg !725

; <label>:13                                      ; preds = %10
  %14 = load i32* %i, align 4, !dbg !727
  %15 = sext i32 %14 to i64, !dbg !727
  %16 = load i32** %c, align 8, !dbg !727
  %17 = getelementptr inbounds i32* %16, i64 %15, !dbg !727
  store i32 2, i32* %17, align 4, !dbg !727
  %18 = load i32* %i, align 4, !dbg !725
  %19 = add nsw i32 %18, 1, !dbg !725
  store i32 %19, i32* %i, align 4, !dbg !725
  br label %10, !dbg !725

; <label>:20                                      ; preds = %10
  %21 = bitcast i32** %dev_c to i8**, !dbg !728
  %22 = call i32 @cudaMalloc(i8** %21, i64 8), !dbg !728
  %23 = bitcast i32** %dev_a to i8**, !dbg !729
  %24 = call i32 @cudaMalloc(i8** %23, i64 8), !dbg !729
  %25 = load i32** %dev_c, align 8, !dbg !730
  %26 = bitcast i32* %25 to i8*, !dbg !730
  %27 = load i32** %c, align 8, !dbg !730
  %28 = bitcast i32* %27 to i8*, !dbg !730
  %29 = call i32 @cudaMemcpy(i8* %26, i8* %28, i64 8, i32 1), !dbg !730
  ...
  %30 = bitcast { i64, i32 }* %4 to i8*, !dbg !731
  %31 = bitcast %struct.dim3* %2 to i8*, !dbg !731
  %32 = call i8* @memcpy(i8* %30, i8* %31, i64 12)
  %33 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !731
  %34 = load i64* %33, align 1, !dbg !731
  %35 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !731
  %36 = load i32* %35, align 1, !dbg !731
  %37 = bitcast { i64, i32 }* %5 to i8*, !dbg !731
  %38 = bitcast %struct.dim3* %3 to i8*, !dbg !731
  %39 = call i8* @memcpy(i8* %37, i8* %38, i64 12)
  %40 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !731
  %41 = load i64* %40, align 1, !dbg !731
  %42 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !731
  %43 = load i32* %42, align 1, !dbg !731
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %34, i32 %36, i64 %41, i32 %43), !dbg !731
  %44 = load i32** %dev_c, align 8, !dbg !733
  %45 = load i32** %dev_a, align 8, !dbg !733
  call void @_Z3fooPiS_(i32* %44, i32* %45), !dbg !733
  %46 = load i32** %a, align 8, !dbg !734
  %47 = bitcast i32* %46 to i8*, !dbg !734
  %48 = load i32** %dev_a, align 8, !dbg !734
  %49 = bitcast i32* %48 to i8*, !dbg !734
  %50 = call i32 @cudaMemcpy(i8* %47, i8* %49, i64 8, i32 2), !dbg !734
  %51 = load i32** %a, align 8, !dbg !735
  %52 = bitcast i32* %51 to i8*, !dbg !735
  call void @free(i8* %52) nounwind, !dbg !735
  %53 = load i32** %c, align 8, !dbg !736
  %54 = bitcast i32* %53 to i8*, !dbg !736
  call void @free(i8* %54) nounwind, !dbg !736
  %55 = load i32** %dev_a, align 8, !dbg !737
  %56 = bitcast i32* %55 to i8*, !dbg !737
  %57 = call i32 @cudaFree(i8* %56), !dbg !737
  %58 = load i32** %dev_c, align 8, !dbg !738
  %59 = bitcast i32* %58 to i8*, !dbg !738
  %60 = call i32 @cudaFree(i8* %59), !dbg !738
  ret i32 0, !dbg !739
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !11,
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8", null} ; [ DW_TAG_file_type ]
...
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"foo", metadata !"foo", metadata !"_Z3fooPiS_", metadata !16, i32 8, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32*)* @_Z3fooPiS_, null, null, metadata 
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 8, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8/main.cpp]
!721 = metadata !{i32 13, i32 0, metadata !720, null}
!722 = metadata !{i32 22, i32 0, metadata !723, null}
!723 = metadata !{i32 786443, metadata !21, i32 15, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8/main.cpp]
!724 = metadata !{i32 23, i32 0, metadata !723, null}
!725 = metadata !{i32 25, i32 0, metadata !726, null}
!726 = metadata !{i32 786443, metadata !723, i32 25, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8/main.cpp]
!727 = metadata !{i32 26, i32 0, metadata !726, null}
!728 = metadata !{i32 28, i32 0, metadata !723, null}
!729 = metadata !{i32 29, i32 0, metadata !723, null}
!730 = metadata !{i32 31, i32 0, metadata !723, null}
!731 = metadata !{i32 32, i32 0, metadata !732, null}
!732 = metadata !{i32 786443, metadata !723, i32 32, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8/main.cpp]
!733 = metadata !{i32 34, i32 0, metadata !732, null}
!734 = metadata !{i32 38, i32 0, metadata !723, null}
!735 = metadata !{i32 40, i32 0, metadata !723, null}
!736 = metadata !{i32 41, i32 0, metadata !723, null}
!737 = metadata !{i32 42, i32 0, metadata !723, null}
!738 = metadata !{i32 43, i32 0, metadata !723, null}
!739 = metadata !{i32 45, i32 0, metadata !723, null}
...
!743 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/099_test8//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
