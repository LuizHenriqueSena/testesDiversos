...
@.str2 = private unnamed_addr constant [8 x i8] c"c[i]!=0\00", align 1
@.str3 = private unnamed_addr constant [9 x i8] c"main.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

define void @_Z3barPi(i32* %p) nounwind uwtable section "__device__" {
  %1 = alloca i32*, align 8
  store i32* %p, i32** %1, align 8
  %2 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !720
  %3 = zext i32 %2 to i64, !dbg !720
  %4 = load i32** %1, align 8, !dbg !720
  %5 = getelementptr inbounds i32* %4, i64 %3, !dbg !720
...
define void @_Z3fooPi(i32* %p) nounwind uwtable noinline {
  %1 = alloca i32*, align 8
  store i32* %p, i32** %1, align 8
  %2 = load i32** %1, align 8, !dbg !723
  call void @_Z3barPi(i32* %2), !dbg !723
  ret void, !dbg !725
}
...
define i32 @main() uwtable {
  ...
  store i32 0, i32* %1
  %6 = call noalias i8* @malloc(i64 8) nounwind, !dbg !726
  %7 = bitcast i8* %6 to i32*, !dbg !726
  store i32* %7, i32** %c, align 8, !dbg !726
  store i32 0, i32* %i, align 4, !dbg !728
  br label %8, !dbg !728

; <label>:8                                       ; preds = %11, %0
  %9 = load i32* %i, align 4, !dbg !728
  %10 = icmp slt i32 %9, 2, !dbg !728
  br i1 %10, label %11, label %21, !dbg !728

; <label>:11                                      ; preds = %8
  %12 = call i32 @rand() nounwind, !dbg !730
  %13 = srem i32 %12, 10, !dbg !730
  %14 = add nsw i32 %13, 1, !dbg !730
  %15 = load i32* %i, align 4, !dbg !730
  %16 = sext i32 %15 to i64, !dbg !730
  %17 = load i32** %c, align 8, !dbg !730
  %18 = getelementptr inbounds i32* %17, i64 %16, !dbg !730
  store i32 %14, i32* %18, align 4, !dbg !730
  %19 = load i32* %i, align 4, !dbg !728
  %20 = add nsw i32 %19, 1, !dbg !728
  store i32 %20, i32* %i, align 4, !dbg !728
  br label %8, !dbg !728

; <label>:21                                      ; preds = %8
  store i32 0, i32* %i1, align 4, !dbg !731
  br label %22, !dbg !731

; <label>:22                                      ; preds = %25, %21
  %23 = load i32* %i1, align 4, !dbg !731
  %24 = icmp slt i32 %23, 2, !dbg !731
  br i1 %24, label %25, label %34, !dbg !731

; <label>:25                                      ; preds = %22
  %26 = load i32* %i1, align 4, !dbg !733
  %27 = sext i32 %26 to i64, !dbg !733
  %28 = load i32** %c, align 8, !dbg !733
  %29 = getelementptr inbounds i32* %28, i64 %27, !dbg !733
  %30 = load i32* %29, align 4, !dbg !733
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 %30), !dbg !733
  %32 = load i32* %i1, align 4, !dbg !731
  %33 = add nsw i32 %32, 1, !dbg !731
  store i32 %33, i32* %i1, align 4, !dbg !731
  br label %22, !dbg !731

; <label>:34                                      ; preds = %22
  %35 = bitcast i32** %dev_c to i8**, !dbg !734
  %36 = call i32 @cudaMalloc(i8** %35, i64 8), !dbg !734
  %37 = load i32** %dev_c, align 8, !dbg !735
  %38 = bitcast i32* %37 to i8*, !dbg !735
  %39 = load i32** %c, align 8, !dbg !735
  %40 = bitcast i32* %39 to i8*, !dbg !735
  %41 = call i32 @cudaMemcpy(i8* %38, i8* %40, i64 8, i32 1), !dbg !735
  ...
  %42 = bitcast { i64, i32 }* %4 to i8*, !dbg !736
  %43 = bitcast %struct.dim3* %2 to i8*, !dbg !736
  %44 = call i8* @memcpy(i8* %42, i8* %43, i64 12)
  %45 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !736
  %46 = load i64* %45, align 1, !dbg !736
  %47 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !736
  %48 = load i32* %47, align 1, !dbg !736
  %49 = bitcast { i64, i32 }* %5 to i8*, !dbg !736
  %50 = bitcast %struct.dim3* %3 to i8*, !dbg !736
  %51 = call i8* @memcpy(i8* %49, i8* %50, i64 12)
  %52 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !736
  %53 = load i64* %52, align 1, !dbg !736
  %54 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !736
  %55 = load i32* %54, align 1, !dbg !736
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %46, i32 %48, i64 %53, i32 %55), !dbg !736
  %56 = load i32** %dev_c, align 8, !dbg !738
  call void @_Z3fooPi(i32* %56), !dbg !738
  %57 = load i32** %c, align 8, !dbg !739
  %58 = bitcast i32* %57 to i8*, !dbg !739
  %59 = load i32** %dev_c, align 8, !dbg !739
  %60 = bitcast i32* %59 to i8*, !dbg !739
  %61 = call i32 @cudaMemcpy(i8* %58, i8* %60, i64 8, i32 2), !dbg !739
  %62 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @.str1, i32 0, i32 0)), !dbg !740
  store i32 0, i32* %i2, align 4, !dbg !741
  br label %63, !dbg !741

; <label>:63                                      ; preds = %80, %34
  %64 = load i32* %i2, align 4, !dbg !741
  %65 = icmp slt i32 %64, 2, !dbg !741
  br i1 %65, label %66, label %83, !dbg !741

; <label>:66                                      ; preds = %63
  %67 = load i32* %i2, align 4, !dbg !743
  %68 = sext i32 %67 to i64, !dbg !743
  %69 = load i32** %c, align 8, !dbg !743
  %70 = getelementptr inbounds i32* %69, i64 %68, !dbg !743
  %71 = load i32* %70, align 4, !dbg !743
  %72 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 %71), !dbg !743
  %73 = load i32* %i2, align 4, !dbg !745
  %74 = sext i32 %73 to i64, !dbg !745
  %75 = load i32** %c, align 8, !dbg !745
  %76 = getelementptr inbounds i32* %75, i64 %74, !dbg !745
  %77 = load i32* %76, align 4, !dbg !745
  %78 = icmp ne i32 %77, 0, !dbg !745
  br i1 %78, label %80, label %79, !dbg !745

; <label>:79                                      ; preds = %66
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 43, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwin
  unreachable, !dbg !745

; <label>:80                                      ; preds = %66
  %81 = load i32* %i2, align 4, !dbg !741
  %82 = add nsw i32 %81, 1, !dbg !741
  store i32 %82, i32* %i2, align 4, !dbg !741
  br label %63, !dbg !741

; <label>:83                                      ; preds = %63
  %84 = load i32** %c, align 8, !dbg !746
  %85 = bitcast i32* %84 to i8*, !dbg !746
  call void @free(i8* %85) nounwind, !dbg !746
  %86 = load i32** %dev_c, align 8, !dbg !747
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail", null} ; [ DW_TAG_file_type ]
...
!14 = metadata !{metadata !15, metadata !21, metadata !22, metadata !25, metadata !68}
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"bar", metadata !"bar", metadata !"_Z3barPi", metadata !16, i32 6, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*)* @_Z3barPi, null, null, metadata !11, i32 6
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail", null} ; [ DW_TAG_file_type ]
...
!21 = metadata !{i32 786478, i32 0, metadata !16, metadata !"foo", metadata !"foo", metadata !"_Z3fooPi", metadata !16, i32 11, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*)* @_Z3fooPi, null, null, metadata !11, i32 
!22 = metadata !{i32 786478, i32 0, metadata !16, metadata !"main", metadata !"main", metadata !"", metadata !16, i32 17, metadata !23, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main, null, null, metadata !11, i32 17} ; [ DW_TAG_
...
!26 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 7, i32 0, metadata !721, null}
!721 = metadata !{i32 786443, metadata !15, i32 6, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!722 = metadata !{i32 9, i32 0, metadata !721, null}
!723 = metadata !{i32 13, i32 0, metadata !724, null}
!724 = metadata !{i32 786443, metadata !21, i32 11, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!725 = metadata !{i32 15, i32 0, metadata !724, null}
!726 = metadata !{i32 20, i32 0, metadata !727, null}
!727 = metadata !{i32 786443, metadata !22, i32 17, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!728 = metadata !{i32 22, i32 0, metadata !729, null}
!729 = metadata !{i32 786443, metadata !727, i32 22, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!730 = metadata !{i32 23, i32 0, metadata !729, null}
!731 = metadata !{i32 25, i32 0, metadata !732, null}
!732 = metadata !{i32 786443, metadata !727, i32 25, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!733 = metadata !{i32 26, i32 0, metadata !732, null}
!734 = metadata !{i32 28, i32 0, metadata !727, null}
!735 = metadata !{i32 30, i32 0, metadata !727, null}
!736 = metadata !{i32 31, i32 0, metadata !737, null}
!737 = metadata !{i32 786443, metadata !727, i32 31, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!738 = metadata !{i32 33, i32 0, metadata !737, null}
!739 = metadata !{i32 37, i32 0, metadata !727, null}
!740 = metadata !{i32 39, i32 0, metadata !727, null}
!741 = metadata !{i32 41, i32 0, metadata !742, null}
!742 = metadata !{i32 786443, metadata !727, i32 41, i32 0, metadata !16, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!743 = metadata !{i32 42, i32 0, metadata !744, null}
!744 = metadata !{i32 786443, metadata !742, i32 41, i32 0, metadata !16, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail/main.cpp]
!745 = metadata !{i32 43, i32 0, metadata !744, null}
!746 = metadata !{i32 46, i32 0, metadata !727, null}
!747 = metadata !{i32 47, i32 0, metadata !727, null}
!748 = metadata !{i32 49, i32 0, metadata !727, null}
!749 = metadata !{i32 419, i32 0, metadata !25, null}
!750 = metadata !{i32 419, i32 0, metadata !68, null}
!751 = metadata !{i32 419, i32 0, metadata !752, null}
!752 = metadata !{i32 786443, metadata !68, i32 419, i32 0, metadata !26, i32 8} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/036_test4_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
