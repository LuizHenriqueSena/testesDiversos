...
@.str = private unnamed_addr constant [25 x i8] c"threadIdx.x < blockDim.x\00", align 1
...
define void @_Z3fooPi(i32* %A) nounwind uwtable noinline {
  ...
  %3 = load i32* getelementptr inbounds (%struct.dim3* @blockDim, i32 0, i32 0), align 4, !dbg !719
  %4 = icmp ult i32 %2, %3, !dbg !719
  br i1 %4, label %6, label %5, !dbg !719

; <label>:5                                       ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([25 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str1, i32 0, i32 0), i32 12, i8* getelementptr inbounds ([16 x i8]* @__PRETTY_FUNCTION__._Z3fooPi, i32 0, i32 0)) noreturn nou
  unreachable, !dbg !719
...
define i32 @main() uwtable {
  ...
  %3 = alloca { i64, i32 }
  %4 = alloca { i64, i32 }
  %5 = call noalias i8* @malloc(i64 8) nounwind, !dbg !722
  %6 = bitcast i8* %5 to i32*, !dbg !722
  store i32* %6, i32** %a, align 8, !dbg !722
  %7 = bitcast i32** %dev_a to i8**, !dbg !724
  %8 = call i32 @cudaMalloc(i8** %7, i64 8), !dbg !724
  %9 = load i32** %dev_a, align 8, !dbg !725
  %10 = bitcast i32* %9 to i8*, !dbg !725
  %11 = load i32** %a, align 8, !dbg !725
  %12 = bitcast i32* %11 to i8*, !dbg !725
  %13 = call i32 @cudaMemcpy(i8* %10, i8* %12, i64 8, i32 1), !dbg !725
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %1, i32 1, i32 1, i32 1), !dbg !726
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 2, i32 1, i32 1), !dbg !726
  %14 = bitcast { i64, i32 }* %3 to i8*, !dbg !726
  %15 = bitcast %struct.dim3* %1 to i8*, !dbg !726
  %16 = call i8* @memcpy(i8* %14, i8* %15, i64 12)
  %17 = getelementptr { i64, i32 }* %3, i32 0, i32 0, !dbg !726
  %18 = load i64* %17, align 1, !dbg !726
  %19 = getelementptr { i64, i32 }* %3, i32 0, i32 1, !dbg !726
  %20 = load i32* %19, align 1, !dbg !726
  %21 = bitcast { i64, i32 }* %4 to i8*, !dbg !726
  %22 = bitcast %struct.dim3* %2 to i8*, !dbg !726
  %23 = call i8* @memcpy(i8* %21, i8* %22, i64 12)
  %24 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !726
  %25 = load i64* %24, align 1, !dbg !726
  %26 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !726
  %27 = load i32* %26, align 1, !dbg !726
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %18, i32 %20, i64 %25, i32 %27), !dbg !726
  %28 = load i32** %dev_a, align 8, !dbg !728
  call void @_Z3fooPi(i32* %28), !dbg !728
  %29 = load i32** %dev_a, align 8, !dbg !729
  %30 = bitcast i32* %29 to i8*, !dbg !729
  %31 = call i32 @cudaFree(i8* %30), !dbg !729
  %32 = load i32** %a, align 8, !dbg !730
  %33 = bitcast i32* %32 to i8*, !dbg !730
  call void @free(i8* %33) nounwind, !dbg !730
  ret i32 0, !dbg !731
}
...
define linkonce_odr void @_ZN4dim3C1Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr uwtable section "__device__" align 2 {
  ...
  %6 = load i32* %2, align 4, !dbg !732
  %7 = load i32* %3, align 4, !dbg !732
  %8 = load i32* %4, align 4, !dbg !732
  call void @_ZN4dim3C2Ejjj(%struct.dim3* %5, i32 %6, i32 %7, i32 %8), !dbg !732
  ret void, !dbg !732
}
...
define linkonce_odr void @_ZN4dim3C2Ejjj(%struct.dim3* %this, i32 %vx, i32 %vy, i32 %vz) unnamed_addr nounwind uwtable section "__device__" align 2 {
  ...
  store i32 %vz, i32* %4, align 4
  %5 = load %struct.dim3** %1
  %6 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 0, !dbg !733
  %7 = load i32* %2, align 4, !dbg !733
  store i32 %7, i32* %6, align 4, !dbg !733
  %8 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 1, !dbg !733
  %9 = load i32* %3, align 4, !dbg !733
  store i32 %9, i32* %8, align 4, !dbg !733
  %10 = getelementptr inbounds %struct.dim3* %5, i32 0, i32 2, !dbg !733
  %11 = load i32* %4, align 4, !dbg !733
  store i32 %11, i32* %10, align 4, !dbg !733
  ret void, !dbg !734
}

define i8* @memcpy(i8* %destaddr, i8* nocapture %srcaddr, i64 %len) nounwind uwtable {
  %1 = icmp eq i64 %len, 0, !dbg !736
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !736

.lr.ph:                                           ; preds = %.lr.ph, %0
  %src.06 = phi i8* [ %3, %.lr.ph ], [ %srcaddr, %0 ]
  %dest.05 = phi i8* [ %5, %.lr.ph ], [ %destaddr, %0 ]
  %.04 = phi i64 [ %2, %.lr.ph ], [ %len, %0 ]
  %2 = add i64 %.04, -1, !dbg !736
  %3 = getelementptr inbounds i8* %src.06, i64 1, !dbg !737
  %4 = load i8* %src.06, align 1, !dbg !737, !tbaa !738
  %5 = getelementptr inbounds i8* %dest.05, i64 1, !dbg !737
  store i8 %4, i8* %dest.05, align 1, !dbg !737, !tbaa !738
  %6 = icmp eq i64 %2, 0, !dbg !736
  br i1 %6, label %._crit_edge, label %.lr.ph, !dbg !736

._crit_edge:                                      ; preds = %.lr.ph, %0
  ret i8* %destaddr, !dbg !740
}

declare void @llvm.dbg.value(metadata, i64, metadata) nounwind readnone

define i8* @memset(i8* %dst, i32 %s, i64 %count) nounwind uwtable {
  %1 = icmp eq i64 %count, 0, !dbg !741
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !741

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !742
  br label %3, !dbg !741

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.05 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.04 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.04, -1, !dbg !741
  %5 = getelementptr inbounds i8* %a.05, i64 1, !dbg !742
  store volatile i8 %2, i8* %a.05, align 1, !dbg !742, !tbaa !738
  %6 = icmp eq i64 %4, 0, !dbg !741
  br i1 %6, label %._crit_edge, label %3, !dbg !741
...
define i32 @cudaFree(i8* nocapture %devPtr) nounwind uwtable {
  tail call void @free(i8* %devPtr) nounwind, !dbg !746
  ret i32 0, !dbg !748
}

define i32 @cudaFreeArray(%struct.cudaArray* nocapture %array) nounwind uwtable {
  %1 = bitcast %struct.cudaArray* %array to i8*, !dbg !749
  tail call void @free(i8* %1) nounwind, !dbg !749
  ret i32 0, !dbg !751
}

define i32 @cudaFreeHost(i8* nocapture %ptr) nounwind uwtable {
  tail call void @free(i8* %ptr) nounwind, !dbg !752
  ret i32 0, !dbg !754
}
...
define i32 @cudaMalloc(i8** nocapture %devPtr, i64 %size) uwtable {
  tail call void @__set_device(), !dbg !769
  %1 = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !771
  store i8* %1, i8** %devPtr, align 8, !dbg !771, !tbaa !772
  tail call void @__clear_device(), !dbg !773
  ret i32 0, !dbg !774
}
...
define i32 @cudaMallocHost(i8** nocapture %ptr, i64 %size) uwtable {
  tail call void @__set_host(), !dbg !781
  %1 = tail call noalias i8* @malloc(i64 %size) nounwind, !dbg !783
  store i8* %1, i8** %ptr, align 8, !dbg !783, !tbaa !772
  tail call void @__clear_host(), !dbg !784
  ret i32 0, !dbg !785
}
...
define i32 @cudaMemcpyToSymbol(i8* nocapture %symbol, i8* nocapture %src, i64 %count, i64 %offset, i32 %kind) nounwind uwtable {
  %1 = getelementptr inbounds i8* %symbol, i64 %offset, !dbg !832
...
define i32 @cudaMemset(i8* nocapture %devPtr, i32 %value, i64 %count) nounwind uwtable {
  %1 = trunc i32 %value to i8, !dbg !839
  %2 = zext i8 %1 to i32
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all", null} ; [ DW_TAG_file_type ]
...
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"foo", metadata !"foo", metadata !"_Z3fooPi", metadata !16, i32 8, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*)* @_Z3fooPi, null, null, metadata !11, i32 9
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 9, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all/main.cpp]
!721 = metadata !{i32 14, i32 0, metadata !720, null}
!722 = metadata !{i32 19, i32 0, metadata !723, null}
!723 = metadata !{i32 786443, metadata !21, i32 16, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all/main.cpp]
!724 = metadata !{i32 21, i32 0, metadata !723, null}
!725 = metadata !{i32 22, i32 0, metadata !723, null}
!726 = metadata !{i32 23, i32 0, metadata !727, null}
!727 = metadata !{i32 786443, metadata !723, i32 23, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all/main.cpp]
!728 = metadata !{i32 25, i32 0, metadata !727, null}
!729 = metadata !{i32 29, i32 0, metadata !723, null}
!730 = metadata !{i32 30, i32 0, metadata !723, null}
!731 = metadata !{i32 32, i32 0, metadata !723, null}
!732 = metadata !{i32 419, i32 0, metadata !24, null}
!733 = metadata !{i32 419, i32 0, metadata !67, null}
!734 = metadata !{i32 419, i32 0, metadata !735, null}
!735 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/060_test_all//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
!736 = metadata !{i32 16, i32 0, metadata !86, null}
!737 = metadata !{i32 17, i32 0, metadata !86, null}
!738 = metadata !{metadata !"omnipotent char", metadata !739}
!739 = metadata !{metadata !"Simple C/C++ TBAA"}
!740 = metadata !{i32 18, i32 0, metadata !86, null}
!741 = metadata !{i32 14, i32 0, metadata !122, null}
!742 = metadata !{i32 15, i32 0, metadata !122, null}
!743 = metadata !{i32 16, i32 0, metadata !122, null}
!744 = metadata !{i32 26, i32 0, metadata !745, null}
!745 = metadata !{i32 786443, metadata !212, i32 25, i32 0, metadata !213, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!746 = metadata !{i32 30, i32 0, metadata !747, null}
!747 = metadata !{i32 786443, metadata !241, i32 29, i32 0, metadata !213, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!748 = metadata !{i32 31, i32 0, metadata !747, null}
!749 = metadata !{i32 35, i32 0, metadata !750, null}
!750 = metadata !{i32 786443, metadata !247, i32 34, i32 0, metadata !213, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!751 = metadata !{i32 36, i32 0, metadata !750, null}
!752 = metadata !{i32 40, i32 0, metadata !753, null}
!753 = metadata !{i32 786443, metadata !253, i32 39, i32 0, metadata !213, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!754 = metadata !{i32 41, i32 0, metadata !753, null}
!755 = metadata !{i32 45, i32 0, metadata !756, null}
!756 = metadata !{i32 786443, metadata !257, i32 44, i32 0, metadata !213, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!757 = metadata !{i32 49, i32 0, metadata !758, null}
!758 = metadata !{i32 786443, metadata !265, i32 48, i32 0, metadata !213, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!759 = metadata !{i32 53, i32 0, metadata !760, null}
!760 = metadata !{i32 786443, metadata !273, i32 52, i32 0, metadata !213, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!761 = metadata !{i32 57, i32 0, metadata !762, null}
!762 = metadata !{i32 786443, metadata !281, i32 56, i32 0, metadata !213, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!763 = metadata !{i32 61, i32 0, metadata !764, null}
!764 = metadata !{i32 786443, metadata !289, i32 60, i32 0, metadata !213, i32 8} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!765 = metadata !{i32 65, i32 0, metadata !766, null}
!766 = metadata !{i32 786443, metadata !296, i32 64, i32 0, metadata !213, i32 9} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaRu
!767 = metadata !{i32 69, i32 0, metadata !768, null}
!768 = metadata !{i32 786443, metadata !304, i32 68, i32 0, metadata !213, i32 10} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!769 = metadata !{i32 73, i32 0, metadata !770, null}
!770 = metadata !{i32 786443, metadata !308, i32 72, i32 0, metadata !213, i32 11} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!771 = metadata !{i32 74, i32 0, metadata !770, null}
!772 = metadata !{metadata !"any pointer", metadata !738}
!773 = metadata !{i32 75, i32 0, metadata !770, null}
!774 = metadata !{i32 77, i32 0, metadata !770, null}
!775 = metadata !{i32 81, i32 0, metadata !776, null}
!776 = metadata !{i32 786443, metadata !315, i32 80, i32 0, metadata !213, i32 12} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!777 = metadata !{i32 86, i32 0, metadata !778, null}
!778 = metadata !{i32 786443, metadata !329, i32 85, i32 0, metadata !213, i32 13} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!779 = metadata !{i32 91, i32 0, metadata !780, null}
!780 = metadata !{i32 786443, metadata !339, i32 90, i32 0, metadata !213, i32 14} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!781 = metadata !{i32 95, i32 0, metadata !782, null}
!782 = metadata !{i32 786443, metadata !349, i32 94, i32 0, metadata !213, i32 15} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/CudaR
!783 = metadata !{i32 96, i32 0, metadata !782, null}
!784 = metadata !{i32 97, i32 0, metadata !782, null}
!785 = metadata !{i32 99, i32 0, metadata !782, null}
!786 = metadata !{i32 103, i32 0, metadata !787, null}
!787 = metadata !{i32 786443, metadata !354, i32 102, i32 0, metadata !213, i32 16} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!788 = metadata !{i32 108, i32 0, metadata !789, null}
!789 = metadata !{i32 786443, metadata !363, i32 106, i32 0, metadata !213, i32 17} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!790 = metadata !{i32 113, i32 0, metadata !791, null}
!791 = metadata !{i32 786443, metadata !372, i32 112, i32 0, metadata !213, i32 18} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!792 = metadata !{i32 119, i32 0, metadata !793, null}
!793 = metadata !{i32 786443, metadata !384, i32 118, i32 0, metadata !213, i32 19} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!794 = metadata !{i32 125, i32 0, metadata !795, null}
!795 = metadata !{i32 786443, metadata !398, i32 124, i32 0, metadata !213, i32 20} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!796 = metadata !{i32 131, i32 0, metadata !797, null}
!797 = metadata !{i32 786443, metadata !414, i32 130, i32 0, metadata !213, i32 21} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!798 = metadata !{i32 137, i32 0, metadata !799, null}
!799 = metadata !{i32 786443, metadata !427, i32 136, i32 0, metadata !213, i32 22} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!800 = metadata !{i32 143, i32 0, metadata !801, null}
!801 = metadata !{i32 786443, metadata !441, i32 142, i32 0, metadata !213, i32 23} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!802 = metadata !{i32 149, i32 0, metadata !803, null}
!803 = metadata !{i32 786443, metadata !454, i32 148, i32 0, metadata !213, i32 24} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!804 = metadata !{i32 153, i32 0, metadata !805, null}
!805 = metadata !{i32 786443, metadata !468, i32 152, i32 0, metadata !213, i32 25} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!806 = metadata !{i32 157, i32 0, metadata !807, null}
!807 = metadata !{i32 786443, metadata !492, i32 156, i32 0, metadata !213, i32 26} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!808 = metadata !{i32 161, i32 0, metadata !809, null}
!809 = metadata !{i32 786443, metadata !499, i32 160, i32 0, metadata !213, i32 27} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!810 = metadata !{i32 165, i32 0, metadata !811, null}
!811 = metadata !{i32 786443, metadata !518, i32 164, i32 0, metadata !213, i32 28} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!812 = metadata !{i32 171, i32 0, metadata !813, null}
!813 = metadata !{i32 786443, metadata !525, i32 170, i32 0, metadata !213, i32 29} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!814 = metadata !{i32 176, i32 0, metadata !815, null}
!815 = metadata !{i32 786443, metadata !538, i32 175, i32 0, metadata !213, i32 30} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!816 = metadata !{i32 181, i32 0, metadata !817, null}
!817 = metadata !{i32 786443, metadata !548, i32 180, i32 0, metadata !213, i32 31} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!818 = metadata !{i32 187, i32 0, metadata !819, null}
!819 = metadata !{i32 786443, metadata !559, i32 186, i32 0, metadata !213, i32 32} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!820 = metadata !{i32 192, i32 0, metadata !821, null}
!821 = metadata !{i32 786443, metadata !571, i32 191, i32 0, metadata !213, i32 33} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!822 = metadata !{i32 198, i32 0, metadata !823, null}
!823 = metadata !{i32 786443, metadata !581, i32 197, i32 0, metadata !213, i32 34} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!824 = metadata !{i32 203, i32 0, metadata !825, null}
!825 = metadata !{i32 786443, metadata !592, i32 201, i32 0, metadata !213, i32 35} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!826 = metadata !{i32 209, i32 0, metadata !827, null}
!827 = metadata !{i32 786443, metadata !602, i32 207, i32 0, metadata !213, i32 36} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!828 = metadata !{i32 214, i32 0, metadata !829, null}
!829 = metadata !{i32 786443, metadata !613, i32 213, i32 0, metadata !213, i32 37} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!830 = metadata !{i32 220, i32 0, metadata !831, null}
!831 = metadata !{i32 786443, metadata !624, i32 219, i32 0, metadata !213, i32 38} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!832 = metadata !{i32 225, i32 0, metadata !833, null}
!833 = metadata !{i32 786443, metadata !636, i32 224, i32 0, metadata !213, i32 39} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!834 = metadata !{i32 226, i32 0, metadata !833, null}
!835 = metadata !{i32 231, i32 0, metadata !836, null}
!836 = metadata !{i32 786443, metadata !646, i32 230, i32 0, metadata !213, i32 40} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!837 = metadata !{i32 235, i32 0, metadata !838, null}
!838 = metadata !{i32 786443, metadata !657, i32 234, i32 0, metadata !213, i32 41} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!839 = metadata !{i32 239, i32 0, metadata !840, null}
!840 = metadata !{i32 786443, metadata !664, i32 238, i32 0, metadata !213, i32 42} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!841 = metadata !{i32 240, i32 0, metadata !840, null}
!842 = metadata !{i32 245, i32 0, metadata !843, null}
!843 = metadata !{i32 786443, metadata !672, i32 244, i32 0, metadata !213, i32 43} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!844 = metadata !{i32 250, i32 0, metadata !845, null}
!845 = metadata !{i32 786443, metadata !682, i32 249, i32 0, metadata !213, i32 44} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!846 = metadata !{i32 255, i32 0, metadata !847, null}
!847 = metadata !{i32 786443, metadata !693, i32 254, i32 0, metadata !213, i32 45} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!848 = metadata !{i32 260, i32 0, metadata !849, null}
!849 = metadata !{i32 786443, metadata !701, i32 259, i32 0, metadata !213, i32 46} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
!850 = metadata !{i32 264, i32 0, metadata !851, null}
!851 = metadata !{i32 786443, metadata !710, i32 263, i32 0, metadata !213, i32 47} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/OutrosVerificadores/Gklee/build/Gklee/runtime/CudaRuntime//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/runtime/Cuda
