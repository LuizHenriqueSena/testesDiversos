...
; <label>:15                                      ; preds = %18, %0
  ...
  %17 = icmp slt i32 %16, 2, !dbg !729
  br i1 %17, label %18, label %26, !dbg !729

; <label>:18                                      ; preds = %15
  %19 = load i32* %i, align 4, !dbg !731
  %20 = load i32* %i, align 4, !dbg !731
  %21 = sext i32 %20 to i64, !dbg !731
  %22 = load i32** %a, align 8, !dbg !731
  %23 = getelementptr inbounds i32* %22, i64 %21, !dbg !731
  store i32 %19, i32* %23, align 4, !dbg !731
  %24 = load i32* %i, align 4, !dbg !729
  %25 = add nsw i32 %24, 1, !dbg !729
  store i32 %25, i32* %i, align 4, !dbg !729
  br label %15, !dbg !729

; <label>:26                                      ; preds = %15
  %27 = load i32** %dev_a, align 8, !dbg !732
  %28 = bitcast i32* %27 to i8*, !dbg !732
  %29 = load i32** %a, align 8, !dbg !732
  %30 = bitcast i32* %29 to i8*, !dbg !732
  %31 = load i32* %size, align 4, !dbg !732
  %32 = sext i32 %31 to i64, !dbg !732
  %33 = call i32 @cudaMemcpy(i8* %28, i8* %30, i64 %32, i32 1), !dbg !732
  %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0)), !dbg !733
  store i32 0, i32* %i1, align 4, !dbg !734
  br label %35, !dbg !734

; <label>:35                                      ; preds = %38, %26
  %36 = load i32* %i1, align 4, !dbg !734
  %37 = icmp slt i32 %36, 2, !dbg !734
  br i1 %37, label %38, label %47, !dbg !734

; <label>:38                                      ; preds = %35
  %39 = load i32* %i1, align 4, !dbg !736
  %40 = sext i32 %39 to i64, !dbg !736
  %41 = load i32** %a, align 8, !dbg !736
  %42 = getelementptr inbounds i32* %41, i64 %40, !dbg !736
  %43 = load i32* %42, align 4, !dbg !736
  %44 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0), i32 %43), !dbg !736
  %45 = load i32* %i1, align 4, !dbg !734
  %46 = add nsw i32 %45, 1, !dbg !734
  store i32 %46, i32* %i1, align 4, !dbg !734
  br label %35, !dbg !734
...
; <label>:47                                      ; preds = %35
  ...
  %48 = bitcast { i64, i32 }* %4 to i8*, !dbg !737
  %49 = bitcast %struct.dim3* %2 to i8*, !dbg !737
  %50 = call i8* @memcpy(i8* %48, i8* %49, i64 12)
  %51 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !737
  %52 = load i64* %51, align 1, !dbg !737
  %53 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !737
  %54 = load i32* %53, align 1, !dbg !737
  %55 = bitcast { i64, i32 }* %5 to i8*, !dbg !737
  %56 = bitcast %struct.dim3* %3 to i8*, !dbg !737
  %57 = call i8* @memcpy(i8* %55, i8* %56, i64 12)
  %58 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !737
  %59 = load i64* %58, align 1, !dbg !737
  %60 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !737
  %61 = load i32* %60, align 1, !dbg !737
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %52, i32 %54, i64 %59, i32 %61), !dbg !737
  %62 = load i32** %dev_a, align 8, !dbg !739
  call void @_Z7shufflePi(i32* %62), !dbg !739
  %63 = load i32** %a, align 8, !dbg !740
  %64 = bitcast i32* %63 to i8*, !dbg !740
  %65 = load i32** %dev_a, align 8, !dbg !740
  %66 = bitcast i32* %65 to i8*, !dbg !740
  %67 = load i32* %size, align 4, !dbg !740
  %68 = sext i32 %67 to i64, !dbg !740
  %69 = call i32 @cudaMemcpy(i8* %64, i8* %66, i64 %68, i32 2), !dbg !740
  %70 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str2, i32 0, i32 0)), !dbg !741
  store i32 0, i32* %i2, align 4, !dbg !742
  br label %71, !dbg !742

; <label>:71                                      ; preds = %74, %47
  %72 = load i32* %i2, align 4, !dbg !742
  %73 = icmp slt i32 %72, 2, !dbg !742
  br i1 %73, label %74, label %83, !dbg !742

; <label>:74                                      ; preds = %71
  %75 = load i32* %i2, align 4, !dbg !744
  %76 = sext i32 %75 to i64, !dbg !744
  %77 = load i32** %a, align 8, !dbg !744
  %78 = getelementptr inbounds i32* %77, i64 %76, !dbg !744
  %79 = load i32* %78, align 4, !dbg !744
  %80 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0), i32 %79), !dbg !744
  %81 = load i32* %i2, align 4, !dbg !742
  %82 = add nsw i32 %81, 1, !dbg !742
  store i32 %82, i32* %i2, align 4, !dbg !742
  br label %71, !dbg !742

; <label>:83                                      ; preds = %71
  %84 = load i32** %a, align 8, !dbg !745
  %85 = bitcast i32* %84 to i8*, !dbg !745
  call void @free(i8* %85) nounwind, !dbg !745
  %86 = load i32** %dev_a, align 8, !dbg !746
  %87 = bitcast i32* %86 to i8*, !dbg !746
  %88 = call i32 @cudaFree(i8* %87), !dbg !746
  ret i32 0, !dbg !747
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, met
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle", null} ; [ DW_TAG_file_type ]
...
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"shuffle", metadata !"shuffle", metadata !"_Z7shufflePi", metadata !16, i32 11, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*)* @_Z7shufflePi, null, null, me
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 12, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle/main.cpp]
!721 = metadata !{i32 14, i32 0, metadata !720, null}
!722 = metadata !{i32 15, i32 0, metadata !720, null}
!723 = metadata !{i32 16, i32 0, metadata !720, null}
!724 = metadata !{i32 17, i32 0, metadata !720, null}
!725 = metadata !{i32 22, i32 0, metadata !726, null}
!726 = metadata !{i32 786443, metadata !21, i32 19, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle/main.cpp]
!727 = metadata !{i32 24, i32 0, metadata !726, null}
!728 = metadata !{i32 26, i32 0, metadata !726, null}
!729 = metadata !{i32 28, i32 0, metadata !730, null}
!730 = metadata !{i32 786443, metadata !726, i32 28, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle/main.cpp]
!731 = metadata !{i32 29, i32 0, metadata !730, null}
!732 = metadata !{i32 31, i32 0, metadata !726, null}
!733 = metadata !{i32 33, i32 0, metadata !726, null}
!734 = metadata !{i32 35, i32 0, metadata !735, null}
!735 = metadata !{i32 786443, metadata !726, i32 35, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle/main.cpp]
!736 = metadata !{i32 36, i32 0, metadata !735, null}
!737 = metadata !{i32 37, i32 0, metadata !738, null}
!738 = metadata !{i32 786443, metadata !726, i32 37, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle/main.cpp]
!739 = metadata !{i32 39, i32 0, metadata !738, null}
!740 = metadata !{i32 43, i32 0, metadata !726, null}
!741 = metadata !{i32 45, i32 0, metadata !726, null}
!742 = metadata !{i32 47, i32 0, metadata !743, null}
!743 = metadata !{i32 786443, metadata !726, i32 47, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle/main.cpp]
!744 = metadata !{i32 48, i32 0, metadata !743, null}
!745 = metadata !{i32 50, i32 0, metadata !726, null}
!746 = metadata !{i32 52, i32 0, metadata !726, null}
!747 = metadata !{i32 54, i32 0, metadata !726, null}
...
!751 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/093_bronken_shuffle//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h
