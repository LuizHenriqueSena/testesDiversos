...
@.str1 = private unnamed_addr constant [11 x i8] c"%d        \00", align 1
@.str2 = private unnamed_addr constant [23 x i8] c"\0AFunction Results:\0A   \00", align 1
@.str3 = private unnamed_addr constant [13 x i8] c"b[i]==a[i+1]\00", align 1
@.str4 = private unnamed_addr constant [9 x i8] c"main.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

define void @_Z7shufflePi(i32* %A) nounwind uwtable noinline {
  ...
  %4 = sdiv i32 %3, 2, !dbg !721
  store i32 %4, i32* %warp, align 4, !dbg !721
  %5 = load i32** %1, align 8, !dbg !722
  %6 = load i32* %warp, align 4, !dbg !722
  %7 = mul nsw i32 %6, 2, !dbg !722
  %8 = sext i32 %7 to i64, !dbg !722
  %9 = getelementptr inbounds i32* %5, i64 %8, !dbg !722
  store i32* %9, i32** %B, align 8, !dbg !722
  %10 = load i32* %tid, align 4, !dbg !723
  %11 = add nsw i32 %10, 1, !dbg !723
  %12 = srem i32 %11, 2, !dbg !723
  %13 = sext i32 %12 to i64, !dbg !723
  %14 = load i32** %B, align 8, !dbg !723
  %15 = getelementptr inbounds i32* %14, i64 %13, !dbg !723
  %16 = load i32* %15, align 4, !dbg !723
  %17 = load i32* %tid, align 4, !dbg !723
  %18 = sext i32 %17 to i64, !dbg !723
  %19 = load i32** %1, align 8, !dbg !723
  %20 = getelementptr inbounds i32* %19, i64 %18, !dbg !723
  store i32 %16, i32* %20, align 4, !dbg !723
  ret void, !dbg !724
}
...
define i32 @main() uwtable {
  ...
  store i32 0, i32* %1
  store i32 16, i32* %size, align 4, !dbg !725
  ...
  %10 = load i32* %size, align 4, !dbg !728
  %11 = mul nsw i32 4, %10, !dbg !728
  %12 = sext i32 %11 to i64, !dbg !728
  %13 = call noalias i8* @malloc(i64 %12) nounwind, !dbg !728
  %14 = bitcast i8* %13 to i32*, !dbg !728
  store i32* %14, i32** %a, align 8, !dbg !728
  %15 = load i32* %size, align 4, !dbg !729
  %16 = mul nsw i32 4, %15, !dbg !729
  %17 = sext i32 %16 to i64, !dbg !729
  %18 = call noalias i8* @malloc(i64 %17) nounwind, !dbg !729
  %19 = bitcast i8* %18 to i32*, !dbg !729
  store i32* %19, i32** %b, align 8, !dbg !729
  store i32 0, i32* %i, align 4, !dbg !730
  br label %20, !dbg !730

; <label>:20                                      ; preds = %23, %0
  %21 = load i32* %i, align 4, !dbg !730
  %22 = icmp slt i32 %21, 4, !dbg !730
  br i1 %22, label %23, label %31, !dbg !730

; <label>:23                                      ; preds = %20
  %24 = load i32* %i, align 4, !dbg !732
  %25 = load i32* %i, align 4, !dbg !732
  %26 = sext i32 %25 to i64, !dbg !732
  %27 = load i32** %a, align 8, !dbg !732
  %28 = getelementptr inbounds i32* %27, i64 %26, !dbg !732
  store i32 %24, i32* %28, align 4, !dbg !732
  %29 = load i32* %i, align 4, !dbg !730
  %30 = add nsw i32 %29, 1, !dbg !730
  store i32 %30, i32* %i, align 4, !dbg !730
  br label %20, !dbg !730

; <label>:31                                      ; preds = %20
  %32 = load i32** %dev_a, align 8, !dbg !733
  %33 = bitcast i32* %32 to i8*, !dbg !733
  %34 = load i32** %a, align 8, !dbg !733
  %35 = bitcast i32* %34 to i8*, !dbg !733
  %36 = load i32* %size, align 4, !dbg !733
  %37 = sext i32 %36 to i64, !dbg !733
  %38 = call i32 @cudaMemcpy(i8* %33, i8* %35, i64 %37, i32 1), !dbg !733
  %39 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0)), !dbg !734
  store i32 0, i32* %i1, align 4, !dbg !735
  br label %40, !dbg !735

; <label>:40                                      ; preds = %43, %31
  %41 = load i32* %i1, align 4, !dbg !735
  %42 = icmp slt i32 %41, 4, !dbg !735
  br i1 %42, label %43, label %52, !dbg !735

; <label>:43                                      ; preds = %40
  %44 = load i32* %i1, align 4, !dbg !737
  %45 = sext i32 %44 to i64, !dbg !737
  %46 = load i32** %a, align 8, !dbg !737
  %47 = getelementptr inbounds i32* %46, i64 %45, !dbg !737
  %48 = load i32* %47, align 4, !dbg !737
  %49 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0), i32 %48), !dbg !737
  %50 = load i32* %i1, align 4, !dbg !735
  %51 = add nsw i32 %50, 1, !dbg !735
  store i32 %51, i32* %i1, align 4, !dbg !735
  br label %40, !dbg !735

; <label>:52                                      ; preds = %40
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 1, i32 1, i32 1), !dbg !738
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %3, i32 4, i32 1, i32 1), !dbg !738
  %53 = bitcast { i64, i32 }* %4 to i8*, !dbg !738
  %54 = bitcast %struct.dim3* %2 to i8*, !dbg !738
  %55 = call i8* @memcpy(i8* %53, i8* %54, i64 12)
  %56 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !738
  %57 = load i64* %56, align 1, !dbg !738
  %58 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !738
  %59 = load i32* %58, align 1, !dbg !738
  %60 = bitcast { i64, i32 }* %5 to i8*, !dbg !738
  %61 = bitcast %struct.dim3* %3 to i8*, !dbg !738
  %62 = call i8* @memcpy(i8* %60, i8* %61, i64 12)
  %63 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !738
  %64 = load i64* %63, align 1, !dbg !738
  %65 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !738
  %66 = load i32* %65, align 1, !dbg !738
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %57, i32 %59, i64 %64, i32 %66), !dbg !738
  %67 = load i32** %dev_a, align 8, !dbg !740
  call void @_Z7shufflePi(i32* %67), !dbg !740
  %68 = load i32** %b, align 8, !dbg !741
  %69 = bitcast i32* %68 to i8*, !dbg !741
  %70 = load i32** %dev_a, align 8, !dbg !741
  %71 = bitcast i32* %70 to i8*, !dbg !741
  %72 = load i32* %size, align 4, !dbg !741
  %73 = sext i32 %72 to i64, !dbg !741
  %74 = call i32 @cudaMemcpy(i8* %69, i8* %71, i64 %73, i32 2), !dbg !741
  %75 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str2, i32 0, i32 0)), !dbg !742
  store i32 0, i32* %i2, align 4, !dbg !743
  br label %76, !dbg !743

; <label>:76                                      ; preds = %99, %52
  %77 = load i32* %i2, align 4, !dbg !743
  %78 = icmp slt i32 %77, 4, !dbg !743
  br i1 %78, label %79, label %102, !dbg !743

; <label>:79                                      ; preds = %76
  %80 = load i32* %i2, align 4, !dbg !745
  %81 = sext i32 %80 to i64, !dbg !745
  %82 = load i32** %b, align 8, !dbg !745
  %83 = getelementptr inbounds i32* %82, i64 %81, !dbg !745
  %84 = load i32* %83, align 4, !dbg !745
  %85 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str1, i32 0, i32 0), i32 %84), !dbg !745
  %86 = load i32* %i2, align 4, !dbg !747
  %87 = sext i32 %86 to i64, !dbg !747
  %88 = load i32** %b, align 8, !dbg !747
  %89 = getelementptr inbounds i32* %88, i64 %87, !dbg !747
  %90 = load i32* %89, align 4, !dbg !747
  %91 = load i32* %i2, align 4, !dbg !747
  %92 = add nsw i32 %91, 1, !dbg !747
  %93 = sext i32 %92 to i64, !dbg !747
  %94 = load i32** %a, align 8, !dbg !747
  %95 = getelementptr inbounds i32* %94, i64 %93, !dbg !747
  %96 = load i32* %95, align 4, !dbg !747
  %97 = icmp eq i32 %90, %96, !dbg !747
  br i1 %97, label %99, label %98, !dbg !747

; <label>:98                                      ; preds = %79
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str4, i32 0, i32 0), i32 50, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwi
  unreachable, !dbg !747

; <label>:99                                      ; preds = %79
  %100 = load i32* %i2, align 4, !dbg !743
  %101 = add nsw i32 %100, 1, !dbg !743
  store i32 %101, i32* %i2, align 4, !dbg !743
  br label %76, !dbg !743

; <label>:102                                     ; preds = %76
  %103 = load i32** %a, align 8, !dbg !748
  %104 = bitcast i32* %103 to i8*, !dbg !748
  call void @free(i8* %104) nounwind, !dbg !748
  %105 = load i32** %b, align 8, !dbg !748
  %106 = bitcast i32* %105 to i8*, !dbg !748
  call void @free(i8* %106) nounwind, !dbg !748
  %107 = load i32** %dev_a, align 8, !dbg !749
  %108 = bitcast i32* %107 to i8*, !dbg !749
  %109 = call i32 @cudaFree(i8* %108), !dbg !749
  ret i32 0, !dbg !750
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metada
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail", null} ; [ DW_TAG_file_type ]
...
!15 = metadata !{i32 786478, i32 0, metadata !16, metadata !"shuffle", metadata !"shuffle", metadata !"_Z7shufflePi", metadata !16, i32 10, metadata !17, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*)* @_Z7shufflePi, null, null, me
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 11, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail/main.cpp]
!721 = metadata !{i32 13, i32 0, metadata !720, null}
!722 = metadata !{i32 14, i32 0, metadata !720, null}
!723 = metadata !{i32 15, i32 0, metadata !720, null}
!724 = metadata !{i32 16, i32 0, metadata !720, null}
!725 = metadata !{i32 22, i32 0, metadata !726, null}
!726 = metadata !{i32 786443, metadata !21, i32 18, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail/main.cpp]
!727 = metadata !{i32 24, i32 0, metadata !726, null}
!728 = metadata !{i32 26, i32 0, metadata !726, null}
!729 = metadata !{i32 27, i32 0, metadata !726, null}
!730 = metadata !{i32 29, i32 0, metadata !731, null}
!731 = metadata !{i32 786443, metadata !726, i32 29, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail/main.cpp]
!732 = metadata !{i32 30, i32 0, metadata !731, null}
!733 = metadata !{i32 32, i32 0, metadata !726, null}
!734 = metadata !{i32 34, i32 0, metadata !726, null}
!735 = metadata !{i32 36, i32 0, metadata !736, null}
!736 = metadata !{i32 786443, metadata !726, i32 36, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail/main.cpp]
!737 = metadata !{i32 37, i32 0, metadata !736, null}
!738 = metadata !{i32 38, i32 0, metadata !739, null}
!739 = metadata !{i32 786443, metadata !726, i32 38, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail/main.cpp]
!740 = metadata !{i32 40, i32 0, metadata !739, null}
!741 = metadata !{i32 44, i32 0, metadata !726, null}
!742 = metadata !{i32 46, i32 0, metadata !726, null}
!743 = metadata !{i32 48, i32 0, metadata !744, null}
!744 = metadata !{i32 786443, metadata !726, i32 48, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail/main.cpp]
!745 = metadata !{i32 49, i32 0, metadata !746, null}
!746 = metadata !{i32 786443, metadata !744, i32 48, i32 0, metadata !16, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail/main.cpp]
!747 = metadata !{i32 50, i32 0, metadata !746, null}
!748 = metadata !{i32 52, i32 0, metadata !726, null}
!749 = metadata !{i32 54, i32 0, metadata !726, null}
!750 = metadata !{i32 56, i32 0, metadata !726, null}
...
!754 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/096_shuffle_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
