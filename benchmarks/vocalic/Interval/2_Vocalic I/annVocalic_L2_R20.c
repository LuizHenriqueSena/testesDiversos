...
__ESBMC_assume((layer1[2]  >= 0) && (layer1[2] <= 0.57688498497));
...
__ESBMC_assume((layer2[0]  >= 0) && (layer2[0] <= 0.985225975513));
...
__ESBMC_assume((layer2[1]  >= 0) && (layer2[1] <= 0.331811994314));
...
__ESBMC_assume((layer2[2]  >= 0) && (layer2[2] <= 0.049265999347));
...
__ESBMC_assume((layer2[3]  >= 0.0847110003233) && (layer2[3] <= 1));
float layer3[5];
...
__ESBMC_assume((layer3[0]  >= 0) && (layer3[0] <= 0.00901299994439));
int r = 0;
...
__ESBMC_assume((layer3[1]  >= 0) && (layer3[1] <= 0.990621984005));
...
__ESBMC_assume((layer3[2]  >= 0) && (layer3[2] <= 0.96643102169));
...
__ESBMC_assume((layer3[3]  >= 0) && (layer3[3] <= 0.922011971474));
...
__ESBMC_assume((layer3[4]  >= 0) && (layer3[4] <= 0.140637993813));
