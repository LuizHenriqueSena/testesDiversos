...
@.str2 = private unnamed_addr constant [8 x i8] c"v[i]!=i\00", align 1
@.str3 = private unnamed_addr constant [9 x i8] c"main.cpp\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

define void @_Z3fooPi(i32* %glob) nounwind uwtable noinline {
  %1 = alloca i32*, align 8
  %a = alloca i32, align 4
  %p = alloca i32*, align 8
  store i32* %glob, i32** %1, align 8
  store i32 0, i32* %a, align 4, !dbg !719
  store i32* %a, i32** %p, align 8, !dbg !721
  %2 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !722
  %3 = load i32** %p, align 8, !dbg !722
  store i32 %2, i32* %3, align 4, !dbg !722
  %4 = load i32* getelementptr inbounds (%struct.dim3* @threadIdx, i32 0, i32 0), align 4, !dbg !723
  %5 = load i32** %p, align 8, !dbg !723
  %6 = load i32* %5, align 4, !dbg !723
  %7 = sext i32 %6 to i64, !dbg !723
  %8 = load i32** %1, align 8, !dbg !723
  %9 = getelementptr inbounds i32* %8, i64 %7, !dbg !723
  store i32 %4, i32* %9, align 4, !dbg !723
  ret void, !dbg !724
}
...
define i32 @main() uwtable {
  ...
  store i32* %7, i32** %v, align 8, !dbg !725
  store i32 0, i32* %i, align 4, !dbg !727
  br label %8, !dbg !727

; <label>:8                                       ; preds = %11, %0
  %9 = load i32* %i, align 4, !dbg !727
  %10 = icmp slt i32 %9, 2, !dbg !727
  br i1 %10, label %11, label %21, !dbg !727

; <label>:11                                      ; preds = %8
  %12 = call i32 @rand() nounwind, !dbg !729
  %13 = srem i32 %12, 20, !dbg !729
  %14 = add nsw i32 %13, 1, !dbg !729
  %15 = load i32* %i, align 4, !dbg !729
  %16 = sext i32 %15 to i64, !dbg !729
  %17 = load i32** %v, align 8, !dbg !729
  %18 = getelementptr inbounds i32* %17, i64 %16, !dbg !729
  store i32 %14, i32* %18, align 4, !dbg !729
  %19 = load i32* %i, align 4, !dbg !727
  %20 = add nsw i32 %19, 1, !dbg !727
  store i32 %20, i32* %i, align 4, !dbg !727
  br label %8, !dbg !727

; <label>:21                                      ; preds = %8
  store i32 0, i32* %i1, align 4, !dbg !730
  br label %22, !dbg !730

; <label>:22                                      ; preds = %25, %21
  %23 = load i32* %i1, align 4, !dbg !730
  %24 = icmp slt i32 %23, 2, !dbg !730
  br i1 %24, label %25, label %34, !dbg !730

; <label>:25                                      ; preds = %22
  %26 = load i32* %i1, align 4, !dbg !732
  %27 = sext i32 %26 to i64, !dbg !732
  %28 = load i32** %v, align 8, !dbg !732
  %29 = getelementptr inbounds i32* %28, i64 %27, !dbg !732
  %30 = load i32* %29, align 4, !dbg !732
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 %30), !dbg !732
  %32 = load i32* %i1, align 4, !dbg !730
  %33 = add nsw i32 %32, 1, !dbg !730
  store i32 %33, i32* %i1, align 4, !dbg !730
  br label %22, !dbg !730

; <label>:34                                      ; preds = %22
  %35 = bitcast i32** %dev_v to i8**, !dbg !733
  %36 = call i32 @cudaMalloc(i8** %35, i64 8), !dbg !733
  %37 = load i32** %dev_v, align 8, !dbg !734
  %38 = bitcast i32* %37 to i8*, !dbg !734
  %39 = load i32** %v, align 8, !dbg !734
  %40 = bitcast i32* %39 to i8*, !dbg !734
  %41 = call i32 @cudaMemcpy(i8* %38, i8* %40, i64 8, i32 1), !dbg !734
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %2, i32 1, i32 1, i32 1), !dbg !735
  call void @_ZN4dim3C1Ejjj(%struct.dim3* %3, i32 2, i32 1, i32 1), !dbg !735
  %42 = bitcast { i64, i32 }* %4 to i8*, !dbg !735
  %43 = bitcast %struct.dim3* %2 to i8*, !dbg !735
  %44 = call i8* @memcpy(i8* %42, i8* %43, i64 12)
  %45 = getelementptr { i64, i32 }* %4, i32 0, i32 0, !dbg !735
  %46 = load i64* %45, align 1, !dbg !735
  %47 = getelementptr { i64, i32 }* %4, i32 0, i32 1, !dbg !735
  %48 = load i32* %47, align 1, !dbg !735
  %49 = bitcast { i64, i32 }* %5 to i8*, !dbg !735
  %50 = bitcast %struct.dim3* %3 to i8*, !dbg !735
  %51 = call i8* @memcpy(i8* %49, i8* %50, i64 12)
  %52 = getelementptr { i64, i32 }* %5, i32 0, i32 0, !dbg !735
  %53 = load i64* %52, align 1, !dbg !735
  %54 = getelementptr { i64, i32 }* %5, i32 0, i32 1, !dbg !735
  %55 = load i32* %54, align 1, !dbg !735
  call void (i64, i32, i64, i32, ...)* @__set_CUDAConfig(i64 %46, i32 %48, i64 %53, i32 %55), !dbg !735
  %56 = load i32** %dev_v, align 8, !dbg !737
  call void @_Z3fooPi(i32* %56), !dbg !737
  %57 = load i32** %v, align 8, !dbg !738
  %58 = bitcast i32* %57 to i8*, !dbg !738
  %59 = load i32** %dev_v, align 8, !dbg !738
  %60 = bitcast i32* %59 to i8*, !dbg !738
  %61 = call i32 @cudaMemcpy(i8* %58, i8* %60, i64 8, i32 2), !dbg !738
  %62 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str1, i32 0, i32 0)), !dbg !739
  store i32 0, i32* %i2, align 4, !dbg !740
  br label %63, !dbg !740

; <label>:63                                      ; preds = %81, %34
  %64 = load i32* %i2, align 4, !dbg !740
  %65 = icmp slt i32 %64, 2, !dbg !740
  br i1 %65, label %66, label %84, !dbg !740

; <label>:66                                      ; preds = %63
  %67 = load i32* %i2, align 4, !dbg !742
  %68 = sext i32 %67 to i64, !dbg !742
  %69 = load i32** %v, align 8, !dbg !742
  %70 = getelementptr inbounds i32* %69, i64 %68, !dbg !742
  %71 = load i32* %70, align 4, !dbg !742
  %72 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([9 x i8]* @.str, i32 0, i32 0), i32 %71), !dbg !742
  %73 = load i32* %i2, align 4, !dbg !744
  %74 = sext i32 %73 to i64, !dbg !744
  %75 = load i32** %v, align 8, !dbg !744
  %76 = getelementptr inbounds i32* %75, i64 %74, !dbg !744
  %77 = load i32* %76, align 4, !dbg !744
  %78 = load i32* %i2, align 4, !dbg !744
  %79 = icmp ne i32 %77, %78, !dbg !744
  br i1 %79, label %81, label %80, !dbg !744

; <label>:80                                      ; preds = %66
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i32 0, i32 0), i32 51, i8* getelementptr inbounds ([11 x i8]* @__PRETTY_FUNCTION__.main, i32 0, i32 0)) noreturn nounwin
  unreachable, !dbg !744

; <label>:81                                      ; preds = %66
  %82 = load i32* %i2, align 4, !dbg !740
  %83 = add nsw i32 %82, 1, !dbg !740
  store i32 %83, i32* %i2, align 4, !dbg !740
  br label %63, !dbg !740

; <label>:84                                      ; preds = %63
  %85 = load i32** %v, align 8, !dbg !745
  %86 = bitcast i32* %85 to i8*, !dbg !745
  call void @free(i8* %86) nounwind, !dbg !745
  %87 = load i32** %dev_v, align 8, !dbg !746
  %88 = bitcast i32* %87 to i8*, !dbg !746
  %89 = call i32 @cudaFree(i8* %88), !dbg !746
  ret i32 0, !dbg !747
}
...
!0 = metadata !{i32 786449, i32 0, i32 4, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail", metadata !"clang version 3.2 (tags/RELEASE_32/final)", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata
...
!4 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/driver_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail", null} ; [ DW_TAG_file_type ]
...
!16 = metadata !{i32 786473, metadata !"main.cpp", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail", null} ; [ DW_TAG_file_type ]
...
!25 = metadata !{i32 786473, metadata !"/home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h", metadata !"/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail", null} ; [ DW_TAG_file_type ]
...
!720 = metadata !{i32 786443, metadata !15, i32 7, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail/main.cpp]
!721 = metadata !{i32 15, i32 0, metadata !720, null}
!722 = metadata !{i32 17, i32 0, metadata !720, null}
!723 = metadata !{i32 19, i32 0, metadata !720, null}
!724 = metadata !{i32 20, i32 0, metadata !720, null}
!725 = metadata !{i32 28, i32 0, metadata !726, null}
!726 = metadata !{i32 786443, metadata !21, i32 22, i32 0, metadata !16, i32 1} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail/main.cpp]
!727 = metadata !{i32 30, i32 0, metadata !728, null}
!728 = metadata !{i32 786443, metadata !726, i32 30, i32 0, metadata !16, i32 2} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail/main.cpp]
!729 = metadata !{i32 31, i32 0, metadata !728, null}
!730 = metadata !{i32 33, i32 0, metadata !731, null}
!731 = metadata !{i32 786443, metadata !726, i32 33, i32 0, metadata !16, i32 3} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail/main.cpp]
!732 = metadata !{i32 34, i32 0, metadata !731, null}
!733 = metadata !{i32 36, i32 0, metadata !726, null}
!734 = metadata !{i32 38, i32 0, metadata !726, null}
!735 = metadata !{i32 39, i32 0, metadata !736, null}
!736 = metadata !{i32 786443, metadata !726, i32 39, i32 0, metadata !16, i32 4} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail/main.cpp]
!737 = metadata !{i32 41, i32 0, metadata !736, null}
!738 = metadata !{i32 45, i32 0, metadata !726, null}
!739 = metadata !{i32 47, i32 0, metadata !726, null}
!740 = metadata !{i32 49, i32 0, metadata !741, null}
!741 = metadata !{i32 786443, metadata !726, i32 49, i32 0, metadata !16, i32 5} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail/main.cpp]
!742 = metadata !{i32 50, i32 0, metadata !743, null}
!743 = metadata !{i32 786443, metadata !741, i32 49, i32 0, metadata !16, i32 6} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail/main.cpp]
!744 = metadata !{i32 51, i32 0, metadata !743, null}
!745 = metadata !{i32 53, i32 0, metadata !726, null}
!746 = metadata !{i32 54, i32 0, metadata !726, null}
!747 = metadata !{i32 56, i32 0, metadata !726, null}
...
!751 = metadata !{i32 786443, metadata !67, i32 419, i32 0, metadata !25, i32 7} ; [ DW_TAG_lexical_block ] [/home/luiz/Projetos/benchLuiz/benchmarksGklee/039_test7_fail//home/luiz/Projetos/OutrosVerificadores/Gklee/Gklee/include/cuda/vector_types.h]
